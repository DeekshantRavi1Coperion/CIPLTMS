<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="OpsCostTypeList.aspx.cs" Inherits="FINOPS_OpsCostTypeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ValidateOpsCostTypeToEdit() {
            var OpsCostTypeToEdit = document.getElementById('<%=txtOpsCostTypeToEdit.ClientID %>').value;
            if (OpsCostTypeToEdit == '') {
                document.getElementById('<%=txtOpsCostTypeToEdit.ClientID %>').style.borderColor = "#F7627F";
                return true;
            }
            else {
                document.getElementById('<%=txtOpsCostTypeToEdit.ClientID %>').style.borderColor = "";
                return false;
            }
        }
        ...
        <ContentTemplate>
            <div align="center" style="margin-top: 100px;">
                <fieldset style="width: 50%">
                    <legend style="text-align: center;">Cost Type List</legend>
                    <table width="100%">
                        <tr>
                            <td>Cost Type:
                            </td>
                            <td>
                                <asp:TextBox ID="txtOpsCostType" runat="server" Width="100%" />
                            </td>
                            <td>&nbsp;
                            </td>
                            <td>
            ...
            <div align="center">
                <fieldset style="width: 50%">
                    ...
                    <asp:GridView ID="gvOpsCostTypeList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ForeColor="#333333" GridLines="None" Width="100%" HorizontalAlign="Center"
                        OnRowCommand="gvOpsCostTypeList_RowCommand" OnRowDataBound="gvOpsCostTypeList_RowDataBound">
                        <RowStyle BackColor="#E3EAEB" HorizontalAlign="Left" />
                        <Columns>
                            <asp:BoundField DataField="COST_TYPE" HeaderText="COST_TYPE"></asp:BoundField>
                            <asp:TemplateField HeaderText="PROPERTIES">
                                <ItemTemplate>
                                    <asp:Label ID="lblCostTypeID" runat="server" Visible="false" Text='<%# Eval("COST_TYPE_ID") %>'></asp:Label>
                                    <asp:Label ID="lblCostType" runat="server" Visible="false" Text='<%# Eval("COST_TYPE") %>'></asp:Label>
            ...
            <asp:Panel ID="pnlPopupOpsType" runat="server" BackColor="White" Height="300px" Width="600px"
                ...
                <fieldset style="width: 95%; margin-left: 22px; margin-top: 10px;">
                    <legend style="text-align: center;">Edit Cost Type</legend>
                    <table style="width: 90%; margin-left: 20px;">
                        ...
                        <tr>
                            <td>
                                <p>Cost Type:</p>
                                <asp:TextBox ID="txtOpsCostTypeToEdit" runat="server" Width="100%" onblur="return ValidateOpsCostTypeToEdit();" />
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
