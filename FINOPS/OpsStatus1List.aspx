<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="OpsStatus1List.aspx.cs" Inherits="FINOPS_OpsStatus1List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ValidateOpsStatus1ToEdit() {
            var OpsStatus1ToEdit = document.getElementById('<%=txtOpsStatus1ToEdit.ClientID %>').value;
            if (OpsStatus1ToEdit == '') {
                document.getElementById('<%=txtOpsStatus1ToEdit.ClientID %>').style.borderColor = "#F7627F";
                return true;
            }
            else {
                document.getElementById('<%=txtOpsStatus1ToEdit.ClientID %>').style.borderColor = "";
                return false;
            }
        }
        ...
        <ContentTemplate>
            <div align="center" style="margin-top: 100px;">
                <fieldset style="width: 50%">
                    <legend style="text-align: center;">Status1 List</legend>
                    <table width="100%">
                        <tr>
                            <td>Status1 Name:
                            </td>
                            <td>
                                <asp:TextBox ID="txtOpsStatus1" runat="server" Width="100%" />
                            </td>
                            <td>&nbsp;
                            </td>
                            <td>
            ...
            <div align="center">
                <fieldset style="width: 50%">
                    ...
                    <asp:GridView ID="gvOpsStatus1List" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ForeColor="#333333" GridLines="None" Width="100%" HorizontalAlign="Center"
                        OnRowCommand="gvOpsStatus1List_RowCommand" OnRowDataBound="gvOpsStatus1List_RowDataBound">
                        <RowStyle BackColor="#E3EAEB" HorizontalAlign="Left" />
                        <Columns>
                            <asp:BoundField DataField="STATUS1" HeaderText="STATUS1"></asp:BoundField>
                            <asp:TemplateField HeaderText="PROPERTIES">
                                <ItemTemplate>
                                    <asp:Label ID="lblStatus1ID" runat="server" Visible="false" Text='<%# Eval("STATUS1_ID") %>'></asp:Label>
                                    <asp:Label ID="lblStatus1" runat="server" Visible="false" Text='<%# Eval("STATUS1") %>'></asp:Label>
            ...
            <asp:Panel ID="pnlPopupOpsType" runat="server" BackColor="White" Height="300px" Width="600px"
                ...
                <fieldset style="width: 95%; margin-left: 22px; margin-top: 10px;">
                    <legend style="text-align: center;">Edit Status1</legend>
                    <table style="width: 90%; margin-left: 20px;">
                        ...
                        <tr>
                            <td>
                                <p>Status1 Name:</p>
                                <asp:TextBox ID="txtOpsStatus1ToEdit" runat="server" Width="100%" onblur="return ValidateOpsStatus1ToEdit();" />
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
