<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of OrderDetailPDF.aspx.cs" EnableEventValidation="false"
    ...
    <div>
        ...
        <table id="tblOrderList" style="width: 100%" border="1" cellpadding="2" cellspacing="0"
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblRevsieValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRevsieValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRevsieValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRevsieValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRevsieValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblBasicValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblBasicValueCurrencySix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueCurrencySeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueCurrencyEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueCurrencyNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueCurrencyTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblExchangeRateSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblExchangeRateSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblExchangeRateEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblExchangeRateNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblExchangeRateTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblBasicValueINRSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueINRSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueINREight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueINRNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblBasicValueINRTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblExchangeRateDateSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblExchangeRateDateSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblExchangeRateDateEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblExchangeRateDateNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblExchangeRateDateTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblMaterialCostSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblMaterialCostSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblMaterialCostEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblMaterialCostNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblMaterialCostTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblGrossMarginValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblGrossMarginValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblGrossMarginValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblGrossMarginValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblGrossMarginValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblGrossMarginPercentageSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblGrossMarginPercentageSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblGrossMarginPercentageEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblGrossMarginPercentageNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblGrossMarginPercentageTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCIDEnggHoursSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCIDEnggHoursRateSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursRateSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursRateEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursRateNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursRateTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCIDEnggHoursValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCIDEnggHoursValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCWGEnggHoursSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCWGEnggHoursRateSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursRateSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursRateEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursRateNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursRateTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCWGEnggHoursValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCWGEnggHoursValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblEstimatedTravelCostSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblEstimatedTravelCostSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblEstimatedTravelCostEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblEstimatedTravelCostNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblEstimatedTravelCostTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblSupervisionSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblSupervisionSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblSupervisionEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblSupervisionNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblSupervisionTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblPurchaseOverheadMtrlRateSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblPurchaseOverheadMtrlRateSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblPurchaseOverheadMtrlRateEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblPurchaseOverheadMtrlRateNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblPurchaseOverheadMtrlRateTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblPurchaseRateValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblPurchaseRateValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblPurchaseRateValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblPurchaseRateValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblPurchaseRateValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblWarrantyCostPercentageSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblWarrantyCostPercentageSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblWarrantyCostPercentageEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblWarrantyCostPercentageNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblWarrantyCostPercentageTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblWarrantyCostValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblWarrantyCostValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblWarrantyCostValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblWarrantyCostValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblWarrantyCostValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblRoyaltyPercentageSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRoyaltyPercentageSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRoyaltyPercentageEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRoyaltyPercentageNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRoyaltyPercentageTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblRoyaltyValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRoyaltyValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRoyaltyValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRoyaltyValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblRoyaltyValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblInsurancePercentageSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblInsurancePercentageSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblInsurancePercentageEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblInsurancePercentageNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblInsurancePercentageTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblInsuranceValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblInsuranceValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblInsuranceValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblInsuranceValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblInsuranceValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblFraightSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblFraightSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblFraightEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblFraightNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblFraightTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCommision1PercentageSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision1PercentageSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision1PercentageEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision1PercentageNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision1PercentageTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCommision1ValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision1ValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision1ValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision1ValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision1ValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCommision2PercentageSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision2PercentageSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision2PercentageEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision2PercentageNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision2PercentageTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblCommision2ValueSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision2ValueSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision2ValueEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision2ValueNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblCommision2ValueTen" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblTotalSix" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblTotalSeven" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblTotalEight" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblTotalNine" runat="server" />
                </td>
                <td>
                    <asp:Label ID="lblTotalTen" runat="server" />
                </td>
            </tr>
        </table>
