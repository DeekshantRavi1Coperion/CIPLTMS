...
public class MRVouchersHtmlForPDF
{
    #region Variables
    ...
    public string DOCClass { get; private set; }
    ...
    public string GetHtmlForPDF(DataSet dsDetails)
    {
        try
        {
            ...
            sb.Append("<h2 class='headerStyle'><u>JOURNAL VOUCHER COPY</u></h2>\n");
            sb.Append("<hr />\n");
            ...
            sb.Append("<td class='td2header'>{#DOCClass#}</td>\n");
            sb.Append("</tr>\n");
            ...
            if (dsDetails.Tables[1].Rows.Count > 0)
            {
                ...
                sb.Append("<th class='tdcate'>Product Code</th>\n");
                ...
                foreach (DataRow dr in dsDetails.Tables[1].Rows)
                {
                    ...
                    sb.Append("<td class='tdcate'>{#ProductCode#}</td>\n");
