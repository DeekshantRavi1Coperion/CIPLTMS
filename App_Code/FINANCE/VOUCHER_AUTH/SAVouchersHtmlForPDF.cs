...
public class SAVouchersHtmlForPDF
{
    #region Variables
    ...
    public string GetHtmlForPDF(DataSet dsDetails)
    {
        try
        {
            ...
            sb.Append("<h2 class='headerStyle'><u>STOCK ADJUSTMENT VOUCHER COPY</u></h2>\n");
            sb.Append("<hr />\n");
            ...
            sb.Append("<td class='td2header'>{#Particular#}</td>\n");
            sb.Append("</tr>\n");
            ...
            if (dsDetails.Tables[1].Rows.Count > 0)
            {
                ...
                sb.Append("<th class='tdtag'>Rate</th>\n");
                ...
                foreach (DataRow dr in dsDetails.Tables[1].Rows)
                {
                    ...
                    sb.Append("<td class='tdtag'>{#Rate#}</td>\n");
