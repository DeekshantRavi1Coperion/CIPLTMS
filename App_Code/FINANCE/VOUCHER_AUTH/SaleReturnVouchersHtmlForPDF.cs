...
public class SaleReturnVouchersHtmlForPDF
{
    #region Variables
    ...
    private string ReferenceInvoiceDate;
    ...
    public string GetHtmlForPDF(DataSet dsDetails)
    {
        try
        {
            if (dsDetails.Tables.Count > 0 && dsDetails.Tables[0].Rows.Count > 0)
            {
                ...
                if (dr0["REFERENCE_INVOICE_NO"] != DBNull.Value) ReferenceInvoiceNo = Convert.ToString(dr0["REFERENCE_INVOICE_NO"]).Trim();
                if (dr0["REFERENCE_INVOICE_DATE"] != DBNull.Value) ReferenceInvoiceDate = Convert.ToString(dr0["REFERENCE_INVOICE_DATE"]).Trim();
                ...
                if (dr0["ACCOUNT_ID"] != DBNull.Value) AccountID = Convert.ToString(dr0["ACCOUNT_ID"]).Trim();
            ...
            sb.Append("<h2 class='headerStyle'><u>SALE RETURN VOUCHER COPY</u></h2>\n");
            sb.Append("<hr />\n");
            ...
            sb.Append("<tr>\n");
            sb.Append("<td class='td1header'>Reference Invoice No.:</td>\n");
            sb.Append("<td class='td2header'><b>{#ReferenceInvoiceNo#}</b></td>\n");
            sb.Append("<td class='td1header'>Reference Invoice Date:</td>\n");
            sb.Append("<td class='td2header'>{#ReferenceInvoiceDate#}</td>\n");
            sb.Append("</tr>\n");
            ...
            sb.Append("<tr>\n");
            sb.Append("<td class='td1header'>Class:</td>\n");
            ...
            sb.Append("<td class='td2header'><b>{#CurrencyRate#}</b></td>\n");
            ...
            sb.Append("<tr>\n");
            sb.Append("<td class='td1header'>Account ID:</td>\n");
            sb.Append("<td class='td2header'>{#AccountID#}</td>\n");
            ...
            sb.Replace("{#ReferenceInvoiceNo#}", ReferenceInvoiceNo);
            sb.Replace("{#ReferenceInvoiceDate#}", ReferenceInvoiceDate);
            ...
            sb.Replace("{#AccountID#}", AccountID);
            ...
            if (dsDetails.Tables[1].Rows.Count > 0)
            {
                ...
                sb.Append("<th class='tdtag'>Product Code Returned</th>\n");
                sb.Append("<th class='tddesc'>Product Description Returned</th>\n");
                ...
                sb.Append("<th class='tdquantity'>Term Amount</th>\n");
                ...
                foreach (DataRow dr in dsDetails.Tables[1].Rows)
                {
                    ...
                    sb.Append("<td class='tdtag'>{#ProductCodeReturned#}</td>\n");
                    sb.Append("<td class='tddesc'>{#ProductDescriptionReturned#}</td>\n");
                    ...
                    sb.Append("<td class='tdquantity'>{#TermAmount#}</td>\n");
                    ...
                    sb.Replace("{#ProductCodeReturned#}", Convert.ToString(dr["PRODUCT_CODE_RETURNED"]));
                    sb.Replace("{#ProductDescriptionReturned#}", Convert.ToString(dr["PRODUCT_DESCRIPTION_RETURNED"]));
                    ...
                    sb.Replace("{#TermAmount#}", Convert.ToString(dr["TERM_AMOUNT"]));
                }
                sb.Append("</table>\n");
            }
