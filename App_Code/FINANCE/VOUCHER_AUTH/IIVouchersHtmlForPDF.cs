...
public class IIVouchersHtmlForPDF
{
    #region Variables
    ...
    public string GetHtmlForPDF(DataSet dsDetails)
    {
        try
        {
            if (dsDetails.Tables.Count > 0 && dsDetails.Tables[0].Rows.Count > 0)
            {
                ...
                if (dr0["FACTOR"] != DBNull.Value) Factor = Convert.ToString(dr0["FACTOR"]).Trim();
            ...
            sb.Append("<h2 class='headerStyle'><u>INVENTORY ISSUE VOUCHER COPY</u></h2>\n");
            sb.Append("<hr />\n");
            ...
            sb.Append("<tr>\n");
            sb.Append("<td class='td1header'>Factor:</td>\n");
            sb.Append("<td class='td2header'><b>{#Factor#}</b></td>\n");            
            sb.Append("</tr>\n");
