<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="ViewPOTCList.aspx.cs"
    Inherits="TC_ViewPOTCList" Title="CIPLTMS- View PO TC List" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidateAllUpload() {
            ...
            if (check) {
                if (confirm("Would you like to upload TC?")) {
                    document.getElementById('<%=hdUploadConfirmValue.ClientID %>').value = "1";
                    return true;
                }
                else {
                    document.getElementById('<%=hdUploadConfirmValue.ClientID %>').value = "0";
                    return false;
                }
            }
            else {
        ...
        function ValidateAllStatus() {
            ...
            if (document.getElementById('<%=ddlStatusTC1.ClientID %>') != null) {
                if (ValidateRejectedReasonTC1()) {
                    check = false;
                }
            }

            if (document.getElementById('<%=ddlStatusTC2.ClientID %>') != null) {
                if (ValidateRejectedReasonTC2()) {
                    check = false;
                }
            }

            if (document.getElementById('<%=ddlStatusTC3.ClientID %>') != null) {
                if (ValidateRejectedReasonTC3()) {
                    check = false;
                }
            }

            if (check) {
                if (confirm("Would you like to update TC status?")) {
                    document.getElementById('<%=hdUpdateStatausConfirmValue.ClientID %>').value = "1";
                    return true;
                }
                else {
                    document.getElementById('<%=hdUpdateStatausConfirmValue.ClientID %>').value = "0";
                    return false;
                }
            }
            else {
        ...
        function ValidateStatusTC1() {

            if (document.getElementById('<%=ddlStatusTC1.ClientID %>') != null) {
                var StatusTC1 = document.getElementById('<%=ddlStatusTC1.ClientID %>').selectedIndex;
                if (StatusTC1 == '' || StatusTC1 == 0) {
                    document.getElementById('<%=ddlStatusTC1.ClientID %>').style.borderColor = "#F7627F";
                    return true;
                }
                else {

                    if (document.getElementById('<%=ddlStatusTC1.ClientID %>') != null)
                        document.getElementById('<%=ddlStatusTC1.ClientID %>').style.borderColor = "";

                    if (document.getElementById('<%=ddlStatusTC2.ClientID %>') != null)
                        document.getElementById('<%=ddlStatusTC2.ClientID %>').style.borderColor = "";

                    if (document.getElementById('<%=ddlStatusTC3.ClientID %>') != null)
                        document.getElementById('<%=ddlStatusTC3.ClientID %>').style.borderColor = "";
        ...
        function ValidateStatusTC2() {

            if (document.getElementById('<%=ddlStatusTC2.ClientID %>') != null) {
                var StatusTC2 = document.getElementById('<%=ddlStatusTC2.ClientID %>').selectedIndex;
                if (StatusTC2 == '' || StatusTC2 == 0) {
                    document.getElementById('<%=ddlStatusTC2.ClientID %>').style.borderColor = "#F7627F";
                    return true;
                }
                else {
                    if (document.getElementById('<%=ddlStatusTC1.ClientID %>') != null)
        ...
        function ValidateStatusTC3() {

            if (document.getElementById('<%=ddlStatusTC3.ClientID %>') != null) {
                var StatusTC3 = document.getElementById('<%=ddlStatusTC3.ClientID %>').selectedIndex;
                if (StatusTC3 == '' || StatusTC3 == 0) {
                    document.getElementById('<%=ddlStatusTC3.ClientID %>').style.borderColor = "#F7627F";
                    return true;
                }
                else {
                    if (document.getElementById('<%=ddlStatusTC1.ClientID %>') != null)
        ...
        function ValidateRejectedReasonTC1() {
            var StatusTC1 = document.getElementById('<%=ddlStatusTC1.ClientID %>').selectedIndex;

            if (StatusTC1 > 0) {
                if (StatusTC1 == 2) {
                    var rejectedRemarks = document.getElementById('<%=txtTC1RemarksToUpload.ClientID %>').value;
                    if (rejectedRemarks == '') {
                        document.getElementById('<%=txtTC1RemarksToUpload.ClientID %>').style.borderColor = "#F7627F";
                        return true;
                    }
                    else {
                        document.getElementById('<%=txtTC1RemarksToUpload.ClientID %>').style.borderColor = "";
                        return false;
                    }
                }
            }
        ...
        function ValidateRejectedReasonTC2() {

            var StatusTC2 = document.getElementById('<%=ddlStatusTC2.ClientID %>').selectedIndex;

            if (StatusTC2 > 0) {
                if (StatusTC2 == 2) {
                    var rejectedRemarks = document.getElementById('<%=txtTC2RemarksToUpload.ClientID %>').value;
                    if (rejectedRemarks == '') {
                        document.getElementById('<%=txtTC2RemarksToUpload.ClientID %>').style.borderColor = "#F7627F";
                        return true;
                    }
                    else {
                        document.getElementById('<%=txtTC2RemarksToUpload.ClientID %>').style.borderColor = "";
                        return false;
                    }
                }
            }
        ...
        function ValidateRejectedReasonTC3() {

            var StatusTC3 = document.getElementById('<%=ddlStatusTC3.ClientID %>').selectedIndex;

            if (StatusTC3 > 0) {
                if (StatusTC3 == 2) {
                    var rejectedRemarks = document.getElementById('<%=txtTC3RemarksToUpload.ClientID %>').value;
                    if (rejectedRemarks == '') {
                        document.getElementById('<%=txtTC3RemarksToUpload.ClientID %>').style.borderColor = "#F7627F";
                        return true;
                    }
                    else {
                        document.getElementById('<%=txtTC3RemarksToUpload.ClientID %>').style.borderColor = "";
                        return false;
                    }
                }
            }
        ...
        function ValidateStatus() {
            ...
            var hdTC1ToUpdateStatusFlag = 0;
            var hdTC2ToUpdateStatusFlag = 0;
            var hdTC3ToUpdateStatusFlag = 0;

            if (document.getElementById('<%=hdTC1ToUpdateStatusFlag.ClientID %>') != null) {
                hdTC1ToUpdateStatusFlag = document.getElementById('<%=hdTC1ToUpdateStatusFlag.ClientID %>').value;
            }

            if (document.getElementById('<%=hdTC2ToUpdateStatusFlag.ClientID %>') != null) {
                hdTC2ToUpdateStatusFlag = document.getElementById('<%=hdTC2ToUpdateStatusFlag.ClientID %>').value;
            }

            if (document.getElementById('<%=hdTC3ToUpdateStatusFlag.ClientID %>') != null) {
                hdTC3ToUpdateStatusFlag = document.getElementById('<%=hdTC3ToUpdateStatusFlag.ClientID %>').value;
            }



            if (parseInt(hdTC1ToUpdateStatusFlag) > 0) {
                needToSelectCount = needToSelectCount + 1;
            }

            if (parseInt(hdTC2ToUpdateStatusFlag) > 0) {
                needToSelectCount = needToSelectCount + 1;
            }

            if (parseInt(hdTC3ToUpdateStatusFlag) > 0) {
                needToSelectCount = needToSelectCount + 1;
            }
            ...
            if (document.getElementById('<%=ddlStatusTC1.ClientID %>') != null) {
                if (parseInt(document.getElementById('<%=ddlStatusTC1.ClientID %>').selectedIndex) > 0) {
                    StatusTC1 = document.getElementById('<%=ddlStatusTC1.ClientID %>').selectedIndex;
                }
            }
            else {
                StatusTC1 = 1;
            ...
            if (document.getElementById('<%=ddlStatusTC2.ClientID %>') != null) {
                if (parseInt(document.getElementById('<%=ddlStatusTC2.ClientID %>').selectedIndex) > 0) {
                    StatusTC2 = document.getElementById('<%=ddlStatusTC2.ClientID %>').selectedIndex;
                }
            }
            else {
                StatusTC2 = 1;
            ...
            if (document.getElementById('<%=ddlStatusTC3.ClientID %>') != null) {
                if (parseInt(document.getElementById('<%=ddlStatusTC3.ClientID %>').selectedIndex) > 0) {
                    StatusTC3 = document.getElementById('<%=ddlStatusTC3.ClientID %>').selectedIndex;
                }
            }
            else {
                StatusTC3 = 1;
            ...
            if (parseInt(StatusTC1) == 0) {
                nonSelectedCount = nonSelectedCount + 1;
            }

            if (parseInt(StatusTC2) == 0) {
                nonSelectedCount = nonSelectedCount + 1;
            }

            if (parseInt(StatusTC3) == 0) {
                nonSelectedCount = nonSelectedCount + 1;
            }

            if (needToSelectCount > 0) {

                if (needToSelectCount == nonSelectedCount) {
                    document.getElementById('<%=hdUpdateStatusFlag.ClientID %>').value = "0";
                ...
                for (var i = 1; i <= needToSelectCount; i++) {

                    if (parseInt(hdTC1SeqNo) > 0 &&
                        parseInt(document.getElementById('<%=hdTC1ToUpdateStatusFlag.ClientID %>').value) > 0 &&
                        parseInt(document.getElementById('<%=hdUpdateStatusFlag.ClientID %>').value) == 0) {

                        if (needToSelectCount == nonSelectedCount) {

                            if (document.getElementById('<%=ddlStatusTC1.ClientID %>') != null) {
                                if (ValidateStatusTC1()) {
                                    check = true;
                                }
                            }
                            else {
                        ...
                        if (check) {
                            ...
                            if (document.getElementById('<%=ddlStatusTC1.ClientID %>') != null) {
                                if (parseInt(document.getElementById('<%=ddlStatusTC1.ClientID %>').selectedIndex) > 0) {
                                    document.getElementById('<%=hdUpdateStatusFlag.ClientID %>').value = "1";
                                }
                            }
                            else {
                                document.getElementById('<%=hdUpdateStatusFlag.ClientID %>').value = "0";
                    ...
                    if (parseInt(hdTC2SeqNo) > 0 &&
                        parseInt(document.getElementById('<%=hdTC2ToUpdateStatusFlag.ClientID %>').value) > 0 &&
                        parseInt(document.getElementById('<%=hdUpdateStatusFlag.ClientID %>').value) == 0) {

                        if (needToSelectCount == nonSelectedCount) {

                            if (document.getElementById('<%=ddlStatusTC2.ClientID %>') != null) {
                                if (ValidateStatusTC2()) {
                                    check = true;
                                }
                            }
                            else {
                    ...
                    if (parseInt(hdTC3SeqNo) > 0 &&
                        parseInt(document.getElementById('<%=hdTC3ToUpdateStatusFlag.ClientID %>').value) > 0 &&
                        parseInt(document.getElementById('<%=hdUpdateStatusFlag.ClientID %>').value) == 0) {

                        if (needToSelectCount == nonSelectedCount) {

                            if (document.getElementById('<%=ddlStatusTC3.ClientID %>') != null) {
                                if (ValidateStatusTC3()) {
                                    check = true;
                                }
                            }
                            else {
    ...
    <script type="text/javascript">
        ...
        function OnChangeStatusTC1() {
            var StatusTC1 = document.getElementById('<%=ddlStatusTC1.ClientID %>').selectedIndex;

            if (StatusTC1 > 0) {
                if (StatusTC1 == 1) {
                    document.getElementById('<%=lblRemarksTxtTC1.ClientID %>').innerHTML = "Accepted Remarks (TC1):"
                }
                else if (StatusTC1 == 2) {
                    document.getElementById('<%=lblRemarksTxtTC1.ClientID %>').innerHTML = "Rejected Reason (TC1):"
                }
            }
            else {
                document.getElementById('<%=lblRemarksTxtTC1.ClientID %>').innerHTML = "Remarks (TC1):"
            }
        }

        function OnChangeStatusTC2() {
            var StatusTC2 = document.getElementById('<%=ddlStatusTC2.ClientID %>').selectedIndex;

            if (StatusTC2 > 0) {
                if (StatusTC2 == 1) {
                    document.getElementById('<%=lblRemarksTxtTC2.ClientID %>').innerHTML = "Accepted Remarks (TC2):"
                }
                else if (StatusTC2 == 2) {
                    document.getElementById('<%=lblRemarksTxtTC2.ClientID %>').innerHTML = "Rejected Reason (TC2):"
                }
            }
            else {
                document.getElementById('<%=lblRemarksTxtTC2.ClientID %>').innerHTML = "Remarks (TC2):"
            }
        }

        function OnChangeStatusTC3() {
            var StatusTC3 = document.getElementById('<%=ddlStatusTC3.ClientID %>').selectedIndex;

            if (StatusTC3 > 0) {
                if (StatusTC3 == 1) {
                    document.getElementById('<%=lblRemarksTxtTC3.ClientID %>').innerHTML = "Accepted Remarks (TC3):"
                }
                else if (StatusTC3 == 2) {
                    document.getElementById('<%=lblRemarksTxtTC3.ClientID %>').innerHTML = "Rejected Reason (TC3):"
                }
            }
            else {
                document.getElementById('<%=lblRemarksTxtTC3.ClientID %>').innerHTML = "Remarks (TC3):"
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:HiddenField ID="hdUploadConfirmValue" runat="server" />
    <asp:HiddenField ID="hdUpdateStatusFlag" runat="server" />
    <asp:HiddenField ID="hdUpdateStatausConfirmValue" runat="server" />
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Procurement Status- TC List:
                ...
                <div class="form-grid form-grid-3">
                    ...
                    <label>Identification Refrernce No.:</label>
                    <asp:TextBox ID="txtIdentificationRefrernceNo" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div class="full-width button-group">
                ...
                <asp:Button ID="btnDownload" CssClass="button" Width="100%" runat="server" Text="Download"
        ...
        <div class="employee-grid-container">
            ...
            <asp:GridView
                ...
                ID="gvTCList" runat="server" CellPadding="4" ForeColor="#333333"
                AutoGenerateColumns="false" Width="100%" HorizontalAlign="Center"
                OnRowDataBound="gvTCList_RowDataBound"
                OnRowCommand="gvTCList_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Button ID="btnCheck" CommandArgument="CHECK_TC" ToolTip="Check TC" runat="server"
                                Text="Check TC" CssClass="cancelbutton" Width="95%" BorderColor="Yellow" BorderStyle="Solid" BorderWidth="2px" />
                    ...
                    <asp:TemplateField HeaderText="PO No.">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblAssignedTo1" runat="server" Visible="false" Text='<%# Eval("ASSIGNED_TO1") %>' />
                            <asp:Label ID="lblAssignedTo2" runat="server" Visible="false" Text='<%# Eval("ASSIGNED_TO2") %>' />
                            <asp:Label ID="lblAssignedTo3" runat="server" Visible="false" Text='<%# Eval("ASSIGNED_TO3") %>' />
                            ...
                            <asp:Label ID="lblUploadedByIDTC1" runat="server" Visible="false" Text='<%# Eval("UPLOADED_BY1") %>' />
                            <asp:Label ID="lblUploadedByIDTC2" runat="server" Visible="false" Text='<%# Eval("UPLOADED_BY2") %>' />
                            <asp:Label ID="lblUploadedByIDTC3" runat="server" Visible="false" Text='<%# Eval("UPLOADED_BY3") %>' />

                            <asp:Label ID="lblAcceptedByIDTC1" runat="server" Visible="false" Text='<%# Eval("ACCEPTED_BY1") %>' />
                            <asp:Label ID="lblAcceptedByIDTC2" runat="server" Visible="false" Text='<%# Eval("ACCEPTED_BY2") %>' />
                            <asp:Label ID="lblAcceptedByIDTC3" runat="server" Visible="false" Text='<%# Eval("ACCEPTED_BY3") %>' />

                            <asp:Label ID="lblRejectedByIDTC1" runat="server" Visible="false" Text='<%# Eval("REJECTED_BY1") %>' />
                            <asp:Label ID="lblRejectedByIDTC2" runat="server" Visible="false" Text='<%# Eval("REJECTED_BY2") %>' />
                            <asp:Label ID="lblRejectedByIDTC3" runat="server" Visible="false" Text='<%# Eval("REJECTED_BY3") %>' />

                            <asp:Label ID="lblIsAcceptedMailSentTC1" runat="server" Visible="false" Text='<%# Eval("IS_ACCEPTED_MAIL_SENT1") %>' />
                            <asp:Label ID="lblIsAcceptedMailSentTC2" runat="server" Visible="false" Text='<%# Eval("IS_ACCEPTED_MAIL_SENT2") %>' />
                            <asp:Label ID="lblIsAcceptedMailSentTC3" runat="server" Visible="false" Text='<%# Eval("IS_ACCEPTED_MAIL_SENT3") %>' />

                            <asp:Label ID="lblIsRejectedMailSentTC1" runat="server" Visible="false" Text='<%# Eval("IS_REJECTED_MAIL_SENT1") %>' />
                            <asp:Label ID="lblIsRejectedMailSentTC2" runat="server" Visible="false" Text='<%# Eval("IS_REJECTED_MAIL_SENT2") %>' />
                            <asp:Label ID="lblIsRejectedMailSentTC3" runat="server" Visible="false" Text='<%# Eval("IS_REJECTED_MAIL_SENT3") %>' />
                    ...
                    <asp:TemplateField HeaderText="Identification Reference No(s)">
                        <ItemTemplate>
                            <asp:Label ID="lblIdentificationReferenceNo" runat="server" Text='<%# Eval("IDENTIFICATION_REFERENCE_NO") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Is Completed">
                        <ItemTemplate>
                            ...
                            <asp:CheckBox ID="chkIsCompleted" runat="server" Enabled="false" />
                        </ItemTemplate>
                    </asp:TemplateField>


                    <asp:TemplateField HeaderText="Completed Remarks">
                        <ItemTemplate>
                            <asp:Label ID="lblIsCompletedRemarks" runat="server" Visible="true" Text='<%# Eval("IS_COMPLETED_REMARKS") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="TC1_Uploaded_ON">
                        <ItemTemplate>
                            <asp:Label ID="lblUploadedOnTC1" runat="server" Visible="true" Text='<%# Eval("UPLOADED_ON1") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="TC2_Uploaded_ON">
                        <ItemTemplate>
                            <asp:Label ID="lblUploadedOnTC2" runat="server" Visible="true" Text='<%# Eval("UPLOADED_ON2") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="TC3_Uploaded_ON">
                        <ItemTemplate>
                            <asp:Label ID="lblUploadedOnTC3" runat="server" Visible="true" Text='<%# Eval("UPLOADED_ON3") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="MR_Created_By">
                        <ItemTemplate>
                            <asp:Label ID="lblMRCreatedBy" runat="server" Visible="true" Text='<%# Eval("MR_CREATED_BY") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <asp:Panel ID="pnlViewDetailPopup" runat="server"
        ...
        <div class="form-container">
            <fieldset class="form-card">
                ...
                <legend>
                    <asp:Label ID="lblTCHeadingText" runat="server" />
                </legend>

                <div class="form-grid form-grid-2">

                    <label>PO No.:</label>
                    <asp:TextBox ID="txtPONoToUpload" runat="server" CssClass="form-control"
                        Enabled="false"></asp:TextBox>

                    <label>PO Date:</label>
                    <asp:TextBox ID="txtPODateToUpload" runat="server" CssClass="form-control"
                        Enabled="false"></asp:TextBox>
                    ...
                    <%--onchange="CheckForIdentityRemarks()"--%>
                ...
                <div class="form-grid form-grid-2">
                    ...
                    <div class="full-width">
                        <table width="100%">
                            <tr id="trTC1" runat="server">
                                <td>
                                    ...
                                    <fieldset class="form-card">
                                        ...
                                        <asp:HiddenField ID="hdIsCompletedRemarks" runat="server" Value="" />
                                        <asp:Label ID="lblAttachOrViewTxtTC1" runat="server" Text="Attach " />
                                        <asp:HiddenField ID="hdTC1RecordID" runat="server" Value="0" />
                                        (TC1):
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td style="width: 75%;">
                                                        ...
                                                        <asp:HiddenField ID="hdTC1ToUpdateStatusFlag" runat="server" Value="0" />
                                                    ...
                                                    <td style="width: 10%;">
                                                        <asp:ImageButton ID="imgBtnRemoveTC1ToView" runat="server" Height="25px" Width="25px"
                                                            OnClick="imgBtnRemoveTC1ToView_Click"
                                        ...
                                        <label>Uploaded Remarks (TC1):</label>
                                        <asp:TextBox ID="txtTC1UploadedRemarks" runat="server" 
                                            CssClass="form-control"
                                        ...
                                        <div class="full-width">
                                            <table width="100%">
                                                ...
                                                <tr id="trTC1RemarksAndStatus" runat="server">
                                                    <td>Status (TC1):</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlStatusTC1" runat="server" 
                                                            CssClass="form-control"
                                                            onchange="OnChangeStatusTC1()" />
                                                    </td>

                                                    <td>&nbsp;</td>

                                                    <td>
                                                        <asp:Label ID="lblRemarksTxtTC1" runat="server" Text="Remarks (TC1):" />
                                                    </td>
                                                    <td>
                            ...
                            <tr id="trTC2" runat="server">
                                <td>
                                    <fieldset class="form-card">
                                        <legend>TC2</legend>


                                        <asp:Label ID="lblAttachOrViewTxtTC2" runat="server" Text="Attach " />
                                        <asp:HiddenField ID="hdTC2RecordID" runat="server" Value="0" />
                                        (TC2):
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td style="width: 75%;">
                                                        ...
                                                        <asp:HiddenField ID="hdTC2ToUpdateStatusFlag" runat="server" Value="0" />
                                        ...
                                        <label>Uploaded Remarks (TC2):</label>
                                        <asp:TextBox ID="txtTC2UploadedRemarks" runat="server" 
                                            CssClass="form-control"
                                            TextMode="MultiLine" Rows="2" Enabled="false" />

                                        <label>Identification Reference No. (TC2):</label>
                                        ...
                                        <div class="full-width">
                                            <table width="100%">
                                                <tr id="trTC2RemarksAndStatus" runat="server">
                                                    <td>Status (TC2):</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlStatusTC2" runat="server" 
                                                            CssClass="form-control"
                                                            onchange="OnChangeStatusTC2()" />
                                                    </td>

                                                    <td>&nbsp;</td>

                                                    <td>
                                                        <asp:Label ID="lblRemarksTxtTC2" runat="server" Text="Remarks (TC2):" />
                                                    </td>
                                                    <td>
                            ...
                            <tr id="trTC3" runat="server">
                                <td>
                                    <fieldset class="form-card">
                                        ...
                                        <asp:Label ID="lblAttachOrViewTxtTC3" runat="server" Text="Attach " />
                                        <asp:HiddenField ID="hdTC3RecordID" runat="server" Value="0" />
                                        (TC3):
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td style="width: 75%;">
                                                        ...
                                                        <asp:HiddenField ID="hdTC3ToUpdateStatusFlag" runat="server" Value="0" />
                                        ...
                                        <label>Uploaded Remarks (TC3):</label>
                                        <asp:TextBox ID="txtTC3UploadedRemarks" runat="server" 
                                            CssClass="form-control"
                                            TextMode="MultiLine" Rows="2" Enabled="false" />
                                        ...
                                        <div class="full-width">
                                            <table width="100%">
                                                ...
                                                <tr id="trTC3RemarksAndStatus" runat="server">
                                                    <td>Status (TC3):</td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlStatusTC3" runat="server" 
                                                            CssClass="form-control"
                                                            onchange="OnChangeStatusTC3()" />
                                                    </td>

                                                    <td>&nbsp;</td>

                                                    <td>
                                                        <asp:Label ID="lblRemarksTxtTC3" runat="server" Text="Remarks (TC3):" />
                                                    </td>
                                                    <td>
            ...
            <div class="full-width button-group">
                ...
                <asp:Button ID="btnUpdateStatus" CssClass="button" Width="100%" runat="server"
                    Text="Update TC Status"
                    OnClick="btnUpdateStatus_Click" OnClientClick="return ValidateAllStatus();" />

                <asp:Button ID="btnUpload" CssClass="button" Width="100%" runat="server"
                    Text="Upload TC"
    ...
    <%-- VIEW TC DETAIL IN PDF START--%>
    <asp:Button ID="btnTCViewInPDF" runat="server" Style="display: none" />
    <asp:ModalPopupExtender ID="mpeViewInPDF" runat="server" TargetControlID="btnTCViewInPDF"
        PopupControlID="pnlBtnTCViewInPDFPopup" CancelControlID="imgBtnTCViewInPDFPopup"
        BackgroundCssClass="modalBackground">
    </asp:ModalPopupExtender>
    <asp:Panel ID="pnlBtnTCViewInPDFPopup" runat="server"
        CssClass="popup-pdf">
        <table width="100%">
            <tr>
                <td align="right">
                    <asp:ImageButton ID="imgBtnTCViewInPDFPopup" ImageUrl="~/Images/cancelled_img.png"
                        runat="server" />
                </td>
            </tr>
        </table>
        <iframe
            class="popup-iframe"
            id="iframeViewTCDetailsInPDF"
            runat="server"></iframe>
    </asp:Panel>
    <%-- VIEW TC DETAIL IN PDF END--%>
