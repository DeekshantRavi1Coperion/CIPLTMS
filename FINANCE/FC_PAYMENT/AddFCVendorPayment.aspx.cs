...
public partial class FINANCE_FC_PAYMENT_AddFCVendorPayment : System.Web.UI.Page
{
    ...
    DataSet dsVendorDetail = new DataSet();
    ...
    private Byte[] _InvoiceFileBytes;
    private decimal _RequestedAmountToBeReleased;
    ...
    private string _PaymentFileName;
    private Byte[] _PaymentFileBytes;
    ...
    public string VendorCode
    {
        get
        {
            _VendorCode = txtVendorCode.Text;
            return _VendorCode;
        }
    ...
    public string VendorName
    {
        get
        {
            _VendorName = txtVendorName.Text;
            return _VendorName;
        }
    ...
    public string VendorAddress
    {
        get
        {
            _VendorAddress = txtVendorAddress.Text;
    ...
    public string InvoiceFileName
    {
        get
        {
            if (uploadFileAttachmentInvoice.HasFile)
            {

                if (!string.IsNullOrEmpty(uploadFileAttachmentInvoice.PostedFile.FileName))
                {
                    _InvoiceFileName = uploadFileAttachmentInvoice.PostedFile.FileName;
                }
            }

            return _InvoiceFileName;
        }
    ...
    public Byte[] InvoiceFileBytes
    {
        get
        {
            if (uploadFileAttachmentInvoice.HasFile)
            {
                if (!string.IsNullOrEmpty(uploadFileAttachmentInvoice.PostedFile.FileName))
                {
                    //string[] str = uploadFileAttachmentInvoice.PostedFile.FileName.Split('\\');
                    //int length = str.Length;
                    //SiDrawing1File = str[str.Length - 1];
                    _InvoiceFileBytes = GetFileBytes(uploadFileAttachmentInvoice.PostedFile.FileName, uploadFileAttachmentInvoice.PostedFile.InputStream);
                }
            }

            return _InvoiceFileBytes;

        }

        set
        {
            _InvoiceFileBytes = value;
        }
    }

    //public int CurrencyToBeReleasedID
    //{
    //    get
    //    {
    //        _CurrencyToBeReleasedID = Convert.ToInt32(ddlCurrencyToBeReleased.SelectedValue);
    //        return _CurrencyToBeReleasedID;
    //    }

    //    set
    //    {
    //        _CurrencyToBeReleasedID = value;
    //    }
    //}

    //public string OtherCurrencyToBeReleased
    //{
    //    get
    //    {
    //        _OtherCurrencyToBeReleased = txtOtherCurrencyToBeReleased.Text;
    //        return _OtherCurrencyToBeReleased;
    //    }

    //    set
    //    {
    //        _OtherCurrencyToBeReleased = value;
    //    }
    //}

    public decimal RequestedAmountToBeReleased
    {
        get
        {
            _RequestedAmountToBeReleased = Convert.ToDecimal(txtRequestedAmountToBeReleased.Text);
            return _RequestedAmountToBeReleased;
        }

        set
        {
            _RequestedAmountToBeReleased = value;
        }
    }
    ...
    public int PaymentTypeID
    {
        get
        {
            _PaymentTypeID = Convert.ToInt32(ddlPaymentType.SelectedValue);
    ...
    public string InvoiceNo
    {
        get
        {
            _InvoiceNo = txtVendorInvoiceNo.Text;
            return _InvoiceNo;
        }
    ...
    public string InvoiceDate
    {
        get
        {
            _InvoiceDate = Convert.ToDateTime(txtVendorInvoiceDate.Text).ToString("yyyy-MM-dd");
            return _InvoiceDate;
        }
    ...
    public string BankName
    {
        get
        {
            _BankName = txtVendorBankName.Text;
            return _BankName;
        }
    ...
    public string BankBranch
    {
        get
        {
            _BankBranch = txtBankVendorBranch.Text;
            return _BankBranch;
        }
    ...
    public string SwiftCode
    {
        get
        {
            _SwiftCode = txtVendorSwiftCode.Text;
            return _SwiftCode;
        }
    ...
    public string BankAccountNo
    {
        get
        {
            _BankAccountNo = txtBankAccountNumber.Text;
    ...
    public string CutOffDate
    {
        get
        {
            _CutOffDate = Convert.ToDateTime(txtCutOffDate.Text).ToString("yyyy-MM-dd");
            return _CutOffDate;
        }
    ...
    public string PaymentFileName
    {
        get
        {
            ...
            //    if (!string.IsNullOrEmpty(uploadFileAttachmentInvoice.PostedFile.FileName))
            //    {
            //        _PaymentFileName = uploadFileAttachmentInvoice.PostedFile.FileName;
            //    }
            //}

            _PaymentFileName = string.Empty;
            return _PaymentFileName;
        }

        set
        {
            _PaymentFileName = value;
        }
    }
    ...
    public Byte[] PaymentFileBytes
    {
        get
        {
            ...
            //        int length = str.Length;
            //        SiDrawing1File = str[str.Length - 1];
            //        _PaymentFileBytes = GetFileBytes(uploadFileAttachmentInvoice.PostedFile.FileName, uploadFileAttachmentInvoice.PostedFile.InputStream);
            //    }
            //}

            _PaymentFileBytes = null;
            return _PaymentFileBytes;

        }

        set
        {
            _PaymentFileBytes = value;
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["EMP_RECORD_ID"] != null)
        {
            ...
            if (!IsPostBack)
            {
                ...
                hdVendorInvoiceDate.Value = DateTime.Now.ToString("dd-MMM-yyyy");
                txtVendorInvoiceDate.Text = hdVendorInvoiceDate.Value;

                hdCutOffDate.Value = DateTime.Now.ToString("dd-MMM-yyyy");
                txtCutOffDate.Text = hdCutOffDate.Value;
    ...
    {
        Response.Redirect("~/FINANCE/FC_PAYMENT/FCVendorPaymentsList.aspx");
    }
    ...
    protected void btnGetVendor_Click(object sender, EventArgs e)
    {
        mpeVendorDetail.Show();
        GetVendorDetail();
    }

    protected void btnSearchVendorDetails_Click(object sender, EventArgs e)
    {
        mpeVendorDetail.Show();
        GetVendorDetail();
    }
    ...
    protected void gvVendorDetail_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                Label lblPONo = gvVendorDetail.Rows[rowindex].FindControl("lblPONo") as Label;
                Label lblVendorCode = gvVendorDetail.Rows[rowindex].FindControl("lblVendorCode") as Label;
                Label lblVendorName = gvVendorDetail.Rows[rowindex].FindControl("lblVendorName") as Label;
                Label lblVendorAddress = gvVendorDetail.Rows[rowindex].FindControl("lblVendorAddress") as Label;
                Label lblVendorBankName = gvVendorDetail.Rows[rowindex].FindControl("lblVendorBankName") as Label;
                Label lblVendorBankBranch = gvVendorDetail.Rows[rowindex].FindControl("lblVendorBankBranch") as Label;
                Label lblVendorBankIFSCSWIFT = gvVendorDetail.Rows[rowindex].FindControl("lblVendorBankIFSCSWIFT") as Label;
                Label lblVendorBankAccountNo = gvVendorDetail.Rows[rowindex].FindControl("lblVendorBankAccountNo") as Label;

                Label lblTotalPOAmount = gvVendorDetail.Rows[rowindex].FindControl("lblTotalPOAmount") as Label;
                Label lblPOAmountCurrency = gvVendorDetail.Rows[rowindex].FindControl("lblPOAmountCurrency") as Label;
                Label lblReleasedAmount = gvVendorDetail.Rows[rowindex].FindControl("lblReleasedAmount") as Label;

                txtPONo.Text = Convert.ToString(lblPONo.Text).Trim();
                txtVendorCode.Text = Convert.ToString(lblVendorCode.Text).Trim();
                txtVendorName.Text = Convert.ToString(lblVendorName.Text).Trim();
                txtVendorAddress.Text = Convert.ToString(lblVendorAddress.Text).Trim();

                txtVendorBankName.Text = Convert.ToString(lblVendorBankName.Text).Trim();
                txtBankVendorBranch.Text = Convert.ToString(lblVendorBankBranch.Text).Trim();
                txtVendorSwiftCode.Text = Convert.ToString(lblVendorBankIFSCSWIFT.Text).Trim();
                txtBankAccountNumber.Text = Convert.ToString(lblVendorBankAccountNo.Text).Trim();

                txtTotalPOAmount.Text = Convert.ToString(lblTotalPOAmount.Text).Trim();
                txtPOAmountCurrency.Text = Convert.ToString(lblPOAmountCurrency.Text).Trim();
                txtReleasedAmount.Text = Convert.ToString(lblReleasedAmount.Text).Trim();

                txtBalanceAmount.Text = Convert.ToString(Convert.ToDecimal(txtTotalPOAmount.Text) - Convert.ToDecimal(txtReleasedAmount.Text));
                txtRequestedAmountToBeReleased.Text = txtBalanceAmount.Text;
            }
            else
            {
                Response.Redirect("~/Login.aspx");
    ...
    private void SaveVendorPayment()
    {
        try
        {
            ...
            if (paymentID > 0)
            {
                ...
                if (mailSentValue > 0)
                {
                    int sentMailStatus = objFCVendorPayment.UpdateVendorPaymentMailStatus(paymentID, (int)FCVendorPaymentStatusTypes.EnumStatus.OPEN);
                    SuccessMessage("Payment saved with Request No.: '" + requestNo + "' and mail sent successfully.");
                }
                else
                {
                    SuccessMessage("Payment saved with Request No.: '" + requestNo + "'. Please go to list to send email!");
                }
    ...
    //    try
    //    {
    //        dsCurrency = objFCVendorPayment.GetCurrencys();
    //        if (dsCurrency.Tables.Count > 0 && dsCurrency.Tables[0].Rows.Count > 0)
    //        {
    //            ddlCurrencyToBeReleased.DataSource = dsCurrency.Tables[0];
    //            ddlCurrencyToBeReleased.DataTextField = "CURRENCY_NAME";
    //            ddlCurrencyToBeReleased.DataValueField = "CURRENCY_ID";
    //            ddlCurrencyToBeReleased.DataBind();
    //            //ddlCurrencyToBeReleased.Items.Insert(0, "Select");
    //        }
    //    }
    //    catch (Exception ex)
    //    {
    ...
    private void BindPaymentType()
    {
        try
        {
            ...
            {
                ddlPaymentType.DataSource = dsPaymentType.Tables[0];
                ddlPaymentType.DataTextField = "NAME";
                ddlPaymentType.DataValueField = "PID";
    ...
    private DataSet GetJOBData()
    {
        try
        {
            ...
            dsJobNo = objFCVendorPayment.GetJOBDetails(custCode, jobNo);
    ...
    private DataSet GetVendorData()
    {
        try
        {
            ...
            if (!string.IsNullOrEmpty(txtVendorCodeSearch.Text))
                vendorCode = txtVendorCodeSearch.Text;

            if (!string.IsNullOrEmpty(txtVendorNameSearch.Text))
                vendorName = txtVendorCodeSearch.Text;

            if (!string.IsNullOrEmpty(txtPONoSearch.Text))
                poNo = txtPONoSearch.Text;


            dsVendorDetail = objFCVendorPayment.GetVendorDetails(vendorCode, vendorName, poNo);

            if (dsVendorDetail.Tables.Count > 0)
            {
                return dsVendorDetail;
            }
            else
            {
                return null;
    ...
    private void GetVendorDetail()
    {
        try
        {
            dsVendorDetail = GetVendorData();
            if (dsVendorDetail.Tables.Count > 0 && dsVendorDetail.Tables[0].Rows.Count > 0)
            {
                lblVendorMsg.Visible = false;
                lblVendorMsg.Text = string.Empty;
                gvVendorDetail.DataSource = dsVendorDetail.Tables[0];
                gvVendorDetail.DataBind();
            }
            else
            {
                lblVendorMsg.Visible = true;
                lblVendorMsg.Text = "No data found!";
                gvVendorDetail.DataSource = null;
                gvVendorDetail.DataBind();
            }
            lblVendorRecords.Text = "Records[" + gvVendorDetail.Rows.Count + "]";
        }
        catch (Exception ex)
        {
            ExceptionMessage(ex.ToString());
    ...
    private void AddNewLOTTransmittalToFactory(string LOTMainSubItemIDs, int savingType)
    {
        try
        {
            ...
            if (dsJobApprovers.Tables.Count > 0)
            {
                ...
                {
                    //mpeAddApprovers.Show();
                    //iframeAddApprovers.Attributes.Add(d"src", "UpdateLOTApprover.aspx?jobNo=" + txtJOBNo.Text + "&actID=0&unitid=" + companyID + "");
                    //return;
                }
            }
            else
            ...
            if (value > 0)
            {
                if (savingType == Convert.ToInt32(LOTAllStatusAndTypes.SavingType.SaveAndSendForApproval))
                {
                    ...
                    int sendMailValue = 0;//objLOTSendMail.SendEmailLOT(value, "", txtTFNo.Text, companyID, "", 0, 0, null, 0, 0, 0);
    ...
    private void Reset()
    {
        try
        {
            ...
            txtTotalPOAmount.Text = "0.000";
            txtPOAmountCurrency.Text = string.Empty;
            txtReleasedAmount.Text = "0.000";
            txtBalanceAmount.Text = "0.000";
            txtRequestedAmountToBeReleased.Text = "0.000";

            ddlPaymentType.SelectedIndex = 0;
            txtVendorBankName.Text = string.Empty;
            txtBankVendorBranch.Text = string.Empty;
            txtVendorSwiftCode.Text = string.Empty;
