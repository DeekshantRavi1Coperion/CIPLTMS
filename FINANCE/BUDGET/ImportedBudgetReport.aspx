<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="ImportedBudgetReport.aspx.cs"
    Inherits="FINANCE_BUDGET_ImportedBudgetReport" Title="CIPLTMS- Imported Budget Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center" style="margin-top: 20px;">
        <fieldset style="width: 80%">
            <legend style="text-align: center;">Imported Budget Report</legend>
            <table width="90%">
                <tr>
                    <td>Period:
                    </td>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownList3" runat="server" Width="100%" Height="26px" />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownList1" runat="server" Width="100%" Height="26px" />
                    </td>
                    <td>&nbsp;
                    </td>
                    <td>Period Type:
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownList2" runat="server" Width="100%" Height="26px" />
                    </td>
                    <td>&nbsp;
                    </td>
