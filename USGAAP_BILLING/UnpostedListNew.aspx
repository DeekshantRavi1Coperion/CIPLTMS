<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="UnpostedListNew.aspx.cs"
    Inherits="USGAAP_BILLING_UnpostedListNew" Title="Untitled Page" %>
        ...
        function checkDec1(el) {
            ...
            if (ex.test(el.value) == false) {
                ...
                if (el.value == '') {
                    ...
                    var lblAmountInr = row.cells[13].innerHTML;
                    var pendingpostedValue = row.cells[15].innerHTML;
                    var postingValue = row.cells[16].getElementsByTagName("input")[0].value;
                    ...
                    if (parseFloat(pendingpostedValue) == '0' || pendingpostedValue == '') {
                        ...
                        row.cells[18].getElementsByTagName("input")[0].value = unpostedValue;

                        if (parseFloat(postingValue) == '0' || postingValue == '') {
                            row.cells[18].getElementsByTagName("input")[0].value = lblAmountInr;
                        }
                        ...
                        if (parseFloat(postingValue) == '0' || postingValue == '') {
                            row.cells[18].getElementsByTagName("input")[0].value = pendingpostedValue;
                        }
        ...
        function checkDec2(el) {
            ...
            if (ex.test(el.value) == false) {
                ...
                if (el.value == '') {
                    ...
                    var lblAmountInr = row.cells[13].innerHTML;
                    var pendingpostedValue = row.cells[15].innerHTML;
                    var unpostedValue = row.cells[18].getElementsByTagName("input")[0].value;

                    if (parseFloat(pendingpostedValue) == '0' || pendingpostedValue == '') {
                        postingValue = Math.round((parseFloat(lblAmountInr) - parseFloat(unpostedValue)) * 100) / 100;
                        row.cells[16].getElementsByTagName("input")[0].value = postingValue;

                        if (parseFloat(unpostedValue) == '0' || unpostedValue == '') {
                            row.cells[16].getElementsByTagName("input")[0].value = lblAmountInr;
                        }

                        if (parseFloat(lblAmountInr) < parseFloat(row.cells[16].getElementsByTagName("input")[0].value)) {
                            row.cells[16].getElementsByTagName("input")[0].style.borderColor = "#F7627F";
                            return true;
                        }
                        else {
                        ...
                        if (parseFloat(unpostedValue) == '0' || unpostedValue == '') {
                            row.cells[16].getElementsByTagName("input")[0].value = pendingpostedValue;
                        }

                        if (parseFloat(pendingpostedValue) < parseFloat(row.cells[16].getElementsByTagName("input")[0].value)) {
                            row.cells[16].getElementsByTagName("input")[0].style.borderColor = "#F7627F";
                            return true;
                        }
                        else {
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                ...
                <div class="form-grid form-grid-3">
                    ...
                    <asp:CheckBox ID="chkClearUnclearAll" runat="server"
                        Text="Clear/Unclear All"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="UNPOSTED_VALUE">
                        <ItemTemplate>
                            ...
                            <%--<asp:HiddenField ID="hdUnPostedValue" runat="server" Visible="false" />--%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="END_MARKET">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblEndMarketID" runat="server" Visible="false" Text='<%# Eval("END_MARKET") %>' />
                            <asp:Label ID="lblCountryID" runat="server" Visible="false" Text='<%# Eval("COUNTRY_ID") %>' />
                    ...
                    <asp:BoundField DataField="FACT_COUNTRY" HeaderText="FACT_COUNTRY" />
