...
public partial class ADMIN_MENU_AssignMenu : System.Web.UI.Page
{
    ...
    private void AssignMenu(string type)
    {
        try
        {
            int value = 0;
            if (tvMenu.Nodes.Count > 0)
            {
                for (int i = 0; i < tvMenu.Nodes.Count; i++)
                {
                    ...
                    if (tvMenu.Nodes[i].Checked)
                    {
                        ...
                        if (menuID > 0)
                            value = objCommon.AssignUnassignEmployeeMenu(type, Convert.ToInt32(ddlEmployeeName.SelectedValue), menuID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                    }
                    ...
                    if (tvMenu.Nodes[i].ChildNodes.Count > 0)
                    {
                        for (int j = 0; j < tvMenu.Nodes[i].ChildNodes.Count; j++)
                        {
                            ...
                            if (tvMenu.Nodes[i].ChildNodes[j].Checked)
                            {
                                ...
                                if (childNodeOneID > 0)
                                    value = objCommon.AssignUnassignEmployeeMenu(type, Convert.ToInt32(ddlEmployeeName.SelectedValue), childNodeOneID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                            }
                            ...
                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes.Count > 0)
                            {
                                for (int k = 0; k < tvMenu.Nodes[i].ChildNodes[j].ChildNodes.Count; k++)
                                {
                                    ...
                                    if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].Checked)
                                    {
                                        ...
                                        if (childNodeTwoID > 0)
                                            value = objCommon.AssignUnassignEmployeeMenu(type, Convert.ToInt32(ddlEmployeeName.SelectedValue), childNodeTwoID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                    }
                                        ...
                                        for (int l = 0; l < tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes.Count; l++)
                                        {
                                            ...
                                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].Checked)
                                            {
                                                ...
                                                if (childNodeThreeID > 0)
                                                    value = objCommon.AssignUnassignEmployeeMenu(type, Convert.ToInt32(ddlEmployeeName.SelectedValue), childNodeThreeID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                            }
                                                ...
                                                for (int m = 0; m < tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes.Count; m++)
                                                {
                                                    ...
                                                    if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].Checked)
                                                    {
                                                        ...
                                                        if (childNodeFourID > 0)
                                                            value = objCommon.AssignUnassignEmployeeMenu(type, Convert.ToInt32(ddlEmployeeName.SelectedValue), childNodeFourID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                                    }
                                                        ...
                                                        for (int n = 0; n < tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes.Count; n++)
                                                        {
                                                            ...
                                                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].ChildNodes[n].Checked)
                                                            {
                                                                ...
                                                                if (childNodeFiveID > 0)
                                                                    value = objCommon.AssignUnassignEmployeeMenu(type, Convert.ToInt32(ddlEmployeeName.SelectedValue), childNodeFiveID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                                            }
                                                            ...
                                                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].ChildNodes[n].ChildNodes.Count > 0)
                                                            {
                                                                for (int o = 0; o < tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[n].ChildNodes.Count; o++)
                                                                {
                                                                    ...
                                                                    if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].ChildNodes[n].ChildNodes[o].Checked)
                                                                    {
                                                                        ...
                                                                        if (childNodeSixID > 0)
                                                                            value = objCommon.AssignUnassignEmployeeMenu(type, Convert.ToInt32(ddlEmployeeName.SelectedValue), childNodeSixID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                                                    }
                                                                }
                                                            }
                                                        }
    ...
    private void AssignMenuNew(string type)
    {
        try
        {
            ...
            if (tvMenu.Nodes.Count > 0)
            {
                if (dtEmployee.Rows.Count > 0)
                {
                    ...
                    {
                        int employeeID = Convert.ToInt32(dr["EMP_RECORD_ID"]);
                        ...
                        for (int i = 0; i < tvMenu.Nodes.Count; i++)
                        {
                            ...
                            if (tvMenu.Nodes[i].Checked)
                            {
                                ...
                                if (menuID > 0)
                                    value = objCommon.AssignUnassignEmployeeMenu(type, employeeID, menuID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                            }
                            ...
                            if (tvMenu.Nodes[i].ChildNodes.Count > 0)
                            {
                                for (int j = 0; j < tvMenu.Nodes[i].ChildNodes.Count; j++)
                                {
                                    ...
                                    if (tvMenu.Nodes[i].ChildNodes[j].Checked)
                                    {
                                        ...
                                        if (childNodeOneID > 0)
                                            value = objCommon.AssignUnassignEmployeeMenu(type, employeeID, childNodeOneID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                    }
                                    ...
                                    if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes.Count > 0)
                                    {
                                        for (int k = 0; k < tvMenu.Nodes[i].ChildNodes[j].ChildNodes.Count; k++)
                                        {
                                            ...
                                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].Checked)
                                            {
                                                ...
                                                if (childNodeTwoID > 0)
                                                    value = objCommon.AssignUnassignEmployeeMenu(type, employeeID, childNodeTwoID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                            }
                                            ...
                                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes.Count > 0)
                                            {
                                                for (int l = 0; l < tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes.Count; l++)
                                                {
                                                    ...
                                                    if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].Checked)
                                                    {
                                                        ...
                                                        if (childNodeThreeID > 0)
                                                            value = objCommon.AssignUnassignEmployeeMenu(type, employeeID, childNodeThreeID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                                    }
                                                    ...
                                                    if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes.Count > 0)
                                                    {
                                                        for (int m = 0; m < tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes.Count; m++)
                                                        {
                                                            ...
                                                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].Checked)
                                                            {
                                                                ...
                                                                if (childNodeFourID > 0)
                                                                    value = objCommon.AssignUnassignEmployeeMenu(type, employeeID, childNodeFourID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                                            }
                                                            ...
                                                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].ChildNodes.Count > 0)
                                                            {
                                                                for (int n = 0; n < tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes.Count; n++)
                                                                {
                                                                    ...
                                                                    if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].ChildNodes[n].Checked)
                                                                    {
                                                                        ...
                                                                        if (childNodeFiveID > 0)
                                                                            value = objCommon.AssignUnassignEmployeeMenu(type, employeeID, childNodeFiveID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                                                    }
                                                                    ...
                                                                    if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].ChildNodes[n].ChildNodes.Count > 0)
                                                                    {
                                                                        for (int o = 0; o < tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[n].ChildNodes.Count; o++)
                                                                        {
                                                                            ...
                                                                            if (tvMenu.Nodes[i].ChildNodes[j].ChildNodes[k].ChildNodes[l].ChildNodes[m].ChildNodes[n].ChildNodes[o].Checked)
                                                                            {
                                                                                ...
                                                                                if (childNodeSixID > 0)
                                                                                    value = objCommon.AssignUnassignEmployeeMenu(type, employeeID, childNodeSixID, Convert.ToInt32(Session["EMP_RECORD_ID"]));
                                                                            }
                                                                        }
                                                                    }
                                                                }
    ...
    private void UnassignMenu(string type)
    {
        try
        {
            int value = 0;
            if (tvMenu.Nodes.Count > 0)
            {
                ...
                if (value > 0)
                {
                    SuccessMessage("Menu unassigned successfully.");
                    return;
                }
                else
                {
