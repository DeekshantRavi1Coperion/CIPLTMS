...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center" style="margin-top: 100px;">
        <fieldset style="width: 50%">
            <legend style="text-align: center;">Employee Attendance List</legend>
            <table width="100%">
                <tr>
                ...
                <tr>
                    <td align="right">Employee Code:
                    </td>
                    <td>
                        <asp:TextBox ID="txtEmployeeCode" runat="server" Width="100%" />
                    </td>
    ...
    <div align="center">
        <fieldset style="width: 70%;">
            ...
            <div style='overflow: auto; width: 100%; height: 450PX; border: 1px solid lightgray;'>
                <asp:GridView ID="gvAttendanceList" runat="server" AutoGenerateColumns="False" CellPadding="4"
