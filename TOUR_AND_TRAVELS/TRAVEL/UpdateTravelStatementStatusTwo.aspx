<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateTravelStatementStatusTwo.aspx.cs"
    Inherits="TOUR_AND_TRAVELS_TRAVEL_UpdateTravelStatementStatusTwo" %>
...
<body>
    ...
    <div align="center" style="margin-top: 5px;">
        <fieldset style="width: 90%; margin-top: 5px;">
            ...
            <table style="width: 70%; height: 100%; margin-left: 10px;">
                <tr>
                    ...
                    <td colspan="4">
                        <table width="100%">
                            <tr>
                                ...
                                <td style="width: 10%;" align="right">
                                    <asp:ImageButton ID="btnViewAttachment2" ImageUrl="~/Images/imgicon1.png"
                                        Height="22px" Width="22px" runat="server" OnClick="btnViewAttachment2_Click" />
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td colspan="4">
                        <table width="100%">
                            <tr>
                                ...
                                <td style="width: 10%;" align="right">
                                    <asp:ImageButton ID="btnViewAttachment3" ImageUrl="~/Images/imgicon1.png"
                                        Height="22px" Width="22px" runat="server" OnClick="btnViewAttachment3_Click" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        Tour Cost Recoverable From Client:
                    </td>
                    <td>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <table width="100%">
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtDNNo" runat="server" Width="100%" Enabled="false" Visible="true" />
                                    </td>
                                    <td>
                                        Amount:
                                    </td>
                                    <td>
                                        <table width="100%">
                                            <tr>
                                                <td style="width: 75%;">
                                                    <asp:TextBox ID="txtFinalAmount" runat="server" Width="100%" Visible="true" Enabled="false"
                ...
                <%--<asp:Panel ID="pnlHRRemarks" runat="server" Visible="false">
                    <tr>
                        <td>
                            HR Remarks:
                        </td>
                        <td colspan="4">
                            <asp:TextBox ID="txtHRRemarks" runat="server" Width="100%" Enabled="false" TextMode="MultiLine"
                                Rows="3" />
                        </td>
                    </tr>
                </asp:Panel>--%>
