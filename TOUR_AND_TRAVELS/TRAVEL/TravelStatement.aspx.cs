...
public partial class TOUR_AND_TRAVELS_TRAVEL_TravelStatement : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/TOUR_AND_TRAVELS/TRAVEL/TravelStatementListNewTwo.aspx");
    }
    ...
    private int SendMailNew(int travelStatementID)
    {
        try
        {
            ...
            link = "'" + urlTxt + "/TOUR_AND_TRAVELS/TRAVEL/UpdateTravelStatementStatusTwo.aspx?statementid=" + travelStatementID + "&actid=2&ud=" + userName + "&pd=" + password + "'";
