...
public partial class PROJECT_MGMT_ProjectPivotGroupMonthlyPostedReport : System.Web.UI.Page
{
    ...
    DataSet dsProjectPivotGroupPostedReport = new DataSet();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["EMP_RECORD_ID"] != null)
        {
            if (!IsPostBack)
            {
                Session["dsProjectPivotGroupPostedReport"] = null;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        GetProjectPivotGroupPostedReport();
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        {
            DataTable dt = (DataTable)Session["dsProjectPivotGroupPostedReport"];
            ToCSVNew01(dt);
        }
        else
        {
    ...
    private void GetProjectPivotGroupPostedReport()
    {
        try
        {
            ...
            if (!string.IsNullOrEmpty(Convert.ToString(hdPostingMonth.Value)))
            ...
            dsProjectPivotGroupPostedReport = objProject.GetProjectPivotGroupPostedReport(jobNo, revisionNo, unit, postingMonth, status);
            if (dsProjectPivotGroupPostedReport.Tables.Count > 0 && dsProjectPivotGroupPostedReport.Tables[0].Rows.Count > 0)
            {
                Session["dsProjectPivotGroupPostedReport"] = dsProjectPivotGroupPostedReport.Tables[0];
                gvProjectPivotGroupList.DataSource = dsProjectPivotGroupPostedReport.Tables[0];
    ...
    private void ToCSVNew01(DataTable dt)
    {
        try
        {
            ...
            string fileName = "ProjectPivotGroupPostedReport_" + DateTime.Now.ToString("dd_MMM_yyyy");
            Response.Clear();
