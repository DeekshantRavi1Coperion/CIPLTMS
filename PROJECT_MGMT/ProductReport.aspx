<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ProductReport.aspx.cs" Inherits="PROJECT_MGMT_ProductReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center" style="margin-top: 20px;">
        <fieldset style="width: 90%">
            <legend style="text-align: center;">Product Report</legend>
            <table width="100%">
                <tr>
                    <td align="right">
                        Start Date:
        ...
        <fieldset style="width: 95%;">
            ...
            <div style='overflow: auto; width: 100%; height: 100%; border: 1px solid lightgray;'>
                <asp:GridView ID="gvProductList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    AllowPaging="True" OnPageIndexChanging="gvProductList_PageIndexChanging" OnRowDataBound="gvProductList_RowDataBound">
