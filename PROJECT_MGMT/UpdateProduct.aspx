<%@ Page Title="Tour Information" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="UpdateProduct.aspx.cs" Inherits="PROJECT_MGMT_UpdateProduct" %>
...
<link href="../Styles/ClearCrossInTextbox.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
        function GetItemCode()
        {
             ...
             var TypeText = Type.options[Type.selectedIndex].innerHTML;
             
             var Category = document.getElementById('<%=ddlCategory.ClientID %>');
             var CategoryText = Category.options[Category.selectedIndex].innerHTML;
                                                                                          
             var TypeTextFirstC=TypeText.substring(0,1);
             var CategoryTextFirstC=CategoryText.substring(0,1);
             ...
             document.getElementById('<%=txtProductCode.ClientID %>').value=productcodeTxt;
        }                      
    </script>
                ...
                <fieldset style="width: 70%;">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <asp:DropDownList ID="ddlEstimatedItem" runat="server" Width="100%" Height="25px"
                                    onblur="return ValidateEstimatedItem();">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlGroup" runat="server" Width="100%" Height="25px" onblur="return ValidateProject();"
                            ...
                            <td>
                                <asp:DropDownList ID="ddlSubgroup" runat="server" Width="100%" Height="25px" onblur="return ValidateType();">
                                    <asp:ListItem Text="Select" Value="0" />
                                    <asp:ListItem Text="Boughtout" Value="1" />
                                    <asp:ListItem Text="Assembled" Value="2" />
                                </asp:DropDownList>
                            ...
                            <td colspan="4">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td align="center" style="width: 45%">
                                            <asp:Button ID="btnProductList" CssClass="button" runat="server" Text="Product List"
                                                OnClick="btnProductList_Click" Width="100%" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
