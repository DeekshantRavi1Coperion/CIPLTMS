<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateProductNew.aspx.cs"
    Inherits="PROJECT_MGMT_UpdateProductNew" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function GetItemCode()
        {
             ...
             document.getElementById('<%=txtItemCode.ClientID %>').value=itemcodeTxt;
        }                      
    </script>
    ...
    <script type="text/javascript">
        ...
        function ValidateAll() {
            ...
            if (ValidateItemCode()) {return false;}
    ...
    <div align="center" style="margin-top: 20px;">
        <fieldset style="width: 60%;">
            <legend style="text-align: center;">
                <asp:Label ID="lblLegend" runat="server" Text="Add New Product"></asp:Label></legend>
            <table width="100%">
