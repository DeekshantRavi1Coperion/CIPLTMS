<%@ Page Title="CIPLTMS-Transmittal To Factory Report [Production]" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    EnableViewState="true" CodeFile="LOTTransmittalFactoryReportForProduction.aspx.cs" Inherits="PROJECT_LOT_LOTTransmittalFactoryReportForProduction" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>LOT Report For Production:
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Drawing (.dwg/.dxf)" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="imgSIBtnAttachment2" Height="30px" Width="30px" CommandArgument="ViewSIATTACHMENT2"
                                runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Drg.3" Visible="false">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="imgSIBtnAttachment3" Height="30px" Width="30px" CommandArgument="ViewSIATTACHMENT3"
                                runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
