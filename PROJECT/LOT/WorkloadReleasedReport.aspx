...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">        
        var GridId = "<%=gvWorkloadReleasedList.ClientID %>";
                            ...
                            <tr>
                                <td>
                                    <asp:DropDownList ID="ddlOnWhichDate" runat="server"
                                        ...
                                        <asp:ListItem Text="LOT Date" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="Production Order Delivery Date" Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
