...
public partial class PROJECT_LOT_LOTTransmittalFactoryReportForQA : System.Web.UI.Page
{
    ...
    private void GetLOTList()
    {
        try
        {
            ...
            dsLOTList = objProject.GetLOTReportForQA(startDate, endDate, LOTTFNo, statusID, unitID, jobNo, customerName, LOTMainItemID, LOTMainSubitemID,
                                                tagNumber, drawingNumber, productionOrderNo, productCode, productDesc, isPartOfProductionID);
