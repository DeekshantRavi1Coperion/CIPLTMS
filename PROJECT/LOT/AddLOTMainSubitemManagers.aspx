<%@ Page Title="CIPLTMS-Transmittal To Factory" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="AddLOTMainSubitemManagers.aspx.cs" Inherits="PROJECT_LOT_AddLOTMainSubitemManagers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ValidateLOTMainSubitems() {
            var LOTMainSubitem = document.getElementById('<%=ddlLOTMainSubitems.ClientID %>').selectedIndex;
    ...
    <script type="text/javascript">
        ...
        function ValidateAll() {
            ...
            if (check) {
                if (confirm("Would you like to add manager?")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div class="form-container">
        <fieldset class="form-card">
            ...
            <legend>Add LOT Main Subitem Manager</legend>
        ...
        <div class="full-width button-group">
            ...
            <asp:Button ID="btnMangerList" runat="server" Width="100%" Text="Manager List" CssClass="button"
                OnClick="btnMangerList_Click" />
