<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateInwardOutwardStatusNewOne.aspx.cs"
    Inherits="PROJECT_UpdateInwardOutwardStatusNewOne" %>
            ...
            <fieldset style="width: 96%; margin-left: 9px; margin-top: 10px; height: 250px;">
                ...
                <div style='overflow: auto; width: 99%; height: 230px; border: 1px solid lightgray;
                    ...
                    <table width="90%" align="center">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btnTourList" CssClass="button" runat="server" Text="View Inward List"
                                    Width="100%" OnClick="btnInwardOutwardList_Click" />
                            </td>
                        </tr>
                    </table>
                </div>
