<%@ Page Title="CIPLTMS- MRN Report" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="MRNQAReport.aspx.cs" Inherits="PROJECT_MRNQA_MRNQAReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center" style="margin-top: 20px;">
        <fieldset style="width: 70%">
            <legend style="text-align: center;">MRN Report</legend>
            <table width="100%">
                <tr>
            ...
            <div style='overflow: auto; width: 100%; height: 400px; border: 1px solid lightgray;'>
                <asp:GridView ID="gvMRNList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="MRN_DATE" HeaderText="MRN_Date" />
                        ...
                        <asp:BoundField DataField="ASSIGNED_TO_REMARKS" HeaderText="Created_Remarks" />

                        <asp:BoundField DataField="CHECKED_BY" HeaderText="Checked_By" />
                        <asp:BoundField DataField="CHECKED_ON" HeaderText="Checked_On" />
                        <asp:BoundField DataField="CHECKED_REMARKS" HeaderText="Checked_Remarks" />

                        <asp:BoundField DataField="REJECTED_BY" HeaderText="Rejected_By" />
                        <asp:BoundField DataField="REJECTED_ON" HeaderText="Rejected_On" />
                        <asp:BoundField DataField="REJECTED_REMARKS" HeaderText="Rejected_Remarks" />
