<%@ Page Title="CIPLTMS- Add Design Checker" Language="C#" MasterPageFile="~/HOME.master"
    AutoEventWireup="true" CodeFile="AddDesignChecker.aspx.cs" Inherits="PROJECT_DMS_AddDesignChecker" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div class="form-container">
        <fieldset class="form-card">
            <legend>
                <asp:Label ID="lblLegend" runat="server" Text="Add Design Checker"></asp:Label>
            </legend>
        ...
        <div class="full-width button-group">
            ...
            <asp:Button ID="btnCheckerList" CssClass="button" runat="server" Text="Checker List"
                OnClick="btnCheckerList_Click" Width="100%" />
        </div>
