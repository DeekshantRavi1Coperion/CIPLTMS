<%@ Page Title="CIPLTMS- Assign Items To Machines" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    MaintainScrollPositionOnPostback="true" CodeFile="ScheduleMachines.aspx.cs"
    Inherits="PROJECT_MACHINE_SCH_ScheduleMachines" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function clientChangedScheduleDates(sender, args) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center">
        <fieldset style="width: 95%;">
            <table width="70%">
                ...
                <tr>
                    <td style="width: 10%;">Select All:</td>
                    <td>
                        <asp:CheckBox ID="chkSelectAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkSelectAll_CheckedChanged" /></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td style="width: 20%;">
                    ...
                    <td>&nbsp;</td>
                    <td style="width: 20%;">
                        <asp:Button ID="btnSaveAll" runat="server" Width="100%" Text="Save All" CssClass="button"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle"
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Button ID="btnScheduleMachines" CommandArgument="SCHEDULE" ToolTip="Scuedule Machines" runat="server"
                                    Text="Schedular" CssClass="cancelbutton" Width="100%" BorderColor="Yellow" BorderStyle="Solid" BorderWidth="2px" />
                        ...
                        <asp:TemplateField HeaderText="Type">
                            <ItemTemplate>
                                <asp:TextBox ID="txtType" Width="70px" runat="server" Enabled="false" CssClass="textboxleftgreen" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Activity">
                            <ItemTemplate>
                                <asp:TextBox ID="txtActivity" Width="100px" runat="server" Enabled="false" CssClass="textboxleftgreen" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Machine">
                            <ItemTemplate>
                                <asp:TextBox ID="txtMachine" Width="250px" runat="server" Enabled="false" CssClass="textboxleftgreen" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Scheduled From">
                            <ItemTemplate>
                                <asp:TextBox ID="txtScheduledFrom" runat="server" Width="100px" Enabled="false" CssClass="textboxleftsmall"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Scheduled To">
                            <ItemTemplate>
                                <asp:TextBox ID="txtScheduledTo" runat="server" Width="100px" Enabled="false" CssClass="textboxleftsmall"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Assigned Drawing Code">
                            <ItemTemplate>
                                <asp:TextBox ID="txtAssignedDrawingCode" Width="180px" runat="server" Enabled="false" CssClass="textboxleftyellow"
                                    Text='<%# Eval("ASSIGNED_DRAWING_CODE") %>' ToolTip='<%# Eval("ASSIGNED_DRAWING_CODE") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Item Desc">
                            <ItemTemplate>
                                <asp:TextBox ID="txtItemDesc" Width="200px" runat="server" TextMode="MultiLine"
                                    Columns="30" Enabled="false" CssClass="textboxleftyellow"
                                    Text='<%# Eval("ITEM_DETAIL") %>' ToolTip='<%# Eval("ITEM_DETAIL") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Date of Receipt of Material">
                            <ItemTemplate>
                                <asp:TextBox ID="txtDateOfReceiptOfMaterial" runat="server" Width="100px" Enabled="false" CssClass="textboxleftgreen"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Commited Date By Shop Incharge">
                            <ItemTemplate>
                                <asp:TextBox ID="txtCommitedDateByShopIncharge" runat="server" Width="100px" Enabled="false" CssClass="textboxleftgreen"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Completion Date">
                            <ItemTemplate>
                                <asp:TextBox ID="txtCompletionDate" runat="server" Width="100px" Enabled="false" CssClass="textboxleftgreen"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <asp:Panel ID="pnlPopupScheduleDates" runat="server" BackColor="White" Height="570px" Width="1000px"
        Style="display: block">
        <table width="100%">
            <tr>
                <td align="right">
        ...
        <div align="center">
            ...
            <fieldset style="width: 95%; margin-top: 10px;">
                <legend style="text-align: center;">
                    <asp:Label ID="lblMachineNameLegend" runat="server" />
                </legend>
                <div align="center">
                    <asp:Panel ID="pnlMachineDatesMsg" Visible="false" runat="server">
                        <asp:Label ID="lblMachineDatesMsg" runat="server" Font-Bold="true" Font-Size="Large" />
                    </asp:Panel>
                </div>
                <div style='overflow: auto; width: 99%; height: 450px; border: 1px solid lightgray; margin-left: 5px;'>
                    <table width="95%">
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                                    ...
                                    <tr>
                                        <td style="width: 90%;">
                                            ...
                                            <ajax:CalendarExtender ID="calendarScheduledFromSchD" PopupButtonID="imgbtnScheduledFromSchD"
                                                ...
                                                OnClientDateSelectionChanged="clientChangedScheduleDates">
                                            </ajax:CalendarExtender>
                                        </td>
                                        <td style="width: 10%;" align="right">
                            ...
                            <td style="width: 30%;">
                                 <asp:Button ID="btnScheduleDates" runat="server" Width="100%" Text="Schedule Dates" CssClass="button"
                                  OnClientClick="return ValidateDateRangeAll();"  OnClick="btnScheduleDates_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                                    ...
                                    <div id="dvScrollMachineRecords" style='overflow: scroll; width: 100%; height: 300px; border: 1px solid lightgray;'>
                                        <asp:GridView ID="gvMachineDatesList" runat="server" AutoGenerateColumns="false" CellPadding="5"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Sr No">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtSrNo" runat="server" Enabled="false" CssClass="textboxcenter" Width="100%"
                                                            Text='<%# Eval("SR_NO") %>' />
                                                ...
                                                <asp:TemplateField HeaderText="Activity Name">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtActivityName" runat="server" Enabled="false" CssClass="textboxleftyellow" Width="100%"
                                                ...
                                                <asp:TemplateField HeaderText="Scheduled From">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtScheduledFrom" runat="server" Enabled="false" CssClass="textboxleftyellow" Width="100%"
                                                ...
                                                <asp:TemplateField HeaderText="Scheduled To">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtScheduledTo" Width="100%" runat="server" Enabled="false" CssClass="textboxleftyellow"
                                                            Text='<%# Eval("SCHEDULE_TO") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Scheduled Days">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtScheduledTo" Width="100%" runat="server" Enabled="false" CssClass="textboxrightsmall"
                                                            Text='<%# Eval("SCHEDULED_DAYS") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
