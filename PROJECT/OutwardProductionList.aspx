<%@ Page Title="CIPLTMS-Outward Information List" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    AspCompat="true" CodeFile="OutwardProductionList.aspx.cs" Inherits="PROJECT_OutwardProductionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function clientChangedUpdations2(sender, args) {

            document.getElementById('<%=HiddenField3.ClientID %>').value = document.getElementById('<%=TextBox15.ClientID %>').value;
           ...
           <%-- document.getElementById('<%=hdEndDate.ClientID %>').value = document.getElementById('<%=txtEndDate.ClientID %>').value;--%>
            ...
            var formatLowerCase = "dd-MMM-yyyy".toLowerCase();
            var formatItems = formatLowerCase.split("-");
            var dateItems = document.getElementById('<%=HiddenField3.ClientID %>').value.split("-");
            var monthIndex = formatItems.indexOf("mmm");
            var dayIndex = formatItems.indexOf("dd");
            var yearIndex = formatItems.indexOf("yyyy");
            var month;
    ...
    <script type="text/javascript">
        ...
        function validateConsignmentFields() {
            check = true; // Reset before validation

            var fields = [
            "<%=txtLRNoC.ClientID %>",
            "<%=txtLRDateC.ClientID %>",
            "<%=txtTruckNoC.ClientID %>",
            "<%=txtFCRBLC.ClientID %>",
            "<%=txtFCRBLDateC.ClientID %>",
            "<%=txtContainerNoC.ClientID %>"
            ];
            ...
            for (var i = 0; i < fields.length; i++) {
                ...
                if (element && element.offsetParent !== null) { // Check if element is visible
                    if (element.value.trim() === "") {
                        element.style.borderColor = "#F7627F";
                        check = false;
                    } else {
                        element.style.borderColor = ""; // Clear any previous error
                    }
                }
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center" style="margin-top: 20px;">
        <fieldset style="width: 70%">
            <legend style="text-align: center;">Outward Information List(Domestic/International)</legend>
            <table width="100%">
                <tr>
    ...
    <div align="center">
        <fieldset style="width: 80%;">
            ...
            <div id="gridContainer" style='overflow-y: scroll; overflow-x: scroll; width: 100%; height: 430px; border: 1px solid lightgray;'>
                <asp:GridView ID="gvOutwardList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ForeColor="#333333" GridLines="Vertical" Width="100%" HorizontalAlign="Center"
                    OnRowCommand="gvOutwardList_RowCommand"
                    OnRowDataBound="gvOutwardList_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="STATUS">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lblOutwardNO" runat="server" Visible="false" Text='<%# Eval("Outward_NO") %>' />
                                <asp:Label ID="lblOutwardDate" runat="server" Visible="false" Text='<%# Eval("OUTWARD_DATE") %>' />
                                ...
                                <asp:Label ID="lblOutwardStatus" runat="server" Visible="false" Text='<%# Eval("OUTWARD_STATUS_NAME") %>' />
                                <asp:Label ID="lblIsInternationalOutward" runat="server" Visible="false" Text='<%# Eval("Outward_TYPE") %>' />
                                <asp:Label ID="lblJobNo" runat="server" Visible="false" Text='<%# Eval("JOB_NO") %>' />
                                <asp:Label ID="lblVendorName" runat="server" Visible="false" Text='<%# Eval("CLIENT_NAME") %>' />
                                <asp:Label ID="lblVendorLocation" runat="server" Visible="false" Text='<%# Eval("CLIENT_LOCATION") %>' />
                                <asp:Label ID="lblVendorEmail" runat="server" Visible="false" Text='<%# Eval("CLIENT_EMAIL") %>' />
                                <asp:Label ID="lblVendorContact" runat="server" Visible="false" Text='<%# Eval("CLIENT_CONTACT") %>' />
                                ...
                                <asp:Label ID="lblQtyDCont20" runat="server" Visible="false" Text='<%# Eval("QTY_OF_D_CONT_20") %>' />
                                <asp:Label ID="lblQtyDCont40" runat="server" Visible="false" Text='<%# Eval("QTY_OF_D_CONT_40") %>' />
                                <%--<asp:Label ID="lblQtyODC" runat="server" Visible="false" Text='<%# Eval("QTY_OF_ODC") %>' />--%>
                                <asp:Label ID="lblQtyODCTruck" runat="server" Visible="false" Text='<%# Eval("TRUCK_QTY_OF_ODC") %>' />
                                <asp:Label ID="lblQtyODCContainer" runat="server" Visible="false" Text='<%# Eval("CONTAINER_QTY_OF_ODC") %>' />
                        ...
                        <asp:BoundField DataField="OUTWARD_STATUS_NAME" HeaderText="OUTWARD_STATUS_NAME" />
                        <asp:BoundField DataField="OUTWARD_TYPE" HeaderText="OUTWARD_TYPE" />
                        <asp:BoundField DataField="JOB_NO" HeaderText="JOB_NO" />
                        <asp:BoundField DataField="CLIENT_NAME" HeaderText="VENDOR_NAME" />
                        <asp:BoundField DataField="CLIENT_LOCATION" HeaderText="VENDOR_LOCATION" />
                        <asp:BoundField DataField="CLIENT_EMAIL" HeaderText="VENDOR_EMAIL" />
                        <asp:BoundField DataField="CLIENT_CONTACT" HeaderText="VENDOR_CONTACT" />
        ...
        <fieldset style="width: 95%; margin-left: 22px; margin-top: 10px;">
            ...
            <div style='overflow: auto; width: 99%; height: 500px; border: 1px solid lightgray; margin-left: 5px;'>
                <table style="width: 95%; height: 100%; margin-left: 20px;">
                    ...
                    <tr>
                        <td>Material Pick Up location:
                        </td>
                        <td>
                            <%--<asp:TextBox ID="txtCustVendName" runat="server" Width="100%" Enabled="true" onblur="return ValidateCustVendName();" />--%>
                            <asp:DropDownList ID="ddlVenLoc" runat="server" Width="100%" Height="25px" onblur="return ValidateEmployee();">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;
                        </td>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownList12" runat="server" Width="100%" Height="25px" Enabled ="false" onblur="return ValidateEmployee();">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:Panel ID="Panel4" runat="server" Width="300px" Height="50px">
                                <table border="1" cellpadding="5">
                                    ...
                                    <asp:Repeater ID="rptTruck2" runat="server" OnItemDataBound="rptTrucks_ItemDataBound" EnableViewState="true">
                    ...
                    <tr  id="canceldomesticid3" runat="server">
                     ...
                     <tr id="canceldomesticid12" runat="server">
                        <td>&nbsp;
                        </td>
                    </tr>
                     <tr  id="canceldomesticid13" runat="server">
                        <td>&nbsp;
                        </td>
                    </tr>
                ...
                <div id="submitbtncanceleditdom" runat="server" style="margin-top: 10px; text-align: center;">
                    <asp:Button
                        ID="btnSubmit"
                        runat="server"
                        Text="Update Outward Information"
...
<%--
            ...
            <div style='overflow: auto; width: 99%; height: 500px; border: 1px solid lightgray; margin-left: 5px;'>
                <table style="width: 95%; height: 100%; margin-left: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlModeOfTransportIntEdit" runat="server" Width="70%" Height="25px" AutoPostBack="false"  onblur="return ValidateEmployee();">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;
                        </td>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlIsStuffingEditInt" runat="server" Width="100%" Height="25px" onblur="return ValidateEmployee();"
                           >
                        </asp:DropDownList>
                    </td>
                    </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:CalendarExtender ID="CalendarExtender6" PopupButtonID="ImageButton9"
                                        runat="server" TargetControlID="TextBox15" Format="dd-MMM-yyyy" OnClientDateSelectionChanged="clientChangedUpdations2" >
                                    </asp:CalendarExtender>
                                </td>
                                <td>
            ...
            <div style='overflow: auto; width: 99%; height: 500px; border: 1px solid lightgray; margin-left: 5px;'>
                <table style="width: 95%; height: 100%; margin-left: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtOutwardNo" runat="server" Width="100%" Enabled="false" />
                        </td>
                        <td>&nbsp;
                        </td>
                        <td>Job Number:
    ...
    <asp:Panel ID="pnlapproveconfirm" runat="server" BackColor="White" Height="650px" Width="950px" Style="display: block; overflow: auto;">
        ...
        <table style="width: 90%; margin: 15px auto; padding: 2px 2px; border: 1px solid #ddd;">
            ...
            <tr>
                <td> Client Contact Details for unloading (If available):</td>
                <td>
                    <asp:TextBox ID="txtVenContactIO" runat="server" Style="width: 100%;" Enabled="false" />
                </td>
                <td>&nbsp;
                </td>
                <td>Material Pickup Location:</td>
                <td>
            ...
            <tr>
                ...
                <td>Delivery Term:</td>
                <td>
                   <%--   <asp:DropDownList ID="ddlDeliveryTermIO" runat="server" Width="100%" Height="25px" onblur="return ValidateEmployee();"
                           >
                        </asp:DropDownList>--%>
            ...
            <tr>
                ...
                <td>
                   ...
                   <%-- <asp:CalendarExtender ID=CalendarExtender6rm PopupButtonID="imgBtnDate"
                                        runat="server" TargetControlID="txtStartDate" Format="dd-MMM-yyyy" OnClientDateSelectionChanged="cclientChanged>
                            </asp:CalendarExtender--%>
                            
                </td>
                <td>
                    <asp:ImageButton ID="imgBtnDate" runat="server" ImageUrl="~/Images/Calendar2.png"
                        ToolTip="Date of Pickup" />
                </td>
            ...
            <tr>
                ...
                <td>Type Of Outward:</td>
                <td>
                    <asp:TextBox ID="txtTypeOutward" runat="server" Style="width: 100%;" Enabled="false" />
                </td>
            ...
            <tr runat="server" id="row1domesticC">
                ...
                <td>
                    ...
                    <asp:CalendarExtender ID="CalendarExtender7" PopupButtonID="imgLRDate"
                                        runat="server" TargetControlID="txtLRDateC" Format="dd-MMM-yyyy">
                                    </asp:CalendarExtender>
            ...
            <tr runat="server" id="row3domesticC">

                <td>Invoice No.:
                </td>
                <td>
                    <asp:TextBox ID="txtInvoiceNo2C" runat="server" Style="width: 100%;" Enabled="true" />
                </td>
                <td>&nbsp;
                </td>
                <td>Invoice Date.:
                ...
                <td>
                    <asp:TextBox ID="txtInvoiceDate2C" runat="server" Width="100%" Enabled="false" AutoPostBack="false"></asp:TextBox>
                    <asp:HiddenField ID="hftxtInvoiceDate2C" runat="server" />
                    <asp:CalendarExtender ID="CalendarExtender10" PopupButtonID="imgInvoiceDate2C"
                                        runat="server" TargetControlID="txtInvoiceDate2C" Format="dd-MMM-yyyy">
                                    </asp:CalendarExtender>

                </td>
                <td>
                    <asp:ImageButton ID="imgInvoiceDate2C" runat="server" ImageUrl="~/Images/Calendar2.png"
                        ToolTip="LR Date" />
                </td>
            ...
            <tr id="row1InternationalC" runat="server">
                ...
                <td>
                    <asp:TextBox ID="txtFCRBLDateC" runat="server" Width="100%" Enabled="true" AutoPostBack="false" ></asp:TextBox>
                    <asp:HiddenField ID="hdFCRBLC" runat="server" />
                    <asp:CalendarExtender ID="CalendarExtender8" PopupButtonID="imgFCRBLDateC"
                                        runat="server" TargetControlID="txtFCRBLDateC" Format="dd-MMM-yyyy">
                                    </asp:CalendarExtender>
            ...
            <tr id="row3InternationalC" runat="server">

                <td>Invoice No.:
                </td>
                <td>
                    <asp:TextBox ID="txtInvoiceNoC" runat="server" Style="width: 100%;" Enabled="true" />
                </td>
                <td>&nbsp;
                </td>
                <td>Invoice Date.:
                ...
                <td>
                    <asp:TextBox ID="txtInvoiceDateC" runat="server" Width="100%" Enabled="true" AutoPostBack="false" ></asp:TextBox>
                    <asp:HiddenField ID="hfInvoiceDateC" runat="server" />
                    <asp:CalendarExtender ID="CalendarExtender9" PopupButtonID="imgInvoiceDateC"
                                        runat="server" TargetControlID="txtInvoiceDateC" Format="dd-MMM-yyyy">
                                    </asp:CalendarExtender>

                </td>
                <td>
                    <asp:ImageButton ID="imgInvoiceDateC" runat="server" ImageUrl="~/Images/Calendar2.png"
                        ToolTip="FCR/BL Date" />
                </td>
            ...
            <div style="width: 100%; text-align: left;">
                <div style="display: inline-block; margin-left: 230px; margin-top: 20px;">
                    <asp:Button ID="btnSubmitCONFIRM" CssClass="button" runat="server" Text="Confirm"
                        Width="300px" Style="margin-right: 20px;" OnClientClick="return validateConsignmentFields()" OnClick="btnSubmitCONFIRM_Click" />
                    <%--  OnClientClick="return ValidateAll();"--%>
                    <br />
                    <br />
