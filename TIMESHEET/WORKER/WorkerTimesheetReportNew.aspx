<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="WorkerTimesheetReportNew.aspx.cs" Inherits="TIMESHEET_WORKER_WorkerTimesheetReportNew" %>
        ...
        <fieldset style="width: 90%">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnExport" CssClass="button" Width="100%" runat="server" Text="Export To Excel"
        ...
        <fieldset style="width: 95%;">
            ...
            <div style='overflow: auto; width: 100%; height: 100%; border: 1px solid lightgray;'>
                <asp:GridView ID="gvTimesheetList" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    PageSize="15" OnPageIndexChanging="gvTimesheetList_PageIndexChanging">
