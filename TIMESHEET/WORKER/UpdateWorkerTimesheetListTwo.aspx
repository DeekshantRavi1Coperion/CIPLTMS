<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateWorkerTimesheetListTwo.aspx.cs"
    Inherits="TIMESHEET_WORKER_UpdateWorkerTimesheetListTwo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hdRemovedRecordIDs" runat="server" />
        <div align="center" style="margin-top: 20px;">
            <fieldset style="width: 100%">
                ...
                <table width="95%">
                    ...
                    <tr>
                        <td align="right">Saved Timesheet Hours:</td>
                        <td>
                            <asp:TextBox ID="txtSavedTimesheetHours" runat="server" Width="100%" Enabled="false"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td align="right">Balance Timesheet Hours:</td>
                        <td>
                            <asp:TextBox ID="txtBalanceTimesheetHours" runat="server" Width="100%" Enabled="false"></asp:TextBox>
                        </td>
                        ...
                        <td colspan="2">
                            <table width="100%">
                                <tr>
                                    <td style="width: 45%;">
                                        <asp:Button ID="btnRefresh" CssClass="button" Width="100%" runat="server" Text="Refresh"
                                ...
                                <asp:GridView ID="gvWorkerTimesheetList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Sr No.">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtSRNo" Width="50px" runat="server" Enabled="false" CssClass="textboxcenter"
                                                    Text='<%# Eval("SERIAL_NO") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="JOB No">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblEmployeeName" runat="server" Text='<%# Eval("EMPLOYEE_NAME") %>' Visible="false" />
                                                ...
                                                <asp:Label ID="lblWorkingHours" runat="server" Text='<%# Eval("WORKING_HOURS") %>' Visible="false" />
                                                ...
                                                <asp:DropDownList ID="ddlJOBNo" Width="140px" runat="server" Height="26PX"
                                        ...
                                        <asp:TemplateField HeaderText="Item Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblLOTTFSubitem" runat="server" Visible="false" Text='<%# Eval("SUBITEM_DESC") %>' />
                                                <asp:DropDownList ID="ddlSubitems" Width="200px" Height="26px" runat="server">
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Activity Matrix" Visible="false">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtActivityMatrix" Width="250px" runat="server" TextMode="MultiLine" Rows="2"
                                                    Text='<%# Eval("ACTIVITY_MATRIX") %>' Columns="30" CssClass="textboxleft" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Adjustment Hours">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlHours" runat="server" Width="96%"
                                                    OnSelectedIndexChanged="ddlHours_SelectedIndexChanged" Height="26PX"
                                                    AutoPostBack="true">
                                        ...
                                        <asp:TemplateField HeaderText="Adjustment Minuts">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlMins" runat="server" Width="96%"
                                                    OnSelectedIndexChanged="ddlMins_SelectedIndexChanged" Height="26PX"
                                                    AutoPostBack="true">
                                                    <asp:ListItem Text="00" Value="0" />
                                                    <asp:ListItem Text="01" Value="1" />
                                                    <asp:ListItem Text="02" Value="2" />
                                        ...
                                        <asp:TemplateField HeaderText="Adjusted Hours">
                                            <ItemTemplate>
                                                <asp:Label ID="lblWorkingMinuts" runat="server" Text='<%# Eval("WORKING_MINUTS") %>' Visible="false" />
                                                <asp:Label ID="lblAdjustedWorkingHours" runat="server" Text='<%# Eval("ADJUSTED_WORKING_HOURS") %>' Visible="false" />
                                                <asp:TextBox ID="txtAdjustedWorkingHours" Width="100%" runat="server" Text='<%# Eval("ADJUSTED_WORKING_HOURS") %>' Enabled="false" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtRemarks" Width="250px" runat="server" TextMode="MultiLine" Rows="2"
                                                    Columns="50" CssClass="textboxleft" Text='<%# Eval("REMARKS") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgBtnDeleteRecord" ImageUrl="~/Images/Icons/REMOVE01.png" ToolTip="Delete Record Permanently"
                                                    runat="server" CommandArgument="DELETE" Visible="false" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
