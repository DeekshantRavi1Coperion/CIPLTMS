...
public partial class TIMESHEET_TimesheetMachineActivitiesList : System.Web.UI.Page
{
    ...
    private void GetActivityList()
    {
        try
        {
            ...
            dsMachineActivityList = objTimesheet.GetActivities(activityName);
    ...
    private void UpdateActivity()
    {
        try
        {
            ...
            int value = objTimesheet.AddUpdateActivity(recordID, activityName, Convert.ToInt32(Session["EMP_RECORD_ID"]));
            if (value > 0)
            {
