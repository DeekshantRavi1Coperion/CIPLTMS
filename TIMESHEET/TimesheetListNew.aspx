<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="TimesheetListNew.aspx.cs" Inherits="TIMESHEET_TimesheetListNew" %>
    ...
    <div class="page-layout">
            ...
            <fieldset class="filter-card">
                ...
                <div class="form-grid form-grid-3">
                 ...
                 <asp:Button ID="btnSearch"
                    ...
                    &nbsp;
                 &nbsp;
                 <asp:Button ID="btnAddNewTimeSheet"
                     OnClick="btnAddNewTimeSheet_Click"
                     runat="server"
                     Text="Add New"
                     CssClass="button" />
        ...
        <div class="employee-grid-container">
            ...
            <asp:GridView
                ...
                AllowPaging="True" OnPageIndexChanging="gvTimesheetList_PageIndexChanging" OnRowDataBound="gvTimesheetList_RowDataBound">
