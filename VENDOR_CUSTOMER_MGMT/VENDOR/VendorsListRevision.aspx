        ...
        function GetRevisionFor() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                ...
                if (checkboxes[i].checked) {
                    ...
                    <%--else if (i == 5) {
                        document.getElementById('<%= hdEditContactPerson.ClientID %>').value = i;
                        toggleContactPersonActions(true);
                    }--%>

                        <%--else if (i == 6) {
                        document.getElementById('<%= imgBtnShowPopupAddBankDetails.ClientID %>').disabled = false;
                        document.getElementById("divShowPopupAddBankDetails").classList.add('btn-add-show');
                    }--%>
