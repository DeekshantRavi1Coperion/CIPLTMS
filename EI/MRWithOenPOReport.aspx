<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="MRWithOenPOReport.aspx.cs" Inherits="EI_MRWithOenPOReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center" style="margin-top: 20px;">
        <fieldset style="width: 80%">
            <legend style="text-align: center;">MR With Open PO Report</legend>
            <table width="100%">
                <tr>
                    ...
                    <td align="right">MR No:
                    </td>
                    <td>
                        <asp:TextBox ID="txtMRNo" runat="server" Width="100%" />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
    ...
    <div align="center">
        <fieldset style="width: 95%;">
            ...
            <div style='overflow: auto; width: 100%; height: 500px; border: 1px solid lightgray;'>
                <asp:GridView ID="gvMRDetailReport" runat="server" AutoGenerateColumns="true" CellPadding="4"
                    ForeColor="#333333" GridLines="Both" PageSize="20" Width="100%" HorizontalAlign="Center"
                    AllowPaging="false" OnRowDataBound="gvMRDetailReport_RowDataBound">
