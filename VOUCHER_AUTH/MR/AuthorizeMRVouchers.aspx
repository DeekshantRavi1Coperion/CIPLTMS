<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="AuthorizeMRVouchers.aspx.cs" Inherits="VOUCHER_AUTH_MR_AuthorizeMRVouchers" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No."
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblClassD" runat="server" Text='<%# Eval("DOC_CLASS") %>' Visible="false" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
