...
public partial class VOUCHER_AUTH_JV_JournalVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "JournalVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersDetails = objVouchersAuthorization.GetJournalVouchersReport
                (
                      StartDate
                    , EndDate
                    , UnitId
