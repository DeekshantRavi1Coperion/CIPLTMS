<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="AuthorizeJournalVouchers.aspx.cs" Inherits="VOUCHER_AUTH_JV_AuthorizeJournalVouchers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            document.getElementById("folderPicker").addEventListener("change", function (e) {
                ...
                if (files.length > 0) {
                    // This gives something like: 'MyFolder/file1.txt'
                    const relativePath = files[0].webkitRelativePath;
                    const folderName = relativePath.split('/')[0]; // or '\\' if on Windows

                    // Set in textbox (only folder name)
                    document.getElementById("<%= txtFolderPathSS.ClientID %>").value = folderName;
                }
            });
        });
    </script>
    ...
    <%--<script type="text/javascript">
        function openFolderPathDialog() {
            alert("Due to browser limitations, please manually paste the folder path.");
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Authorize Journal Vouchers:
                    ...
                    <asp:TemplateField HeaderText="Local Files" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            ...
                            <table width="10%" id="tblViewFolderDocuments" runat="server">
                                <tr>
                                    <td>
                                        <asp:ImageButton ID="btnViewFolderDocuments" Height="20px" Width="20px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No."
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblTypeCodeD" runat="server" Text='<%# Eval("TYPE_CODE") %>' Visible="false" />
                                            <asp:Label ID="lblTypeD" runat="server" Text='<%# Eval("TYPE") %>' Visible="false" />
                                            <asp:Label ID="lblParticularD" runat="server" Text='<%# Eval("PARTICULAR") %>' Visible="false" />
                                    ...
                                    <asp:BoundField DataField="GL_DESCRIPTION" HeaderText="GL Code Description" />
