<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApprovePurchaseOrderVouchers.aspx.cs" Inherits="VOUCHER_AUTH_POV_ApprovePurchaseOrderVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Purchase Order Vouchers:
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblParticular" runat="server" Text='<%# Eval("PARTICULAR") %>' Visible="false" />
                            ...
                            <asp:Label ID="lblINRAmount" runat="server" Text='<%# Eval("INR_AMOUNT") %>' Visible="false" />
                            <asp:Label ID="lblFCAmount" runat="server" Text='<%# Eval("FC_AMOUNT") %>' Visible="false" />
                    ...
                    <asp:BoundField DataField="INR_AMOUNT" HeaderText="INR Amount" />
                    <asp:BoundField DataField="FC_AMOUNT" HeaderText="FC Amount" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No."
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblINRAmountD" runat="server" Text='<%# Eval("INR_AMOUNT") %>' Visible="false" />
                                            <asp:Label ID="lblFCAmountD" runat="server" Text='<%# Eval("FC_AMOUNT") %>' Visible="false" />
