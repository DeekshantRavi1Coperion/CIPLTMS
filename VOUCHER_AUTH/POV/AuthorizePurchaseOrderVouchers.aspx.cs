...
public partial class VOUCHER_AUTH_POV_AuthorizePurchaseOrderVouchers : System.Web.UI.Page
{
    ...
    public decimal INRAmountToAS
    {
        get
        {
            if (ViewState["INRAmount"] != null)
                _INRAmountToAS = Convert.ToDecimal(ViewState["INRAmount"]);
            else _INRAmountToAS = 0;

            return _INRAmountToAS;
        }
    }

    public decimal FCAmountToAS
    {
        get
        {
            if (ViewState["FCAmount"] != null)
                _FCAmountToAS = Convert.ToDecimal(ViewState["FCAmount"]);
            else _FCAmountToAS = 0;

            return _FCAmountToAS;
        }
    }
    ...
    private decimal _INRAmountToAS;
    ...
    protected void gvVouchersList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                Label lblParticular = gvVouchersList.Rows[rowindex].FindControl("lblParticular") as Label;
                ...
                Label lblINRAmount = gvVouchersList.Rows[rowindex].FindControl("lblINRAmount") as Label;
                Label lblFCAmount = gvVouchersList.Rows[rowindex].FindControl("lblFCAmount") as Label;
                ...
                ViewState["Particular"] = lblParticular.Text;
                ViewState["Class"] = lblClass.Text;
                ViewState["INRAmount"] = lblINRAmount.Text;
                ViewState["FCAmount"] = lblFCAmount.Text;
                ...
                else if (Convert.ToString(e.CommandArgument) == "DOWNLOAD_ALL_DOCUMENTS")
                {
                    ...
                    ExportZip(Convert.ToInt32(lblPID.Text)
                            ...
                            , (int)VoucherStatusTypes.EnumVoucherTypes.POV
                            , "");
                }
    ...
    protected void gvAttachedFiles_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                {
                    ViewAttachedFiles(Convert.ToInt32(lblPID.Text), Convert.ToString(lblAttachedFileName.Text).Trim(), (int)VoucherStatusTypes.EnumVoucherTypes.POV);
                    mpeAuthorizeVoucher.Show();
                }
    ...
    protected void btnAuthorize_Click(object sender, EventArgs e)
    {
        ...
        {
            ReAuthorize(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.POV);
        }
    }
    ...
    private void GetFolderPath()
    {
        ...
        DataTable dt = CollectFiles.GetFilePath(Convert.ToInt32(Session["EMP_RECORD_ID"]), (int)VoucherStatusTypes.EnumVoucherTypes.POV);
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetPurchaseOrderVouchersListToAutorize
                (
                        DateSignS
                    , DateTypeS
                    , StartDateS
            ...
            if (dsVouchersList.Tables.Count > 0 && dsVouchersList.Tables[0].Rows.Count > 0)
            {
                if (chkLoadFolderDocuments.Checked)
                {
                    ...
                    List<DataTable> dtfilesList = CollectFiles.GetLocalFilesList(CreatedById, (int)VoucherStatusTypes.EnumVoucherTypes.POV
    ...
    private void BindAttachedDocs(int PId)
    {
        try
        {
            _dsAttachedDocs = objVouchersAuthorization.GetVoucherDOCS(PId, (int)VoucherStatusTypes.EnumVoucherTypes.POV, "");
    ...
    private void GetVouchersDetails(string voucherNo, int unitID)
    {
        try
        {
            dsVoucherDetails = objVouchersAuthorization.GetPurchaseOrderVoucherDetails(voucherNo, unitID);
    ...
    //        DataSet dsAttachedFiles = objVouchersAuthorization.GetVoucherDOCFiles(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.POV);
    ...
    public string GetPDFDetailAndReturnHTML(int PID, string voucherNo)
    {
        try
        {
            DataSet dsDetail = objVouchersAuthorization.GetPurchaseOrderVoucherDetailsForPDF(PID);

            string htmlText = string.Empty;
            if (dsDetail.Tables.Count > 0 && dsDetail.Tables[0].Rows.Count > 0)
            {
                PurchaseOrderVouchersHtmlForPDF objVouchersHtmlForPDF = new PurchaseOrderVouchersHtmlForPDF();
    ...
    private void Authorize()
    {
        ...
        dtVoucherDetails.Columns.Add("INR_AMOUNT", typeof(decimal));
        dtVoucherDetails.Columns.Add("FC_AMOUNT", typeof(decimal));
        ...
        if (gvVoucherDetails.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVoucherDetails.Rows)
            {
                ...
                Label lblINRAmountD = (Label)gr.FindControl("lblINRAmountD");
                Label lblFCAmountD = (Label)gr.FindControl("lblFCAmountD");
                ...
                dr["INR_AMOUNT"] = lblINRAmountD.Text;
                dr["FC_AMOUNT"] = lblFCAmountD.Text;
        ...
        int val = objVouchersAuthorization.AuthorizePurchaseOrderVoucher
            (
                    Pid
                , VoucherNoToAS
    ...
    private void BulkAuthorize()
    {
        ...
        dtVouchers.Columns.Add("PARTICULAR", typeof(string));
        ...
        dtVouchers.Columns.Add("INR_AMOUNT", typeof(decimal));
        dtVouchers.Columns.Add("FC_AMOUNT", typeof(decimal));
        ...
        if (gvVouchersList.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVouchersList.Rows)
            {
                ...
                if (chkSelectVoucher.Checked)
                {
                    ...
                    Label lblINRAmount = (Label)gr.FindControl("lblINRAmount");
                    Label lblFCAmount = (Label)gr.FindControl("lblFCAmount");
        ...
        {
            int val = objVouchersAuthorization.BulkAuthorizePurchaseOrderVoucher
            (
                 CreatedById
               , dtVouchers
               , dtVoucherFiles
