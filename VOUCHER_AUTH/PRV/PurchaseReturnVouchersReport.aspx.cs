...
public partial class VOUCHER_AUTH_PRV_PurchaseReturnVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "PurchaseReturnVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetPurchaseReturnVouchersReport
                (
                        DateSignS, 
                        DateTypeS, 
                        StartDateS, 
