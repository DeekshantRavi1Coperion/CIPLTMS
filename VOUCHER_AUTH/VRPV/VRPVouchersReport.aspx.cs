...
public partial class VOUCHER_AUTH_VRPV_VRPVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "VendorReceiptPaymentVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetVRPVouchersReport
                (
                      DateSignS
                    , DateTypeS
                    , StartDateS
