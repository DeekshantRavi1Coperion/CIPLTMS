...
public partial class VOUCHER_AUTH_IRV_IRVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "InventoryReturnVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetIRVouchersReport
                (
                      DateSignS
                    , DateTypeS
                    , StartDateS
