<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApproveIRVouchers.aspx.cs" Inherits="VOUCHER_AUTH_IRV_ApproveIRVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Inventory Return Vouchers:
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblReferenceVoucherNo" runat="server" Text='<%# Eval("REFERENCE_VOUCHER_NO") %>' Visible="false" />
                            <asp:Label ID="lblReferenceVoucherDate" runat="server" Text='<%# Eval("REFERENCE_VOUCHER_DATE") %>' Visible="false" />
                    ...
                    <asp:BoundField DataField="REFERENCE_VOUCHER_NO" HeaderText="Reference Voucher No." />
                    <asp:BoundField DataField="REFERENCE_VOUCHER_DATE" HeaderText="Reference Voucher Date" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No."
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblReturnedProductCodeD" runat="server" Text='<%# Eval("RETURNED_PRODUCT_CODE") %>' Visible="false" />
                                            <asp:Label ID="lblReturnedProductDescriptionD" runat="server" Text='<%# Eval("RETURNED_PRODUCT_DESCRIPTION") %>' Visible="false" />

                                            <asp:Label ID="lblCostCenterCodeD" runat="server" Text='<%# Eval("COST_CENTER_CODE") %>' Visible="false" />
                                            <asp:Label ID="lblCostCenterNameD" runat="server" Text='<%# Eval("COST_CENTER_NAME") %>' Visible="false" />
                                    ...
                                    <asp:BoundField DataField="RETURNED_PRODUCT_CODE" HeaderText="Returned Product Code" />
                                    <asp:BoundField DataField="RETURNED_PRODUCT_DESCRIPTION" HeaderText="Returned Product Description" />

                                    <asp:BoundField DataField="COST_CENTER_CODE" HeaderText="Cost Center Code" />
                                    <asp:BoundField DataField="COST_CENTER_NAME" HeaderText="Cost Center Name" />
