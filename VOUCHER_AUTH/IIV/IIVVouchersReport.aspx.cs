...
public partial class VOUCHER_AUTH_IIV_IIVVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "InventoryIssueVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetIIVouchersReport
                (
                      DateSignS
                    , DateTypeS
                    , StartDateS
