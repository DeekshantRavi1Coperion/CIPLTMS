<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApproveIIVouchers.aspx.cs" Inherits="VOUCHER_AUTH_IIV_ApproveIIVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Inventory Issue Vouchers:
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblFactor" runat="server" Text='<%# Eval("FACTOR") %>' Visible="false" />
