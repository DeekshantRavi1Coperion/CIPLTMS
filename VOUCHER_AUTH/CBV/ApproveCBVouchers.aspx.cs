...
public partial class VOUCHER_AUTH_CBV_ApproveCBVouchers : System.Web.UI.Page
{
    ...
    {
        //mpeAuthorizeVoucher.Show();
        ApproveVoucher((int)VoucherStatusTypes.EnumStatus.APPROVED, (int)VoucherStatusTypes.EnumVoucherTypes.CBV);
    }

    protected void btnSendToReauthorization_Click(object sender, EventArgs e)
    {
        ApproveVoucher((int)VoucherStatusTypes.EnumStatus.REAUTHORIZATION, (int)VoucherStatusTypes.EnumVoucherTypes.CBV);
    }
    ...
    private void GetVouchersCreatedByList()
    {
        try
        {
            _dsVoucherCreatedBy = objVouchersAuthorization.GetVouchersCreatedByList((int)VoucherStatusTypes.EnumVoucherTypes.CBV);
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetCBVouchersListToApprove
                (
                        DateSignS
                    , DateTypeS
                    , StartDateS
