<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApproveCBVouchers.aspx.cs" Inherits="VOUCHER_AUTH_CBV_ApproveCBVouchers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ClearAllFilters() {
            ...
            <%--document.getElementById('<%=ddlTypeToS.ClientID %>').selectedIndex = 0;--%>
            ...
            document.getElementById('<%=ddlAmountSearchByS.ClientID %>').selectedIndex = 0;
    ...
    <script type="text/javascript">
       ...
       <%-- function ValidateFileAttachment6() {
            var allowedFiles = [".dxf", ".dwg", ".DXF", ".DWG", ".jpg", ".jpeg", ".bmp", ".png", ".gif", ".pdf", ".JPG", ".JPEG", ".BMP", ".PNG", ".GIF", ".PDF"];
            var regex = new RegExp("([a-zA-Z0-9\s_\\.\-:])+(" + allowedFiles.join('|') + ")$");
            var FileAttachment1 = document.getElementById('<%=uploadFileAttachmentToAS6.ClientID %>').value;
             var divfileAttachmentToAS6 = document.getElementById("divfileAttachmentToAS6");
             var lblfileAttachmentToAS6 = document.getElementById('<%=lblfileAttachmentToAS6.ClientID %>');



             if (FileAttachment1 == '') {
                 document.getElementById('<%=uploadFileAttachmentToAS6.ClientID %>').style.borderColor = "";
                divfileAttachmentToAS6.style.display = "none";
                lblfileAttachmentToAS6.innerHTML = "";
                return false;
            }
            else {
                ...
                if (!regex.test(FileAttachment1.toLowerCase())) {
                    document.getElementById('<%=uploadFileAttachmentToAS6.ClientID %>').style.borderColor = "#F7627F";
                    divfileAttachmentToAS6.style.display = "block";
                    lblfileAttachmentToAS6.innerHTML = "Please enter only Pdf or Image file!";
                    return true;
                }
                else {
                     document.getElementById('<%=uploadFileAttachmentToAS6.ClientID %>').style.borderColor = "";
        ...
        function ValidateFileAttachment7() {
            var allowedFiles = [".dxf", ".dwg", ".DXF", ".DWG", ".jpg", ".jpeg", ".bmp", ".png", ".gif", ".pdf", ".JPG", ".JPEG", ".BMP", ".PNG", ".GIF", ".PDF"];
            var regex = new RegExp("([a-zA-Z0-9\s_\\.\-:])+(" + allowedFiles.join('|') + ")$");
            var FileAttachment1 = document.getElementById('<%=uploadFileAttachmentToAS7.ClientID %>').value;
             var divfileAttachmentToAS7 = document.getElementById("divfileAttachmentToAS7");
             var lblfileAttachmentToAS7 = document.getElementById('<%=lblfileAttachmentToAS7.ClientID %>');



             if (FileAttachment1 == '') {
                 document.getElementById('<%=uploadFileAttachmentToAS7.ClientID %>').style.borderColor = "";
                divfileAttachmentToAS7.style.display = "none";
                lblfileAttachmentToAS7.innerHTML = "";
                return false;
            }
            else {
                ...
                if (!regex.test(FileAttachment1.toLowerCase())) {
                    document.getElementById('<%=uploadFileAttachmentToAS7.ClientID %>').style.borderColor = "#F7627F";
                    divfileAttachmentToAS7.style.display = "block";
                    lblfileAttachmentToAS7.innerHTML = "Please enter only Pdf or Image file!";
                    return true;
                }
                else {
                     document.getElementById('<%=uploadFileAttachmentToAS7.ClientID %>').style.borderColor = "";
        ...
        function ValidateFileAttachment8() {
            var allowedFiles = [".dxf", ".dwg", ".DXF", ".DWG", ".jpg", ".jpeg", ".bmp", ".png", ".gif", ".pdf", ".JPG", ".JPEG", ".BMP", ".PNG", ".GIF", ".PDF"];
            var regex = new RegExp("([a-zA-Z0-9\s_\\.\-:])+(" + allowedFiles.join('|') + ")$");
            var FileAttachment1 = document.getElementById('<%=uploadFileAttachmentToAS8.ClientID %>').value;
             var divfileAttachmentToAS8 = document.getElementById("divfileAttachmentToAS8");
             var lblfileAttachmentToAS8 = document.getElementById('<%=lblfileAttachmentToAS8.ClientID %>');



             if (FileAttachment1 == '') {
                 document.getElementById('<%=uploadFileAttachmentToAS8.ClientID %>').style.borderColor = "";
                divfileAttachmentToAS8.style.display = "none";
                lblfileAttachmentToAS8.innerHTML = "";
                return false;
            }
            else {
                ...
                if (!regex.test(FileAttachment1.toLowerCase())) {
                    document.getElementById('<%=uploadFileAttachmentToAS8.ClientID %>').style.borderColor = "#F7627F";
                    divfileAttachmentToAS8.style.display = "block";
                    lblfileAttachmentToAS8.innerHTML = "Please enter only Pdf or Image file!";
                    return true;
                }
                else {
                     document.getElementById('<%=uploadFileAttachmentToAS8.ClientID %>').style.borderColor = "";
        ...
        function ValidateFileAttachment9() {
            var allowedFiles = [".dxf", ".dwg", ".DXF", ".DWG", ".jpg", ".jpeg", ".bmp", ".png", ".gif", ".pdf", ".JPG", ".JPEG", ".BMP", ".PNG", ".GIF", ".PDF"];
            var regex = new RegExp("([a-zA-Z0-9\s_\\.\-:])+(" + allowedFiles.join('|') + ")$");
            var FileAttachment1 = document.getElementById('<%=uploadFileAttachmentToAS9.ClientID %>').value;
             var divfileAttachmentToAS9 = document.getElementById("divfileAttachmentToAS9");
             var lblfileAttachmentToAS9 = document.getElementById('<%=lblfileAttachmentToAS9.ClientID %>');



             if (FileAttachment1 == '') {
                 document.getElementById('<%=uploadFileAttachmentToAS9.ClientID %>').style.borderColor = "";
                divfileAttachmentToAS9.style.display = "none";
                lblfileAttachmentToAS9.innerHTML = "";
                return false;
            }
            else {
                ...
                if (!regex.test(FileAttachment1.toLowerCase())) {
                    document.getElementById('<%=uploadFileAttachmentToAS9.ClientID %>').style.borderColor = "#F7627F";
                    divfileAttachmentToAS9.style.display = "block";
                    lblfileAttachmentToAS9.innerHTML = "Please enter only Pdf or Image file!";
                    return true;
                }
                else {
                     document.getElementById('<%=uploadFileAttachmentToAS9.ClientID %>').style.borderColor = "";
        ...
        function ValidateFileAttachment10() {
            var allowedFiles = [".dxf", ".dwg", ".DXF", ".DWG", ".jpg", ".jpeg", ".bmp", ".png", ".gif", ".pdf", ".JPG", ".JPEG", ".BMP", ".PNG", ".GIF", ".PDF"];
            var regex = new RegExp("([a-zA-Z0-9\s_\\.\-:])+(" + allowedFiles.join('|') + ")$");
            var FileAttachment1 = document.getElementById('<%=uploadFileAttachmentToAS10.ClientID %>').value;
             var divfileAttachmentToAS10 = document.getElementById("divfileAttachmentToAS10");
             var lblfileAttachmentToAS10 = document.getElementById('<%=lblfileAttachmentToAS10.ClientID %>');



             if (FileAttachment1 == '') {
                 document.getElementById('<%=uploadFileAttachmentToAS10.ClientID %>').style.borderColor = "";
                divfileAttachmentToAS10.style.display = "none";
                lblfileAttachmentToAS10.innerHTML = "";
                return false;
            }
            else {
                ...
                if (!regex.test(FileAttachment1.toLowerCase())) {
                    document.getElementById('<%=uploadFileAttachmentToAS10.ClientID %>').style.borderColor = "#F7627F";
                    divfileAttachmentToAS10.style.display = "block";
                    lblfileAttachmentToAS10.innerHTML = "Please enter only Pdf or Image file!";
                    return true;
                }
                else {
                     document.getElementById('<%=uploadFileAttachmentToAS10.ClientID %>').style.borderColor = "";
        ...
        function ValidateAllFiles() {
            ...
            //if (ValidateFileAttachment6()) {
            //    check = false;
            //}

            //if (ValidateFileAttachment7()) {
            //    check = false;
            //}

            //if (ValidateFileAttachment8()) {
            //    check = false;
            //}

            //if (ValidateFileAttachment9()) {
            //    check = false;
            //}

            //if (ValidateFileAttachment10()) {
            //    check = false;
            //}
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Cash Bank Vouchers:
                ...
                <div class="form-grid form-grid-3">
                    ...
                    <asp:DropDownList ID="ddlCreatedByToS" runat="server" Width="100%" Height="23px">
                    </asp:DropDownList>
                    ...
                    <label>Amount Search By:</label>
                    <asp:DropDownList ID="ddlAmountSearchByS" runat="server"
                        CssClass="form-control">
                        <asp:ListItem Text="Receipt Amount FC" Value="RECEIPT_AMOUNT_FC"></asp:ListItem>
                        <asp:ListItem Text="Payment Amount FC" Value="PAYMENT_AMOUNT_FC"></asp:ListItem>
                        <asp:ListItem Text="Receipt Amount INR" Value="RECEIPT_AMOUNT_INR"></asp:ListItem>
                        <asp:ListItem Text="Payment Amount INR" Value="PAYMENT_AMOUNT_INR"></asp:ListItem>
                    </asp:DropDownList>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <%--<asp:Label ID="lblType" runat="server" Text='<%# Eval("TYPE") %>' Visible="false" />--%>
                            ...
                            <asp:Label ID="lblReceiptAmountFC" runat="server" Text='<%# Eval("RECEIPT_AMOUNT_FC") %>' Visible="false" />
                            <asp:Label ID="lblPaymentAmountFC" runat="server" Text='<%# Eval("PAYMENT_AMOUNT_FC") %>' Visible="false" />

                            <asp:Label ID="lblReceiptAmountINR" runat="server" Text='<%# Eval("RECEIPT_AMOUNT_INR") %>' Visible="false" />
                            <asp:Label ID="lblPaymentAmountINR" runat="server" Text='<%# Eval("PAYMENT_AMOUNT_INR") %>' Visible="false" />

                            <%--<asp:Label ID="lblPaidToOrReceivedFrom" runat="server" Text='<%# Eval("PAID_TO_OR_RECEIVED_FROM") %>' Visible="false" />--%>
                    ...
                    <asp:BoundField DataField="RECEIPT_AMOUNT_FC" HeaderText="Receipt Amount FC" />
                    <asp:BoundField DataField="PAYMENT_AMOUNT_FC" HeaderText="Payment Amount FC" />
                    <asp:BoundField DataField="RECEIPT_AMOUNT_INR" HeaderText="Receipt Amount INR" />
                    <asp:BoundField DataField="PAYMENT_AMOUNT_INR" HeaderText="Payment Amount INR" />
                    <%--<asp:BoundField DataField="PAID_TO_OR_RECEIVED_FROM" HeaderText="Paied To / Received From" />--%>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No."
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblVoucherDateD" runat="server" Text='<%# Eval("VOUCHER_DATE") %>' Visible="false" />
                                            <asp:Label ID="lblTypeD" runat="server" Text='<%# Eval("TYPE") %>' Visible="false" />
                                            <asp:Label ID="lblDOCClassD" runat="server" Text='<%# Eval("DOC_CLASS") %>' Visible="false" />
                                            <asp:Label ID="lblGLCodeD" runat="server" Text='<%# Eval("GLCODE") %>' Visible="false" />
                                            <asp:Label ID="lblGLDescriptionD" runat="server" Text='<%# Eval("GL_DESCRIPTION") %>' Visible="false" />
                                            <asp:Label ID="lblCurrencyDescriptionD" runat="server" Text='<%# Eval("CURRENCY_DESC") %>' Visible="false" />
                                            <asp:Label ID="lblReceiptAmountFCD" runat="server" Text='<%# Eval("RECEIPT_AMOUNT_FC") %>' Visible="false" />
                                            <asp:Label ID="lblPaymentAmountFCD" runat="server" Text='<%# Eval("PAYMENT_AMOUNT_FC") %>' Visible="false" />
                                            <asp:Label ID="lblReceiptAmountINRD" runat="server" Text='<%# Eval("RECEIPT_AMOUNT_INR") %>' Visible="false" />
                                            <asp:Label ID="lblPaymentAmountINRD" runat="server" Text='<%# Eval("PAYMENT_AMOUNT_INR") %>' Visible="false" />
                                            <asp:Label ID="lblPaidToOrReceivedFromD" runat="server" Text='<%# Eval("PAID_TO_OR_RECEIVED_FROM") %>' Visible="false" />
                                            <asp:Label ID="lblChequeOrReferenceNoD" runat="server" Text='<%# Eval("CHEQUE_OR_REFERENCE_NO") %>' Visible="false" />
                                            <asp:Label ID="lblChequeDatedD" runat="server" Text='<%# Eval("CHEQUE_DATED") %>' Visible="false" />
                                            <asp:Label ID="lblBankTransactionRefNoOrUTRD" runat="server" Text='<%# Eval("BANK_TRANSACTION_REF_NO_OR_UTR") %>' Visible="false" />
                                            <asp:Label ID="lblReconcileDateD" runat="server" Text='<%# Eval("RECONCILED_DATE") %>' Visible="false" />
                                            <asp:Label ID="lblNarrationD" runat="server" Text='<%# Eval("NARRATION") %>' Visible="false" />
                                    ...
                                    <asp:BoundField DataField="PAYMENT_AMOUNT_FC" HeaderText="Payment Amount FC" />
                                    <asp:BoundField DataField="RECEIPT_AMOUNT_INR" HeaderText="Receipt Amount INR" />
                                    <asp:BoundField DataField="PAID_TO_OR_RECEIVED_FROM" HeaderText="Paid To Received From" />
                                    <asp:BoundField DataField="PAYMENT_AMOUNT_INR" HeaderText="Bank Transaction Ref. No / UTR" />
                                    <asp:BoundField DataField="CHEQUE_OR_REFERENCE_NO" HeaderText="Cheque" />
                                    <asp:BoundField DataField="CHEQUE_DATED" HeaderText="Cheque Dated" />
                                    <asp:BoundField DataField="BANK_TRANSACTION_REF_NO_OR_UTR" HeaderText="Cheque Dated" />
