...
public partial class VOUCHER_AUTH_CBV_AuthorizeCBVouchers : System.Web.UI.Page
{
            ...
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                else if (Convert.ToString(e.CommandArgument) == "DOWNLOAD_ALL_DOCUMENTS")
                {
                    ...
                    ExportZip(Convert.ToInt32(lblPID.Text)
                            ...
                            , (int)VoucherStatusTypes.EnumVoucherTypes.CBV
                            , "");
                }
    ...
    protected void gvAttachedFiles_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                {
                    ViewAttachedFiles(Convert.ToInt32(lblPID.Text), Convert.ToString(lblAttachedFileName.Text).Trim(), (int)VoucherStatusTypes.EnumVoucherTypes.CBV);
                    mpeAuthorizeVoucher.Show();
                }
    ...
    protected void btnAuthorize_Click(object sender, EventArgs e)
    {
        ...
        {
            ReAuthorize(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.CBV);
        }
    }
    ...
    private void GetFolderPath()
    {
        ...
        DataTable dt = CollectFiles.GetFilePath(Convert.ToInt32(Session["EMP_RECORD_ID"]), (int)VoucherStatusTypes.EnumVoucherTypes.CBV);
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetCBVouchersListToAutorize
                (
                      DateSignS
                    , DateTypeS
                    , StartDateS
    ...
    private void BindAttachedDocs(int PId)
    {
        try
        {
            _dsAttachedDocs = objVouchersAuthorization.GetVoucherDOCS(PId, (int)VoucherStatusTypes.EnumVoucherTypes.CBV, "");
    ...
    private void GetVouchersDetails(string voucherNo, int unitID)
    {
        try
        {
            dsVoucherDetails = objVouchersAuthorization.GetCBVoucherDetails(voucherNo, unitID);
    ...
    //        DataSet dsAttachedFiles = objVouchersAuthorization.GetVoucherDOCFiles(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.CBV);
    ...
    public string GetPDFDetailAndReturnHTML(int PID, string voucherNo)
    {
        try
        {
            DataSet dsDetail = objVouchersAuthorization.GetCBVoucherDetailsForPDF(PID);

            string htmlText = string.Empty;
            if (dsDetail.Tables.Count > 0 && dsDetail.Tables[0].Rows.Count > 0)
            {
                CBVouchersHtmlForPDF objVouchersHtmlForPDF = new CBVouchersHtmlForPDF();
    ...
    private void Authorize()
    {
        ...
        dtVoucherDetails.Columns.Add("RECEIPT_AMOUNT_FC", typeof(decimal));
        dtVoucherDetails.Columns.Add("PAYMENT_AMOUNT_FC", typeof(decimal));
        dtVoucherDetails.Columns.Add("RECEIPT_AMOUNT_INR", typeof(decimal));
        dtVoucherDetails.Columns.Add("PAYMENT_AMOUNT_INR", typeof(decimal));
        dtVoucherDetails.Columns.Add("PAID_TO_OR_RECEIVED_FROM", typeof(string));
        dtVoucherDetails.Columns.Add("CHEQUE_OR_REFERENCE_NO", typeof(string));
        dtVoucherDetails.Columns.Add("CHEQUE_DATED", typeof(string));
        dtVoucherDetails.Columns.Add("BANK_TRANSACTION_REF_NO_OR_UTR", typeof(string));
        dtVoucherDetails.Columns.Add("RECONCILED_DATE", typeof(string));
        dtVoucherDetails.Columns.Add("NARRATION", typeof(string));
        ...
        if (gvVoucherDetails.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVoucherDetails.Rows)
            {
                ...
                Label lblCurrencyDescriptionD = (Label)gr.FindControl("lblCurrencyDescriptionD");
                Label lblReceiptAmountFCD = (Label)gr.FindControl("lblReceiptAmountFCD");
                Label lblPaymentAmountFCD = (Label)gr.FindControl("lblPaymentAmountFCD");
                Label lblReceiptAmountINRD = (Label)gr.FindControl("lblReceiptAmountINRD");
                Label lblPaymentAmountINRD = (Label)gr.FindControl("lblPaymentAmountINRD");

                Label lblPaidToOrReceivedFromD = (Label)gr.FindControl("lblPaidToOrReceivedFromD");
                Label lblChequeOrReferenceNoD = (Label)gr.FindControl("lblChequeOrReferenceNoD");
                Label lblChequeDatedD = (Label)gr.FindControl("lblChequeDatedD");
                Label lblBankTransactionRefNoOrUTRD = (Label)gr.FindControl("lblBankTransactionRefNoOrUTRD");
                Label lblReconcileDateD = (Label)gr.FindControl("lblReconcileDateD");
                Label lblNarrationD = (Label)gr.FindControl("lblNarrationD");
                ...
                dr["CURRENCY_DESC"] = lblCurrencyDescriptionD.Text;
                dr["RECEIPT_AMOUNT_FC"] = lblReceiptAmountFCD.Text;
                dr["PAYMENT_AMOUNT_FC"] = lblPaymentAmountFCD.Text;
                dr["RECEIPT_AMOUNT_INR"] = lblReceiptAmountINRD.Text;
                dr["PAYMENT_AMOUNT_INR"] = lblPaymentAmountINRD.Text;
                dr["PAID_TO_OR_RECEIVED_FROM"] = lblPaidToOrReceivedFromD.Text;
                dr["CHEQUE_OR_REFERENCE_NO"] = lblChequeOrReferenceNoD.Text;
                dr["CHEQUE_DATED"] = lblChequeDatedD.Text;
                dr["BANK_TRANSACTION_REF_NO_OR_UTR"] = lblBankTransactionRefNoOrUTRD.Text;
                dr["RECONCILED_DATE"] = lblReconcileDateD.Text;
                dr["NARRATION"] = lblNarrationD.Text;
        ...
        int val = objVouchersAuthorization.AuthorizeCBVoucher
            (
                 Pid
               , VoucherNoToAS
    ...
    private void BulkAuthorize()
    {
        ...
        {
            int val = objVouchersAuthorization.BulkAuthorizeCBVoucher
            (
                 CreatedById
               , dtVouchers
               , dtVoucherFiles
