<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="AuthorizeSTVouchers.aspx.cs" Inherits="VOUCHER_AUTH_STV_AuthorizeSTVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Authorize Stock Transfer Vouchers:
            ...
            <div class="full-width button-group">
                ...
                <asp:CheckBox ID="chkSelectDeselectVouchersWithoutDOCS" Text="Tag All Vouchers" runat="server"
                    OnCheckedChanged="chkSelectDeselectVouchersWithoutDOCS_CheckedChanged" />

                <asp:Button ID="btnBulkAuthorizeWithoutDOCS" CssClass="button" Width="100%" runat="server"
                    Text="Bulk Authorize Without DOCS"
                    OnClientClick="return ValidateAllPath();"
                    OnClick="btnBulkAuthorizeWithoutDOCS_Click" />
            ...
            <asp:GridView ID="gvVouchersList"
                ...
                <Columns>
                    ...
                    <asp:TemplateField
                        ...
                        ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:CheckBox runat="server" ID="chkSelectVoucherWithoutDOCS" />
                        </ItemTemplate>
                    </asp:TemplateField>
