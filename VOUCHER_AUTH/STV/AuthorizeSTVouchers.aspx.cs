...
public partial class VOUCHER_AUTH_STV_AuthorizeSTVouchers : System.Web.UI.Page
{
    ...
    public string StockTransferOrderNoToAS
    {
        get
        {
            if (ViewState["StockTransferOrderNo"] != null)
                _stockTransferOrderNoToAS = Convert.ToString(ViewState["StockTransferOrderNo"]);
            else _stockTransferOrderNoToAS = "";

            return _stockTransferOrderNoToAS;
        }
    }
    ...
    public string FromClassToAS
    {
        get
        {
            if (ViewState["FromClass"] != null)
                _fromClassToAS = Convert.ToString(ViewState["FromClass"]);
            else _fromClassToAS = "";

            return _fromClassToAS;
        }
    }

    public string ToClassToAS
    {
        get
        {
            if (ViewState["ToClass"] != null)
                _toClassToAS = Convert.ToString(ViewState["ToClass"]);
            else _toClassToAS = "";
    ...
    public string FromWarehouseCodeToAS
    {
        get
        {
            if (ViewState["FromWarehouseCode"] != null)
                _fromWarehouseCodeToAS = Convert.ToString(ViewState["FromWarehouseCode"]);
            else _fromWarehouseCodeToAS = "";

            return _fromWarehouseCodeToAS;
        }
    }

    public string ToWarehouseCodeToAS
    {
        get
        {
            if (ViewState["ToWarehouseCode"] != null)
                _toWarehouseCodeToAS = Convert.ToString(ViewState["ToWarehouseCode"]);
            else _toWarehouseCodeToAS = "";

            return _toWarehouseCodeToAS;
        }
    }

    public string RemarksParticularToAS
    {
        get
        {
            if (ViewState["Remarks"] != null)
                _remarksToAS = Convert.ToString(ViewState["Remarks"]);
            else _remarksToAS = "";
    ...
    private string _fromClassToAS;
    private string _toClassToAS;
    private string _fromWarehouseCodeToAS;
    private string _toWarehouseCodeToAS;
    private string _stockTransferOrderNoToAS;
    ...
    protected void gvVouchersList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                Label lblStockTransferOrderNo = gvVouchersList.Rows[rowindex].FindControl("lblStockTransferOrderNo") as Label;
                ...
                Label lblFromClass = gvVouchersList.Rows[rowindex].FindControl("lblFromClass") as Label;
                Label lblToClass = gvVouchersList.Rows[rowindex].FindControl("lblToClass") as Label;
                Label lblFromWarehouseCode = gvVouchersList.Rows[rowindex].FindControl("lblFromWarehouseCode") as Label;
                Label lblToWarehouseCode = gvVouchersList.Rows[rowindex].FindControl("lblToWarehouseCode") as Label;
                Label lblRemarks = gvVouchersList.Rows[rowindex].FindControl("lblRemarks") as Label;
                ...
                ViewState["StockTransferOrderNo"] = lblStockTransferOrderNo.Text;

                ViewState["CustomerCode"] = lblCustomerCode.Text;
                ViewState["CustomerName"] = lblCustomerName.Text;
                ViewState["FromClass"] = lblFromClass.Text;
                ViewState["ToClass"] = lblToClass.Text;
                ViewState["FromWarehouseCode"] = lblFromWarehouseCode.Text;
                ViewState["ToWarehouseCode"] = lblToWarehouseCode.Text;
                ViewState["Remarks"] = lblRemarks.Text;
                ...
                else if (Convert.ToString(e.CommandArgument) == "DOWNLOAD_ALL_DOCUMENTS")
                {
                    ...
                    ExportZip(Convert.ToInt32(lblPID.Text)
                            ...
                            , (int)VoucherStatusTypes.EnumVoucherTypes.STV
                            , "");
                }
    ...
    protected void gvAttachedFiles_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                {
                    ViewAttachedFiles(Convert.ToInt32(lblPID.Text), Convert.ToString(lblAttachedFileName.Text).Trim(), (int)VoucherStatusTypes.EnumVoucherTypes.STV);
                    mpeAuthorizeVoucher.Show();
                }
    ...
    protected void btnAuthorize_Click(object sender, EventArgs e)
    {
        ...
        {
            ReAuthorize(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.STV);
        }
    }
    ...
    private void GetFolderPath()
    {
        ...
        DataTable dt = CollectFiles.GetFilePath(Convert.ToInt32(Session["EMP_RECORD_ID"]), (int)VoucherStatusTypes.EnumVoucherTypes.STV);
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetSTVouchersListToAutorize
            (
                  DateSignS
                , DateTypeS
                , StartDateS
    ...
    private void BindAttachedDocs(int PId)
    {
        try
        {
            _dsAttachedDocs = objVouchersAuthorization.GetVoucherDOCS(PId, (int)VoucherStatusTypes.EnumVoucherTypes.STV, "");
    ...
    private void GetVouchersDetails(string voucherNo, int unitID)
    {
        try
        {
            dsVoucherDetails = objVouchersAuthorization.GetSTVoucherDetails(voucherNo, unitID);
    ...
    //        DataSet dsAttachedFiles = objVouchersAuthorization.GetVoucherDOCFiles(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.STV);
    ...
    public string GetPDFDetailAndReturnHTML(int PID, string voucherNo)
    {
        try
        {
            DataSet dsDetail = objVouchersAuthorization.GetSTVoucherDetailsForPDF(PID);

            string htmlText = string.Empty;
            if (dsDetail.Tables.Count > 0 && dsDetail.Tables[0].Rows.Count > 0)
            {
                STVouchersHtmlForPDF objVouchersHtmlForPDF = new STVouchersHtmlForPDF();
    ...
    private void Authorize()
    {
        ...
        dtVoucherDetails.Columns.Add("FROM_WAREHOUSE", typeof(string));
        dtVoucherDetails.Columns.Add("FROM_CLASS", typeof(string));
        dtVoucherDetails.Columns.Add("TO_WAREHOUSE", typeof(string));
        dtVoucherDetails.Columns.Add("TO_CLASS", typeof(string));
        ...
        if (gvVoucherDetails.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVoucherDetails.Rows)
            {
                ...
                Label lblFromWarehouseD = (Label)gr.FindControl("lblFromWarehouseD");
                Label lblFromClassD = (Label)gr.FindControl("lblFromClassD");
                Label lblToWarehouseD = (Label)gr.FindControl("lblToWarehouseD");
                Label lblToClassD = (Label)gr.FindControl("lblToClassD");
                ...
                dr["FROM_WAREHOUSE"] = lblFromWarehouseD.Text;
                dr["FROM_CLASS"] = lblFromClassD.Text;
                dr["TO_WAREHOUSE"] = lblToWarehouseD.Text;
                dr["TO_CLASS"] = lblToClassD.Text;
        ...
        int val = objVouchersAuthorization.AuthorizeSTVoucher
            (
                 Pid
               , VoucherNoToAS
               , Convert.ToDateTime(VoucherDateToAS).ToString("yyyy-MM-dd")
               , StockTransferOrderNoToAS
               , CustomerCodeToAS
               , CustomerNameToAS
               , FromClassToAS
               , ToClassToAS
               , FromWarehouseCodeToAS
               , ToWarehouseCodeToAS
               , RemarksParticularToAS
               , UnitIdToAS
    ...
    private void BulkAuthorize()
    {
        ...
        dtVouchers.Columns.Add("STOCK_TRASFER_ORDER_NO", typeof(string));
        dtVouchers.Columns.Add("CUSTOMER_CODE", typeof(string));
        dtVouchers.Columns.Add("CUSTOMER_NAME", typeof(string));
        dtVouchers.Columns.Add("FROM_DOC_CLASS", typeof(string));
        dtVouchers.Columns.Add("TO_DOC_CLASS", typeof(string));
        dtVouchers.Columns.Add("FROM_WAREHOUSE_CODE", typeof(string));
        dtVouchers.Columns.Add("TO_WAREHOUSE_CODE", typeof(string));
        dtVouchers.Columns.Add("REMARKS", typeof(string));
        ...
        if (gvVouchersList.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVouchersList.Rows)
            {
                ...
                if (chkSelectVoucher.Checked)
                {
                    ...
                    Label lblStockTransferOrderNo = (Label)gr.FindControl("lblStockTransferOrderNo");
                    Label lblCustomerCode = (Label)gr.FindControl("lblCustomerCode");
                    Label lblCustomerName = (Label)gr.FindControl("lblCustomerName");
                    Label lblFromClass = (Label)gr.FindControl("lblFromClass");
                    Label lblToClass = (Label)gr.FindControl("lblToClass");
                    Label lblFromWarehouseCode = (Label)gr.FindControl("lblFromWarehouseCode");
                    Label lblToWarehouseCode = (Label)gr.FindControl("lblToWarehouseCode");
                    ...
                    dr["STOCK_TRASFER_ORDER_NO"] = lblStockTransferOrderNo.Text;
                    dr["CUSTOMER_CODE"] = lblCustomerCode.Text;
                    dr["CUSTOMER_NAME"] = lblCustomerName.Text;
                    dr["FROM_DOC_CLASS"] = lblFromClass.Text;
                    dr["TO_DOC_CLASS"] = lblToClass.Text;
                    dr["FROM_WAREHOUSE_CODE"] = lblFromWarehouseCode.Text;
                    dr["TO_WAREHOUSE_CODE"] = lblToWarehouseCode.Text;
        ...
        {
            int val = objVouchersAuthorization.BulkAuthorizeSTVoucher
            (
                 CreatedById
               , dtVouchers
               , dtVoucherFiles
    ...
    private void BulkAuthorizeWithoutDOCS()
    {
        ...
        if (dtVouchers.Rows.Count > 0)
        {
            int val = objVouchersAuthorization.BulkAuthorizeSTVoucherWithoutDOCS(CreatedById, dtVouchers);
