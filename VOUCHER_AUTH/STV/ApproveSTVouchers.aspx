<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApproveSTVouchers.aspx.cs" Inherits="VOUCHER_AUTH_STV_ApproveSTVouchers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ClearAllFilters() {
            ...
            document.getElementById('<%=ddlFromWarehouseToS.ClientID %>').selectedIndex = 0;
            document.getElementById('<%=ddlToWarehouseToS.ClientID %>').selectedIndex = 0;
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Stock Transfer Vouchers:
                ...
                <div class="form-grid form-grid-3">
                    ...
                    <asp:DropDownList ID="ddlFromWarehouseToS" runat="server"
                        CssClass="form-control">
                    ...
                    <asp:DropDownList ID="ddlToWarehouseToS" runat="server"
                        CssClass="form-control">
                        <asp:ListItem Text="All" Value="" />
                        <asp:ListItem Text="A35" Value="A" />
                        <asp:ListItem Text="GNU" Value="G" />
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblStockTransferOrderNo" runat="server" Text='<%# Eval("STOCK_TRASFER_ORDER_NO") %>' Visible="false" />
                            ...
                            <asp:Label ID="lblFromClass" runat="server" Text='<%# Eval("FROM_DOC_CLASS") %>' Visible="false" />
                            <asp:Label ID="lblToClass" runat="server" Text='<%# Eval("TO_DOC_CLASS") %>' Visible="false" />

                            <asp:Label ID="lblFromWarehouseCode" runat="server" Text='<%# Eval("FROM_WAREHOUSE_CODE") %>' Visible="false" />
                            <asp:Label ID="lblToWarehouseCode" runat="server" Text='<%# Eval("TO_WAREHOUSE_CODE") %>' Visible="false" />
                    ...
                    <asp:BoundField DataField="STOCK_TRASFER_ORDER_NO" HeaderText="Customer Code" />

                    <asp:BoundField DataField="CUSTOMER_CODE" HeaderText="Customer Code" />
                    <asp:BoundField DataField="CUSTOMER_NAME" HeaderText="Customer Name" />

                    <asp:BoundField DataField="FROM_DOC_CLASS" HeaderText="From DOC Class" />
                    <asp:BoundField DataField="TO_DOC_CLASS" HeaderText="To DOC Class" />

                    <asp:BoundField DataField="FROM_WAREHOUSE_CODE" HeaderText="From Warehouse Code" />
                    <asp:BoundField DataField="TO_WAREHOUSE_CODE" HeaderText="To Warehouse Code" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No."
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblFromWarehouseD" runat="server" Text='<%# Eval("FROM_WAREHOUSE") %>' Visible="false" />
                                            <asp:Label ID="lblFromClassD" runat="server" Text='<%# Eval("FROM_CLASS") %>' Visible="false" />
                                            <asp:Label ID="lblToWarehouseD" runat="server" Text='<%# Eval("TO_WAREHOUSE") %>' Visible="false" />
                                            <asp:Label ID="lblToClassD" runat="server" Text='<%# Eval("TO_CLASS") %>' Visible="false" />
                                    ...
                                    <asp:BoundField DataField="FROM_WAREHOUSE" HeaderText="From Warehouse" />
                                    <asp:BoundField DataField="FROM_CLASS" HeaderText="From Class" />
                                    <asp:BoundField DataField="TO_WAREHOUSE" HeaderText="To Warehouse" />
                                    <asp:BoundField DataField="TO_CLASS" HeaderText="To Class" />
