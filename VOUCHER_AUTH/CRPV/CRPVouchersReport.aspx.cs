...
public partial class VOUCHER_AUTH_CRPV_CRPVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "CustomerReceiptPaymentVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetCRPVouchersReport
                (
                      DateSignS
                    , DateTypeS
                    , StartDateS
