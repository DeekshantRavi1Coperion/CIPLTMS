...
public partial class VOUCHER_AUTH_CRPV_ApproveCRPVouchers : System.Web.UI.Page
{
    ...
    {
        //mpeAuthorizeVoucher.Show();
        ApproveVoucher((int)VoucherStatusTypes.EnumStatus.APPROVED, (int)VoucherStatusTypes.EnumVoucherTypes.CRPV);
    }

    protected void btnSendToReauthorization_Click(object sender, EventArgs e)
    {
        ApproveVoucher((int)VoucherStatusTypes.EnumStatus.REAUTHORIZATION, (int)VoucherStatusTypes.EnumVoucherTypes.CRPV);
    }
    ...
    private void GetVouchersCreatedByList()
    {
        try
        {
            _dsVoucherCreatedBy = objVouchersAuthorization.GetVouchersCreatedByList((int)VoucherStatusTypes.EnumVoucherTypes.CRPV);
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetCRPVouchersListToApprove
                (
                        DateSignS
                    ,   DateTypeS
                    ,   StartDateS
