<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="AuthorizeSaleInvoiceVouchers.aspx.cs" Inherits="VOUCHER_AUTH_SIV_AuthorizeSaleInvoiceVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Authorize Sale Invoice Vouchers:
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblVoucherCreatedBy" runat="server" Text='<%# Eval("CREATED_BY") %>' Visible="false" />
