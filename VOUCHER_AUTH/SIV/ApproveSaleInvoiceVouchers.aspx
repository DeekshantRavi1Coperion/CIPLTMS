<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApproveSaleInvoiceVouchers.aspx.cs" Inherits="VOUCHER_AUTH_SIV_ApproveSaleInvoiceVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Sale Invoice Vouchers:
                ...
                <div class="form-grid form-grid-3">
                            ...
                            <tr>
                                ...
                                <td style="width: 75%;">
                                    <asp:DropDownList ID="ddlDateTypeToS" runat="server"
                                        ...
                                        <asp:ListItem Text="OA Date" Value="OA_DATE"></asp:ListItem>
                                        <asp:ListItem Text="YO Date" Value="YO_DATE"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                    ...
                    <asp:DropDownList ID="ddlSearchByToS" runat="server"
                        ...
                        <asp:ListItem Text="OA No." Value="OA_NO"></asp:ListItem>
                        <asp:ListItem Text="Challan No." Value="CHALLAN_NO"></asp:ListItem>
                        <asp:ListItem Text="YO No." Value="YO_NO"></asp:ListItem>
                    </asp:DropDownList>
                    ...
                    <asp:TextBox ID="txtCustomerCodeToS" runat="server" Width="100%">
                    </asp:TextBox>

                    <label>Customer Name:</label>
                    <asp:TextBox ID="txtCustomerNameToS" runat="server" Width="100%">
                    </asp:TextBox>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblDueDate" runat="server" Text='<%# Eval("DUE_DATE") %>' Visible="false" />
                            ...
                            <asp:Label ID="lblOANo" runat="server" Text='<%# Eval("OA_NO") %>' Visible="false" />
                            <asp:Label ID="lblOADate" runat="server" Text='<%# Eval("OA_DATE") %>' Visible="false" />
                            <asp:Label ID="lblCNNo" runat="server" Text='<%# Eval("CN_NO") %>' Visible="false" />
                            <asp:Label ID="lblCNDate" runat="server" Text='<%# Eval("CN_DATE") %>' Visible="false" />
                            ...
                            <asp:Label ID="lblEGPNo" runat="server" Text='<%# Eval("EGP_NO") %>' Visible="false" />
                            <asp:Label ID="lblEGPDate" runat="server" Text='<%# Eval("EGP_DATE") %>' Visible="false" />
                            ...
                            <asp:Label ID="lblBasic" runat="server" Text='<%# Eval("BASIC") %>' Visible="false" />
                    ...
                    <asp:BoundField DataField="OA_NO" HeaderText="OA No" />
                    <asp:BoundField DataField="OA_DATE" HeaderText="OA Date" />

                    <asp:BoundField DataField="CN_NO" HeaderText="CN Date" />
                    <asp:BoundField DataField="CN_DATE" HeaderText="CN Date" />
                    ...
                    <asp:BoundField DataField="EGP_DATE" HeaderText="EGP Date" />
