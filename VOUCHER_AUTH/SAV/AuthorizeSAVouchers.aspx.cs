...
public partial class VOUCHER_AUTH_SAV_AuthorizeSAVouchers : System.Web.UI.Page
{
    ...
    protected void gvAttachedFiles_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                {
                    ViewAttachedFiles(Convert.ToInt32(lblPID.Text), Convert.ToString(lblAttachedFileName.Text).Trim(), (int)VoucherStatusTypes.EnumVoucherTypes.SAV);
                    mpeAuthorizeVoucher.Show();
                }
    ...
    protected void btnAuthorize_Click(object sender, EventArgs e)
    {
        ...
        {
            ReAuthorize(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.SAV);
        }
    }
    ...
    private void GetFolderPath()
    {
        ...
        DataTable dt = CollectFiles.GetFilePath(Convert.ToInt32(Session["EMP_RECORD_ID"]), (int)VoucherStatusTypes.EnumVoucherTypes.SAV);
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetSAVouchersListToAutorize
            (
                  DateSignS
                , DateTypeS
                , StartDateS
    ...
    private void Authorize()
    {
        ...
        dtVoucherDetails.Columns.Add("RATE", typeof(decimal));
        ...
        int val = objVouchersAuthorization.AuthorizeSAVoucher
            (
                 Pid
               , VoucherNoToAS
    ...
    private void BulkAuthorize()
    {
        ...
        {
            int val = objVouchersAuthorization.BulkAuthorizeSAVoucher
            (
                 CreatedById
               , dtVouchers
               , dtVoucherFiles
    ...
    private void BulkAuthorizeWithoutDOCS()
    {
        ...
        if (dtVouchers.Rows.Count > 0)
        {
            int val = objVouchersAuthorization.BulkAuthorizeSAVoucherWithoutDOCS(CreatedById, dtVouchers);
