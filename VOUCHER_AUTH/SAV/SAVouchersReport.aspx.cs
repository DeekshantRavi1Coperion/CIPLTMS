...
public partial class VOUCHER_AUTH_SAV_SAVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "StockAdjustmentVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetSAVouchersReport
                (
                  DateSignS
                , DateTypeS
                , StartDateS
