...
public partial class VOUCHER_AUTH_VDNV_VDNVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "VendorDebitNoteVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetVDNVouchersReport
                (
                  DateSignS
                , DateTypeS
                , StartDateS
