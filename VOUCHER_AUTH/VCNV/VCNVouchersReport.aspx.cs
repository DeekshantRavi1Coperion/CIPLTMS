...
public partial class VOUCHER_AUTH_VCNV_VCNVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "VendorCreditNoteVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetVCNVouchersReport
                (
                  DateSignS
                , DateTypeS
                , StartDateS
