...
public partial class VOUCHER_AUTH_CDNV_CDNVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "CustomerDebitNoteVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetCDNVouchersReport
                (
                  DateSignS
                , DateTypeS
                , StartDateS
