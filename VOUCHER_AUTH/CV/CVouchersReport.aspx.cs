...
public partial class VOUCHER_AUTH_CV_CVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "ContraVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetCVouchersReport
                (
                        DateSignS
                    ,   DateTypeS
                    ,   StartDateS
