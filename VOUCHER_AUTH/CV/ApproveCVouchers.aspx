<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApproveCVouchers.aspx.cs" Inherits="VOUCHER_AUTH_CV_ApproveCVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Contra Vouchers:
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblTypeFull" runat="server" Text='<%# Eval("FULL_TYPE") %>' Visible="false" />
                            <asp:Label ID="lblClass" runat="server" Text='<%# Eval("DOC_CLASS") %>' Visible="false" />

                            <asp:Label ID="lblGLCode" runat="server" Text='<%# Eval("GLCODE") %>' Visible="false" />
                            ...
                            <asp:Label ID="lblChequeOrReferenceNo" runat="server" Text='<%# Eval("CHEQUE_OR_REFERENCE_NO") %>' Visible="false" />
                            <asp:Label ID="lblChequeDated" runat="server" Text='<%# Eval("CHEQUE_DATED") %>' Visible="false" />
                            <asp:Label ID="lblBankTransactionRefNoOrUTR" runat="server" Text='<%# Eval("BANK_TRANSACTION_REF_NO_OR_UTR") %>' Visible="false" />
                            <asp:Label ID="lblReconcileDate" runat="server" Text='<%# Eval("RECONCILED_DATE") %>' Visible="false" />
                            <asp:Label ID="lblNarration" runat="server" Text='<%# Eval("NARRATION") %>' Visible="false" />
                    ...
                    <%--<asp:BoundField DataField="FULL_TYPE" HeaderText="Type" />--%>
                    ...
                    <asp:BoundField DataField="CHEQUE_OR_REFERENCE_NO" HeaderText="Cheque / Reference No" />
                    <asp:BoundField DataField="CHEQUE_DATED" HeaderText="Cheque Dated" />

                    <%--<asp:BoundField DataField="BANK_TRANSACTION_REF_NO_OR_UTR" HeaderText="Transaction Ref No / UTR" />
                                    <asp:BoundField DataField="RECONCILED_DATE" HeaderText="Reconcile Date" />--%>
        ...
        <div class="form-container">
            <fieldset class="form-card">
                ...
                <div class="form-grid form-grid-2">
                    ...
                    <asp:TextBox ID="txtVoucherNoToAS" runat="server"
                        CssClass="form-control"
                        Enabled="false" />
                    ...
                    <label>Amount:</label>
                    <asp:TextBox ID="txtAmountToAS" runat="server"
                        CssClass="form-control"
                        Enabled="false" />

                    <label>Currency Desc:</label>
                    <asp:TextBox ID="txtCurrencyDescToAS" runat="server"
                        CssClass="form-control"
                        Enabled="false" />

                    <label>Cheque / Reference No:</label>
                    <asp:TextBox ID="txtChequeOrReferenceNoToAS" runat="server"
                        CssClass="form-control"
                        Enabled="false" />

                    <label>Cheque Dated:</label>
                    <asp:TextBox ID="txtChequeDatedToAS" runat="server"
                        CssClass="form-control"
                        Enabled="false" />

                    <label>Narration:</label>
                    <asp:TextBox ID="txtNarrationToAS" runat="server"
                        CssClass="form-control"
                        Enabled="false" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No."
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblGLCodeD" runat="server" Text='<%# Eval("GL_CODE") %>' Visible="false" />
                                            ...
                                            <asp:Label ID="lblDebitAmountD" runat="server" Text='<%# Eval("DEBIT_AMOUNT") %>' Visible="false" />
                                            <asp:Label ID="lblCreditAmountD" runat="server" Text='<%# Eval("CREDIT_AMOUNT") %>' Visible="false" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="DEBIT_AMOUNT" HeaderText="Debit Amount" />
