...
public partial class VOUCHER_AUTH_CV_AuthorizeCVouchers : System.Web.UI.Page
{
    ...
    public string GLCodeToAS
    {
        get
        {
            if (ViewState["GLCode"] != null)
                _GLCodeToAS = Convert.ToString(ViewState["GLCode"]);
            else _GLCodeToAS = "";
    ...
    public string GLDescriptionToAS
    {
        get
        {
            if (ViewState["GLDescription"] != null)
                _GLDescriptionToAS = Convert.ToString(ViewState["GLDescription"]);
            else _GLDescriptionToAS = "";

            return _GLDescriptionToAS;
        }
    }
    ...
    public string ChequeOrReferenceNoToAS
    {
        get
        {
            if (ViewState["ChequeOrReferenceNo"] != null)
                _chequeOrReferenceNoToAS = Convert.ToString(ViewState["ChequeOrReferenceNo"]);
            else _chequeOrReferenceNoToAS = "";

            return _chequeOrReferenceNoToAS;
        }
    }

    public string ChequeDatedToAS
    {
        get
        {
            if (ViewState["ChequeDated"] != null)
                _chequeDatedToAS = Convert.ToString(ViewState["ChequeDated"]);
            else _chequeDatedToAS = "";

            return _chequeDatedToAS;
        }
    }

    public string BankTransactionRefNoOrUTRToAS
    {
        get
        {
            if (ViewState["BankTransactionRefNoOrUTR"] != null)
                _bankTransactionRefNoOrUTRToAS = Convert.ToString(ViewState["BankTransactionRefNoOrUTR"]);
            else _bankTransactionRefNoOrUTRToAS = "";

            return _bankTransactionRefNoOrUTRToAS;
        }
    }

    public string ReconcileDateToAS
    {
        get
        {
            if (ViewState["ReconcileDate"] != null)
                _reconcileDateToAS = Convert.ToString(ViewState["ReconcileDate"]);
            else _reconcileDateToAS = "";

            return _reconcileDateToAS;
        }
    }

    public string NarrationToAS
    {
        get
        {
            if (ViewState["Narration"] != null)
                _narrationToAS = Convert.ToString(ViewState["Narration"]);
            else _narrationToAS = "";

            return _narrationToAS;
        }
    }
    ...
    private string _GLCodeToAS;
    private string _GLDescriptionToAS;
    private string _chequeOrReferenceNoToAS;
    private string _chequeDatedToAS;
    private string _bankTransferRefNoOrUTRToAS;
    private string _bankTransactionRefNoOrUTRToAS;
    private string _reconcileDateToAS;
    private string _narrationToAS;
    ...
    protected void gvVouchersList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                ViewState["TypeId"] = lblType.Text;
                ViewState["Class"] = lblClass.Text;

                ViewState["GLCode"] = lblGLCode.Text;
                ViewState["GLDescription"] = lblGLDescription.Text;

                ViewState["Amount"] = lblAmount.Text;
                ViewState["ReceiptAmountFC"] = lblReceiptAmountFC.Text;
                ViewState["PaymentAmountFC"] = lblPaymentAmountFC.Text;
                ViewState["ReceiptAmountINR"] = lblReceiptAmountINR.Text;
                ViewState["PaymentAmountINR"] = lblPaymentAmountINR.Text;
                ViewState["PaiedToReceivedFrom"] = lblPaidToOrReceivedFrom.Text;

                ViewState["ChequeOrReferenceNo"] = lblChequeOrReferenceNo.Text;
                ViewState["ChequeDated"] = lblChequeDated.Text;
                ViewState["BankTransactionRefNoOrUTR"] = lblBankTransactionRefNoOrUTR.Text;
                ViewState["ReconcileDate"] = lblReconcileDate.Text;
                ViewState["Narration"] = lblNarration.Text;
    ...
    protected void gvAttachedFiles_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                {
                    ViewAttachedFiles(Convert.ToInt32(lblPID.Text), Convert.ToString(lblAttachedFileName.Text).Trim(), (int)VoucherStatusTypes.EnumVoucherTypes.CV);
                    mpeAuthorizeVoucher.Show();
                }
    ...
    private void GetFolderPath()
    {
        ...
        DataTable dt = CollectFiles.GetFilePath(Convert.ToInt32(Session["EMP_RECORD_ID"]), (int)VoucherStatusTypes.EnumVoucherTypes.CV);
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetCVouchersListToAutorize
                (
                      DateSignS
                    , DateTypeS
                    , StartDateS
    ...
    private void Authorize()
    {
        ...
        dtVoucherDetails.Columns.Add("DEBIT_AMOUNT", typeof(decimal));
        dtVoucherDetails.Columns.Add("CREDIT_AMOUNT", typeof(decimal));
        ...
        if (gvVoucherDetails.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVoucherDetails.Rows)
            {
                ...
                Label lblDebitAmountD = (Label)gr.FindControl("lblDebitAmountD");
                Label lblCreditAmountD = (Label)gr.FindControl("lblCreditAmountD");
                ...
                dr["DEBIT_AMOUNT"] = lblDebitAmountD.Text;
                dr["CREDIT_AMOUNT"] = lblCreditAmountD.Text;
        ...
        int val = objVouchersAuthorization.AuthorizeCVoucher
            (
                 Pid
               , VoucherNoToAS
               ...
               , ReceiptAmountFCToAS
               , PaymentAmountFCToAS
               , ReceiptAmountINRToAS
               , PaymentAmountINRToAS
               , PaiedToReceivedFromToAS
               , ChequeOrReferenceNoToAS
               , ChequeDatedToAS
               , BankTransactionRefNoOrUTRToAS
               , ReconcileDateToAS
               , NarrationToAS
               , UnitIdToAS
    ...
    private void BulkAuthorize()
    {
        ...
        dtVouchers.Columns.Add("TYPE", typeof(string));
        dtVouchers.Columns.Add("DOC_CLASS", typeof(string));
        dtVouchers.Columns.Add("GLCODE", typeof(string));
        dtVouchers.Columns.Add("GL_DESCRIPTION", typeof(string));
        dtVouchers.Columns.Add("CURRENCY_DESC", typeof(string));
        dtVouchers.Columns.Add("AMOUNT", typeof(decimal));
        dtVouchers.Columns.Add("RECEIPT_AMOUNT_FC", typeof(decimal));
        dtVouchers.Columns.Add("PAYMENT_AMOUNT_FC", typeof(decimal));
        dtVouchers.Columns.Add("RECEIPT_AMOUNT_INR", typeof(decimal));
        dtVouchers.Columns.Add("PAYMENT_AMOUNT_INR", typeof(decimal));
        dtVouchers.Columns.Add("PAID_TO_OR_RECEIVED_FROM", typeof(string));
        dtVouchers.Columns.Add("CHEQUE_OR_REFERENCE_NO", typeof(string));
        dtVouchers.Columns.Add("CHEQUE_DATED", typeof(string));
        dtVouchers.Columns.Add("BANK_TRANSACTION_REF_NO_OR_UTR", typeof(string));
        dtVouchers.Columns.Add("RECONCILED_DATE", typeof(string));
        dtVouchers.Columns.Add("NARRATION", typeof(string));
        ...
        if (gvVouchersList.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVouchersList.Rows)
            {
                ...
                if (chkSelectVoucher.Checked)
                {
                    ...
                    Label lblGLDescription = (Label)gr.FindControl("lblGLDescription");
                    Label lblCurrencyDesc = (Label)gr.FindControl("lblCurrencyDesc");
                    Label lblAmount = (Label)gr.FindControl("lblAmount");
                    Label lblReceiptAmountFC = (Label)gr.FindControl("lblReceiptAmountFC");
                    Label lblPaymentAmountFC = (Label)gr.FindControl("lblPaymentAmountFC");
                    Label lblReceiptAmountINR = (Label)gr.FindControl("lblReceiptAmountINR");
                    Label lblPaymentAmountINR = (Label)gr.FindControl("lblPaymentAmountINR");
                    Label lblPaidToOrReceivedFrom = (Label)gr.FindControl("lblPaidToOrReceivedFrom");
                    Label lblChequeOrReferenceNo = (Label)gr.FindControl("lblChequeOrReferenceNo");
                    Label lblChequeDated = (Label)gr.FindControl("lblChequeDated");
                    Label lblBankTransactionRefNoOrUTR = (Label)gr.FindControl("lblBankTransactionRefNoOrUTR");
                    Label lblReconcileDate = (Label)gr.FindControl("lblReconcileDate");
                    Label lblNarration = (Label)gr.FindControl("lblNarration");
                    Label lblCreatedBy = (Label)gr.FindControl("lblCreatedBy");
                    Label lblUnitId = (Label)gr.FindControl("lblUnitId");
                    Label lblUnitName = (Label)gr.FindControl("lblUnitName");
                    ...
                    dr["GLCODE"] = lblGLCode.Text;
                    dr["GL_DESCRIPTION"] = lblGLDescription.Text;
                    dr["CURRENCY_DESC"] = lblCurrencyDesc.Text;
                    dr["AMOUNT"] = lblAmount.Text;
                    dr["RECEIPT_AMOUNT_FC"] = lblReceiptAmountFC.Text;
                    dr["PAYMENT_AMOUNT_FC"] = lblPaymentAmountFC.Text;
                    dr["RECEIPT_AMOUNT_INR"] = lblReceiptAmountINR.Text;
                    dr["PAYMENT_AMOUNT_INR"] = lblPaymentAmountINR.Text;
                    dr["PAID_TO_OR_RECEIVED_FROM"] = lblPaidToOrReceivedFrom.Text;
                    dr["CHEQUE_OR_REFERENCE_NO"] = lblChequeOrReferenceNo.Text;
                    dr["CHEQUE_DATED"] = lblChequeDated.Text;
                    dr["BANK_TRANSACTION_REF_NO_OR_UTR"] = lblBankTransactionRefNoOrUTR.Text;
                    dr["RECONCILED_DATE"] = lblReconcileDate.Text;
                    dr["NARRATION"] = lblNarration.Text;
        ...
        {
            int val = objVouchersAuthorization.BulkAuthorizeCVoucher
            (
                 CreatedById
               , dtVouchers
               , dtVoucherFiles
