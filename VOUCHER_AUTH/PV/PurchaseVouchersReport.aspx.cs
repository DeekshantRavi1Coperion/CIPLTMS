...
public partial class VOUCHER_AUTH_PV_PurchaseVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "PurchaseVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetPurchaseVouchersReport
                (
                      DateSignS, DateTypeS, StartDateS, EndDateS, UnitIdS, StatusIdS
                      , VoucherCreatedByS, SearchByS, SearchTextS, VendorCodeS, VendorNameS
