<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="AuthorizePurchaseVouchers.aspx.cs" Inherits="VOUCHER_AUTH_PV_AuthorizePurchaseVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Authorize Purchase Vouchers:
                    ...
                    <div class="full-width">
                        <div class="employee-grid-container">
                            ...
                            <asp:Panel ID="pnlAttachedMRNFilesAu" runat="server">
                                ...
                                <asp:GridView ID="gvAttachedMRNFilesAu"
                                    runat="server"
                                    AutoGenerateColumns="false"
                                    CellPadding="4"
                                    CssClass="myGrid"
                                    ...
                                    Width="100%"
                                    HorizontalAlign="Center"
                                    OnRowDataBound="gvAttachedMRNFilesAu_RowDataBound"
                                    OnRowCommand="gvAttachedMRNFilesAu_RowCommand">
                                    <RowStyle BackColor="#E3EAEB" HorizontalAlign="Left" />
