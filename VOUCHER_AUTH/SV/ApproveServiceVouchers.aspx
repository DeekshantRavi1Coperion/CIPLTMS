<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApproveServiceVouchers.aspx.cs" Inherits="VOUCHER_AUTH_SV_ApproveServiceVouchers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Service Vouchers:
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblMRNPidD" runat="server" Text='<%# Eval("MRN_PID") %>' Visible="false" />
    ...
    <asp:Panel ID="pnlViewAuthorizeVoucherPopup" runat="server" CssClass="popup-pdf">
                        ...
                        <div class="employee-grid-container">
                            ...
                            <asp:Panel ID="divAttachedMRNFiles" runat="server">
                                ...
                                <asp:GridView
                                    ...
                                    Width="100%"
                                    HorizontalAlign="Center"
                                    OnRowDataBound="gvAttachedMRNFiles_RowDataBound"
                                    OnRowCommand="gvAttachedMRNFiles_RowCommand">
                                    <RowStyle BackColor="#E3EAEB" HorizontalAlign="Left" />
