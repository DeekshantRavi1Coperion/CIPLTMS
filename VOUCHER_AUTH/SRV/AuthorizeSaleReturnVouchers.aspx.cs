...
public partial class VOUCHER_AUTH_SRV_AuthorizeSaleReturnVouchers : System.Web.UI.Page
{
    ...
    public string AccountIDToAS
    {
        get
        {
            if (ViewState["AccountID"] != null)
                _accountIDToAS = Convert.ToString(ViewState["AccountID"]);
            else _accountIDToAS = "";

            return _accountIDToAS;
        }
    }
    ...
    protected void gvVouchersList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (Session["EMP_RECORD_ID"] != null)
            {
                ...
                Label lblAccountID = gvVouchersList.Rows[rowindex].FindControl("lblAccountID") as Label;
                ...
                else if (Convert.ToString(e.CommandArgument) == "DOWNLOAD_ALL_DOCUMENTS")
                {
                    ...
                    ExportZip(Convert.ToInt32(lblPID.Text)
                            ...
                            , (int)VoucherStatusTypes.EnumVoucherTypes.SRV
                            , "");
                }
    ...
    protected void btnAuthorize_Click(object sender, EventArgs e)
    {
        ...
        {
            ReAuthorize(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.SRV);
        }
    }
    ...
    private void GetFolderPath()
    {
        ...
        DataTable dt = CollectFiles.GetFilePath(Convert.ToInt32(Session["EMP_RECORD_ID"]), (int)VoucherStatusTypes.EnumVoucherTypes.SRV);
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetSaleReturnVouchersListToAutorize
                (
                        DateSignS
                    , DateTypeS
                    , StartDateS
    ...
    private void BindAttachedDocs(int PId, string challanNo)
    {
        try
        {
            _dsAttachedDocs = objVouchersAuthorization.GetVoucherDOCS(PId, (int)VoucherStatusTypes.EnumVoucherTypes.SRV, challanNo);
    ...
    private void GetVouchersDetails(string voucherNo, int unitID)
    {
        try
        {
            dsVoucherDetails = objVouchersAuthorization.GetSaleReturnVoucherDetails(voucherNo, unitID);
    ...
    //        DataSet dsAttachedFiles = objVouchersAuthorization.GetVoucherDOCFiles(Pid, (int)VoucherStatusTypes.EnumVoucherTypes.SRV);
    ...
    public string GetPDFDetailAndReturnHTML(int PID, string voucherNo)
    {
        try
        {
            DataSet dsDetail = objVouchersAuthorization.GetSaleReturnVoucherDetailsForPDF(PID);

            string htmlText = string.Empty;
            if (dsDetail.Tables.Count > 0 && dsDetail.Tables[0].Rows.Count > 0)
            {
                SaleReturnVouchersHtmlForPDF objVouchersHtmlForPDF = new SaleReturnVouchersHtmlForPDF();
                      ...
                      )
    {
        ...
        dtVoucherDetails.Columns.Add("PRODUCT_CODE_RETURNED", typeof(string));
        dtVoucherDetails.Columns.Add("PRODUCT_DESCRIPTION_RETURNED", typeof(string));
        ...
        if (gvVoucherDetails.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVoucherDetails.Rows)
            {
                ...
                Label lblProductCodeReturnedD = (Label)gr.FindControl("lblProductCodeReturnedD");
                Label lblProductDescriptionReturnedD = (Label)gr.FindControl("lblProductDescriptionReturnedD");
                ...
                dr["PRODUCT_CODE_RETURNED"] = lblProductCodeReturnedD.Text;
                dr["PRODUCT_DESCRIPTION_RETURNED"] = lblProductDescriptionReturnedD.Text;
        ...
        int val = objVouchersAuthorization.AuthorizeSaleReturnVoucher
            (
                 Pid
               , VoucherNo
    ...
    private void BulkAuthorize()
    {
        ...
        dtVouchers.Columns.Add("ACCOUNT_ID", typeof(string));
        ...
        if (gvVouchersList.Rows.Count > 0)
        {
            foreach (GridViewRow gr in gvVouchersList.Rows)
            {
                ...
                if (chkSelectVoucher.Checked)
                {
                    ...
                    Label lblAccountID = (Label)gr.FindControl("lblAccountID");
                    ...
                    dr["ACCOUNT_ID"] = lblAccountID.Text;
        ...
        {
            int val = objVouchersAuthorization.BulkAuthorizeSaleReturnVoucher
            (
                 CreatedById
               , dtVouchers
               , dtVoucherFiles
