...
public partial class VOUCHER_AUTH_SRV_SaleReturnVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "SaleReturnVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetSaleReturnVouchersReport
                (
                        DateSignS, 
                        DateTypeS, 
                        StartDateS, 
