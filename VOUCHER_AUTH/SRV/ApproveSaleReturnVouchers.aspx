<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ApproveSaleReturnVouchers.aspx.cs" Inherits="VOUCHER_AUTH_SRV_ApproveSaleReturnVouchers" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Approve Sale Return Vouchers:
                ...
                <div class="form-grid form-grid-3">
                            ...
                            <tr>
                                ...
                                <td style="width: 75%;">
                                    <asp:DropDownList ID="ddlDateTypeToS" runat="server"
                                        ...
                                        <asp:ListItem Text="Reference Invoice Date" Value="REFERENCE_INVOICE_DATE"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                    ...
                    <asp:DropDownList ID="ddlSearchByToS" runat="server"
                        ...
                        <asp:ListItem Text="Reference Invoice No." Value="REFERENCE_INVOICE_NO"></asp:ListItem>
                        <asp:ListItem Text="Account ID" Value="ACCOUNT_ID"></asp:ListItem>
                    </asp:DropDownList>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sl No."
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblReferenceInvoiceNo" runat="server" Text='<%# Eval("REFERENCE_INVOICE_NO") %>' Visible="false" />
                            <asp:Label ID="lblReferenceInvoiceDate" runat="server" Text='<%# Eval("REFERENCE_INVOICE_DATE") %>' Visible="false" />
                            ...
                            <asp:Label ID="lblAccountID" runat="server" Text='<%# Eval("ACCOUNT_ID") %>' Visible="false" />
                    ...
                    <asp:BoundField DataField="REFERENCE_INVOICE_NO" HeaderText="Reference Invoice No" />
                    <asp:BoundField DataField="REFERENCE_INVOICE_DATE" HeaderText="Reference Invoice Date" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No."
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblProductCodeReturnedD" runat="server" Text='<%# Eval("PRODUCT_CODE_RETURNED") %>' Visible="false" />
                                            <asp:Label ID="lblProductDescriptionReturnedD" runat="server" Text='<%# Eval("PRODUCT_DESCRIPTION_RETURNED") %>' Visible="false" />
                                            ...
                                            <asp:Label ID="lblTermAmountD" runat="server" Text='<%# Eval("TERM_AMOUNT") %>' Visible="false" />
                                    ...
                                    <asp:BoundField DataField="PRODUCT_CODE_RETURNED" HeaderText="Product Code Returned" />
                                    <asp:BoundField DataField="PRODUCT_DESCRIPTION_RETURNED" HeaderText="Product Description Returned" />
                                    <asp:BoundField DataField="QUANTITY" HeaderText="Quantity" />
                                    <asp:BoundField DataField="UOM" HeaderText="UOM" />
                                    <asp:BoundField DataField="RATE" HeaderText="Rate" />
                                    <asp:BoundField DataField="AMOUNT" HeaderText="Amount" />
                                    <asp:BoundField DataField="TERM_AMOUNT" HeaderText="Term Amount" />
                                </Columns>
