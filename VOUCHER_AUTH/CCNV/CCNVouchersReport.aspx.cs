...
public partial class VOUCHER_AUTH_CCNV_CCNVouchersReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvVouchersList.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "CustomerCreditNoteVoucherReport_");
        }
        else
        {
    ...
    private void GetVouchersList()
    {
        try
        {
            dsVouchersList = objVouchersAuthorization.GetCCNVouchersReport
                (
                  DateSignS
                , DateTypeS
                , StartDateS
