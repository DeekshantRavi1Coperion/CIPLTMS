...
public partial class REPORTS_PURCHASE_BALANCE_PurchaseBalanceReportByBooksB2B : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvReport.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "GSTReconciliationReportByBooksB2B_");
    ...
    private void GetReport()
    {
        try
        {
            dsVouchersList = objPurchaseBalanceReports.GetReportByBooksB2B
                (
                      DateSignS
                    , DateTypeS
                    , StartDateS
            ...
            if (dsVouchersList.Tables.Count > 0 && dsVouchersList.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    txtImportedCounts.Text = dsVouchersList.Tables[1].Rows[0]["ImportedCount"].ToString();
                    txtProcessedCounts.Text = dsVouchersList.Tables[1].Rows[0]["ProcessedCount"].ToString();
                    txtM1MatchedCounts.Text = dsVouchersList.Tables[1].Rows[0]["M1MatchedCount"].ToString();
                    txtM1UnmatchedCounts.Text = dsVouchersList.Tables[1].Rows[0]["M1UnmatchedCount"].ToString();
                    txtM2MatchedCounts.Text = dsVouchersList.Tables[1].Rows[0]["M2MatchedCount"].ToString();
                    txtM2UnmatchedCounts.Text = dsVouchersList.Tables[1].Rows[0]["M2UnmatchedCount"].ToString();
                    txtFullyUnmatchedCounts.Text = dsVouchersList.Tables[1].Rows[0]["FullyUnmatchedCount"].ToString();
                    txtNotInGSTR2BCounts.Text = dsVouchersList.Tables[1].Rows[0]["NotInGSTR2BCount"].ToString();
                }
    ...
    {
        txtImportedCounts.Text = "0";
        txtProcessedCounts.Text = "0";
        txtM1MatchedCounts.Text = "0";
        txtM1UnmatchedCounts.Text = "0";
        txtM2MatchedCounts.Text = "0";
        txtM2UnmatchedCounts.Text = "0";
        txtFullyUnmatchedCounts.Text = "0";
        txtNotInGSTR2BCounts.Text = "0";
    }
