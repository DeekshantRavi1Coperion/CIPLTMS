...
public partial class REPORTS_PURCHASE_BALANCE_PurchaseBalanceReportByGSTR2B : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (gvReport.Rows.Count > 0)
        {
            ...
            ToCSVNew01(dt, "GSTReconciliationReportByGSTR2B_");
        }
        else
        {
    ...
    private void GetReport()
    {
        try
        {
            dsVouchersList = objPurchaseBalanceReports.GetReportByBooksGSTR2B
                (
                      DateSignS
                    , DateTypeS
                    , StartDateS
