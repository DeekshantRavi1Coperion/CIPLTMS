...
public partial class REPORTS_SALE_ORDER_SaleOrderBacklogPOCPostingTwo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            HidePanel();
            chkZeroPOCBilling.Checked = false;
            if (!IsPostBack)
            {
        ...
        {            
            ...
            if (gvSaleOrderPosting.Rows.Count > 0)
            {
                ...
                {                   
                    ...
                    if (pocBilling == 0)
                    {
                        if (chkZeroPOCBilling.Checked)
                        {
                            value = objReports.PostPOCBillingOne(jobNo, orderDate, customerCode, customerName,
