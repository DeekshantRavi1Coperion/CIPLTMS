<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="SaleOrderBacklogPOCPostingOne.aspx.cs" Inherits="REPORTS_SALE_ORDER_SaleOrderBacklogPOCPostingOne" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
        ...
        function checkDec1(el) {
            ...
            if (ex.test(el.value) == false) {
                ...
                if (el.value == '') {
                    ...
                    var txtTaxBilling = row.cells[8].getElementsByTagName("input")[0].value;
                    ...
                    if (txtTaxBilling != '' && parseFloat(txtTaxBilling) > '0') {
                        TaxBilling = parseFloat(txtTaxBilling);
                    }
                    else {
                        TaxBilling = 0;
                    }
                    ...
                    if (PreviousBilling > 0) {
                        if ((OrderAmount - PreviousBilling) < (POCBilling + TaxBilling)) {
                            row.cells[7].getElementsByTagName("input")[0].value = "0";
                            row.cells[8].getElementsByTagName("input")[0].value = "0";
                            row.cells[10].getElementsByTagName("input")[0].value = parseFloat(OrderAmount - PreviousBilling);
                        }
                        else {
                            row.cells[10].getElementsByTagName("input")[0].value = parseFloat(POCBilling + TaxBilling);
                        }
                    }
                    else {

                        if (OrderAmount < (POCBilling + TaxBilling)) {
                            row.cells[7].getElementsByTagName("input")[0].value = "0";
                            row.cells[8].getElementsByTagName("input")[0].value = "0";
                            row.cells[10].getElementsByTagName("input")[0].value = parseFloat(OrderAmount);
                        }
                        else {
                            row.cells[10].getElementsByTagName("input")[0].value = parseFloat(POCBilling + TaxBilling);
                        }
                    ...
                    //                        if (parseFloat(row.cells[7].getElementsByTagName("input")[0].value) + parseFloat(TaxBilling) <= PreviousBilling) {
                    //                            row.cells[10].getElementsByTagName("input")[0].value = parseFloat(row.cells[7].getElementsByTagName("input")[0].value) + parseFloat(TaxBilling);
                    //                        }
                    //                        else {
                    //                            row.cells[7].getElementsByTagName("input")[0].value = "0";
                    //                            row.cells[8].getElementsByTagName("input")[0].value = "0";
                    //                            row.cells[10].getElementsByTagName("input")[0].value = parseFloat(PreviousBilling);
                    //                        }
                    //                    }
                    //                    else {
                    ...
                    //                        if (parseFloat(row.cells[7].getElementsByTagName("input")[0].value) + parseFloat(TaxBilling) <= OrderAmount) {
                    //                            row.cells[10].getElementsByTagName("input")[0].value = parseFloat(row.cells[7].getElementsByTagName("input")[0].value) + parseFloat(TaxBilling);
                    //                        }
                    //                        else {
                    //                            row.cells[7].getElementsByTagName("input")[0].value = "0";
    ...
    <script type="text/javascript">
        var GridId = "<%=gvSaleOrderPosting.ClientID %>";
            ...
            <div align="center">
                <fieldset style="width: 90%;">
                    ...
                    <div id="gridContainer" style='overflow-y: scroll; overflow-y: hidden; width: 100%;
                        height: 100%; border: 1px solid lightgray;'>
