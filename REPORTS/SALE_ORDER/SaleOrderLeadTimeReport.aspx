<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="SaleOrderLeadTimeReport.aspx.cs" Inherits="REPORTS_SALE_ORDER_SaleOrderLeadTimeReport" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Sale Order Lead Time Report:
                ...
                <div class="form-grid form-grid-3">
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                <asp:TextBox ID="txtStartDateSearch" runat="server" ReadOnly="true" CssClass="form-control"  />
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                <asp:TextBox ID="txtEndDateSearch" runat="server" ReadOnly="true" CssClass="form-control" />
        ...
        <div class="employee-grid-container">
            ...
            <asp:GridView 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="LAST_BILLING_DATE" HeaderText="LAST_BILLING_DATE" />
                    ...
                    <asp:BoundField DataField="BUS_SEGMENT_DESC" HeaderText="BUS_SEGMENT_DESC" />
