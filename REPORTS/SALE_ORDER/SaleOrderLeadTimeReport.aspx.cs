...
public partial class REPORTS_SALE_ORDER_SaleOrderLeadTimeReport : System.Web.UI.Page
{
    ...
    private void GetSaleOrderLeadTimeReport()
    {
        try
        {
            ...
            if (ddlCompany.SelectedIndex > 0)
            {
                ...
                dsSaleBill = objReports.GetSaleOrderLeadTimeReport(unitId, unitName, fromDate, toDate);
            }
            else
            {
                ...
                dsSaleBill = objReports.GetSaleOrderLeadTimeReportAllUnits(fromDate, toDate, dbNameA35, unitNameA35, dbNameDLH, unitNameDLH, dbNameSEZ, unitNameSEZ, dbNameGNU, unitNameGNU);
            }
    ...
    private void ToCSVNew01(DataTable dt)
    {
        try
        {
            ...
            string fileName = "SaleBillReportWithDeliveryDate_" + DateTime.Now.ToString("dd_MMM_yyyy");
            Response.Clear();
