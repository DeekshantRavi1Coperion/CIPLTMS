<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="SaleOrderBacklogPOCPostingTwo.aspx.cs" Inherits="REPORTS_SALE_ORDER_SaleOrderBacklogPOCPostingTwo" %>
                ...
                <fieldset style="width: 80%">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right">
                                Allow With 0 POC Billing:
                            </td>
                            <td>
                                <asp:CheckBox ID="chkZeroPOCBilling" runat="server" />
                            </td>
                            <td>
                                &nbsp;
                            </td>
