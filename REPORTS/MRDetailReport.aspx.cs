...
public partial class REPORTS_MRDetailReport : System.Web.UI.Page
{
    ...
    private void GetMRDetailReport()
    {
        try
        {
            ...
            dsMRDetailReport = objReports.GetMRDetailReport(fromDate, toDate, dbNameA35, unitNameA35, dbNameDLH, unitNameDLH, dbNameSEZ,
                                                                        unitNameSEZ, dbNameGNU, unitNameGNU, MRNo, PONo, MRNNo, productCode, jobNo,
