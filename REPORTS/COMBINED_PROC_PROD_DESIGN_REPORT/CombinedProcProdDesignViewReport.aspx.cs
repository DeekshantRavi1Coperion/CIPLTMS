...
public partial class REPORTS_COMBINED_PROC_PROD_DESIGN_REPORT_CombinedProcProdDesignViewReport : System.Web.UI.Page
{
    ...
    public string GetPDFDetailAndReturnHTML(DataTable dtProc, DataTable dtProd, DataTable dtDesign, string JOBNo)
    {
        try
        {
            ...
            htmlText = objPDF.GetHtmlForPDF(dtProc, dtProd, dtDesign, JOBNo, totalPOValueINR, totalQuantity, totalSpentEnggHours, Convert.ToString(CombinedReportTypes.EnumType.Outstanding));
