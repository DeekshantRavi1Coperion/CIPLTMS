<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="POReport.aspx.cs"
    Inherits="REPORTS_POReport" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center" style="margin-top: 20px;">
        <fieldset style="width: 90%">
            <legend style="text-align: center;">Po Report</legend>
            <table width="90%">
                <tr>
                    <td>
                        Start Date:
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtVendorCode" runat="server" Width="100%"></asp:TextBox>
                    </td>
                    <td>
                        &nbsp;
                    </td>
    ...
    <div align="center">
        <fieldset style="width: 95%;">
            ...
            <div style='overflow: auto; width: 100%; height: 500px; border: 1px solid lightgray;'>
                <asp:GridView ID="gvPOReport" runat="server" CellPadding="4" ForeColor="#333333" PageSize="20"
                    Width="100%" HorizontalAlign="Center" OnRowDataBound="gvPOReport_RowDataBound">
