<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="ProductLogReport.aspx.cs" Inherits="REPORTS_ProductLogReport" %>
    ...
    <div class="page-layout">
        ...
        <div class="employee-grid-container">
            ...
            <asp:GridView
                ...
                ID="gvProductLogReport" runat="server" AutoGenerateColumns="true" CellPadding="4"
                ForeColor="#333333" GridLines="Vertical" PageSize="20" Width="100%" HorizontalAlign="Center"
                AllowPaging="false" OnRowDataBound="gvProductLogReport_RowDataBound">
