<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="UnpostedPOListThree.aspx.cs"
    Inherits="REPORTS_PURCHASE_ORDER_UnpostedPOListThree" Title="Untitled Page" %>
        ...
        function checkDec1(el) {
            ...
            if (ex.test(el.value) == false) {
                ...
                if (el.value == '') {
                    ...
                    var txtPendingAmount = row.cells[11].getElementsByTagName("input")[0].value;
                    ...
                    row.cells[11].getElementsByTagName("input")[0].value=PendingAmount; 
                                ...
                                <asp:TemplateField HeaderText="PENDING_AMOUNT">
                                    <ItemTemplate>
                                        ...
                                        <asp:TextBox ID="txtPendingAmount" runat="server" Width="100%" CssClass="aligntxtright"
                                            Text='<%# Eval("PENDING_AMOUNT") %>' Enabled="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
