<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="VPOCPostedList.aspx.cs"
    Inherits="REPORTS_PURCHASE_ORDER_VPOCPostedList" Title="VPOC Posted List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/Javascript">
        function ValidateDateRangeNew(el) {
            ...
            var dateItems = row.cells[8].getElementsByTagName("input")[0].value.split("-");
            ...
            var endDateItems = row.cells[9].getElementsByTagName("input")[0].value.split("-");
            ...
            if (endFormatedDate < formatedDate) {
                ...
                row.cells[9].getElementsByTagName("input")[0].style.borderColor = "#F7627F";
                ...
                row.cells[9].getElementsByTagName("input")[0].style.borderColor = "";
            }

            if (monthdiff >= 0) {
                row.cells[10].getElementsByTagName("input")[0].value = monthdiff;
                row.cells[10].getElementsByTagName("input")[0].style.borderColor = "";
            }
            else {
                row.cells[10].getElementsByTagName("input")[0].value = monthdiff;
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            ...
            <div class="full-width button-group">
                ...
                <asp:Button ID="btnUpdate" CssClass="button" Width="123%" runat="server" Text="Update All"
        ...
        <div class="employee-grid-container">
            ...
            <asp:GridView
                ...
                ID="gvVPOCList" runat="server" CellPadding="4" ForeColor="#333333"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ITEM_CATEGORY">
                        <ItemTemplate>
                            ...
                            <asp:TextBox ID="txtItemCategory" runat="server" Width="150px" Text='<%# Eval("ITEM_CATEGORY") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="DATE_OF_DELIVERY">
                        <ItemTemplate>
                            <asp:TextBox ID="txtDOD" runat="server" Width="150px" Text='<%# Eval("DOD") %>'
                                onkeyDown="javascript:preventInput(event);" />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="LIKELY_DOD">
                        <ItemTemplate>
                            <asp:TextBox ID="txtLikelyDOD" runat="server" Width="110px" onkeyDown="javascript:preventInput(event);"
                                onchange="ValidateDateRangeNew(this)" Text='<%# Eval("LIKELY_DOD") %>'></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="MONTHS">
                        <ItemTemplate>
                            <asp:TextBox ID="txtMonths" runat="server" Width="99%"
                                CssClass="aligntxtcenter" onkeyDown="javascript:preventInput(event);" Text='<%# Eval("MONTHS") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="LOCATION" DataField="LOCATION" />
                    <asp:TemplateField HeaderText="UPDATE">
                        <ItemTemplate>
                            <asp:Button ID="btnPost" CommandArgument="UPDATE" runat="server" Text="Update" CssClass="cancelbutton" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
