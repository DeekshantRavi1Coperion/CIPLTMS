<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="POFinalDeliverDateWiseForecastReport.aspx.cs"
    Inherits="REPORTS_PURCHASE_ORDER_POFinalDeliverDateWiseForecastReport" %>
    ...
    <div class="page-layout">
        ...
        <div class="form-container">
            <fieldset class="filter-card">
                <legend>Final Delivery Date Wise PO Forecast Report:
                ...
                <div class="form-grid form-grid-3">
                    ...
                    <label>Final Delivery Month:</label>
                    <table width="100%">
                        <tr>
                            <td>
            ...
            <div class="full-width button-group">
                ...
                <asp:Button ID="btnSearch" CssClass="button" Width="100%"
                    runat="server" Text="Search"
                    OnClientClick="return ValidateAll();" OnClick="btnSearch_Click" />

                <asp:Button ID="btnExport" CssClass="button" Width="100%"
