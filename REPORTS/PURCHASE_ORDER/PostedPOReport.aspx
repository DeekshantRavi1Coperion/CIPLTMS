<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="PostedPOReport.aspx.cs"
    Inherits="REPORTS_PURCHASE_ORDER_PostedPOReport" Title="Untitled Page" %>
    ...
    <div class="page-layout">
        ...
        <div class="employee-grid-container">
            ...
            <asp:GridView 
                ...
                ID="gvPostedPOReport" runat="server" CellPadding="4" ForeColor="#333333"
                AutoGenerateColumns="False" Width="100%" HorizontalAlign="Center" OnRowDataBound="gvPostedPOReport_RowDataBound">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PO_AMOUNT" HeaderText="PO_AMOUNT" />
                    <asp:BoundField DataField="PO_BUDGETED_AMOUNT" HeaderText="PO_BUDGETED_AMOUNT" />
                    <asp:BoundField DataField="SAVING_AMOUNT" HeaderText="SAVING_AMOUNT" />
                    ...
                    <asp:BoundField DataField="IS_SUBJECT_TO_VPOC" HeaderText="IS_SUBJECT_TO_VPOC" />
                    <asp:BoundField DataField="IS_BILLABLE" HeaderText="IS_BILLABLE" />
