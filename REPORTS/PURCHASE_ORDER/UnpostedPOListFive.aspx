<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="UnpostedPOListFive.aspx.cs"
    Inherits="REPORTS_PURCHASE_ORDER_UnpostedPOListFive" Title="Unposted PO List" %>
        ...
        function checkDec1(el) {
            ...
            if (ex.test(el.value) == false) {
                ...
                if (el.value == '') {
                    ...
                    if (PostingValue > POAmount) {
                        row.cells[8].getElementsByTagName("input")[0].value = '0';
                        row.cells[9].getElementsByTagName("input")[0].value = parseFloat(BudgetedAmount - POAmount);
                    }
                    else {
                        row.cells[9].getElementsByTagName("input")[0].value = parseFloat(BudgetedAmount - PostingValue);
                    }
