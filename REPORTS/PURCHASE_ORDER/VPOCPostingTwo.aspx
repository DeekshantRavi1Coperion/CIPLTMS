<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="VPOCPostingTwo.aspx.cs"
    Inherits="REPORTS_PURCHASE_ORDER_VPOCPostingTwo" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/Javascript">
        function ValidateDateRangeBasedUponLDOD(el) {
            ...
            var postingDate = "01-" + (row.cells[8].getElementsByTagName("input")[0].value);
            ...
            var dodDateItems = row.cells[10].getElementsByTagName("input")[0].value.split("-");
            ...
            var ldodDateItems = row.cells[14].getElementsByTagName("input")[0].value.split("-");
            ...
            if (ldodFormatedDate < formatedDate) {
                ...
                row.cells[14].getElementsByTagName("input")[0].style.borderColor = "#F7627F";
                row.cells[14].getElementsByTagName("input")[0].value = "";
                row.cells[15].getElementsByTagName("input")[0].value = "0";
                row.cells[16].getElementsByTagName("input")[0].value = "0";
                row.cells[17].innerText = 0;
                alert("Invalid Date Range between PO Date and LDOD Date");
                return true;
            }
            else {
                row.cells[1].getElementsByTagName("input")[0].style.borderColor = "";
                row.cells[14].getElementsByTagName("input")[0].style.borderColor = "";
            }

            if (ldodFormatedDate < dodFormatedDate) {
                row.cells[10].getElementsByTagName("input")[0].style.borderColor = "#F7627F";
                row.cells[14].getElementsByTagName("input")[0].style.borderColor = "#F7627F";
                row.cells[14].getElementsByTagName("input")[0].value = "";
                row.cells[15].getElementsByTagName("input")[0].value = "0";
                row.cells[16].getElementsByTagName("input")[0].value = "0";
            ...
            var poYear = 0;
            var LDODYear = 0;
            var LDODMonthsFromPODate = 0;

            poMonth = parseInt(month);
            LDODMonth = parseInt(ldodMonth);
            poYear = parseInt(dateItems[yearIndex]);
            LDODYear = parseInt(ldodDateItems[ldodYearIndex]);
            LDODMonthsFromPODate = parseInt((LDODYear - poYear) * 12 + (LDODMonth - poMonth));
            
            var postingMonthsFromPODate = parseInt(row.cells[9].getElementsByTagName("input")[0].value);
            
            var monthsBasedOponLDOD = 0;
            if (LDODMonthsFromPODate < postingMonthsFromPODate) {
                monthsBasedOponLDOD = parseInt(LDODMonthsFromPODate + 1);
            }
            else {
                monthsBasedOponLDOD = parseInt(postingMonthsFromPODate);
            }
            ...
            COGSLDOD = parseFloat((poAmount * parseInt(postingMonthsFromPODate)) / (monthsBasedOponLDOD));
            ...
            if (monthdiff1 >= 0 && monthdiff2 >= 0) {
                row.cells[15].getElementsByTagName("input")[0].value = (LDODMonthsFromPODate + 1);
                row.cells[15].getElementsByTagName("input")[0].style.borderColor = "";

                row.cells[16].getElementsByTagName("input")[0].value = monthsBasedOponLDOD;
                row.cells[16].getElementsByTagName("input")[0].style.borderColor = "";

                row.cells[17].innerText = COGSLDOD;
                row.cells[17].getElementsByTagName("input")[0].style.borderColor = "";
            }
            else {
                ...
                row.cells[16].getElementsByTagName("input")[0].value = 0;
                row.cells[16].getElementsByTagName("input")[0].style.borderColor = "#F7627F";

                row.cells[17].innerText = 0;
                row.cells[17].getElementsByTagName("input")[0].style.borderColor = "#F7627F";
                return true;
            }
        }
    </script>
    ...
    <script type="text/Javascript">
        function ValidateDateRangeBasedUponLDODNew(el) {
            var row = el.parentNode.parentNode;
            ...
            <div id="gridContainer" style="overflow-y: scroll; overflow-y: hidden; width: 100%; height: 360px; border: 1px solid lightgray;">
                <asp:GridView ID="gvVPOCList" runat="server" CellPadding="4" ForeColor="#333333"
                    ...
                    <Columns>
                        ...
                        <%--9 POSTING_MONTHS_FROM_PO_DATE--%>
                        <asp:TemplateField HeaderText="POSTING_MONTHS_FROM_PO_DATE">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPostingMonthsFromPODate" runat="server" Width="99%"
                        ...
                        <%--11 DOD_MONTHS_FROM_PO_DATE--%>
                        <asp:TemplateField HeaderText="DOD_MONTHS_FROM_PO_DATE">
                            <ItemTemplate>
                                <asp:TextBox ID="txtDODMonthsFromPODate" runat="server" Width="99%"
                                    CssClass="aligntxtcenter" onkeyDown="javascript:preventInput(event);" Text="0" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <%--12 MONTHS_BASED_UPON_DOD--%>
                        <asp:TemplateField HeaderText="MONTHS_BASED_UPON_DOD">
                            <ItemTemplate>
                        ...
                        <%--15 LDOD_MONTHS_FROM_PO_DATE--%>
                        <asp:TemplateField HeaderText="LDOD_MONTHS_FROM_PO_DATE">
                            <ItemTemplate>
                                <asp:TextBox ID="txtLDODMonthsFromPODate" runat="server" Width="99%"
                                    CssClass="aligntxtcenter" onkeyDown="javascript:preventInput(event);" Text="0" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <%--16 MONTHS_BASED_UPON_LDOD--%>
                        <asp:TemplateField HeaderText="MONTHS_BASED_UPON_LDOD">
                            <ItemTemplate>
