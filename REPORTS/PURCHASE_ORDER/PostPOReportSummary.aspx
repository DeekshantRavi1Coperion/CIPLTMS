<%@ Page Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true" CodeFile="PostPOReportSummary.aspx.cs"
    Inherits="REPORTS_PURCHASE_ORDER_PostPOReportSummary" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/Javascript">
        function ValidateDateRangeNew(el) {            
            ...
            var dateItems = row.cells[12].getElementsByTagName("input")[0].value.split("-");            
            var monthIndex = formatItems.indexOf("mmm");
            var dayIndex = formatItems.indexOf("dd");
            var yearIndex = formatItems.indexOf("yyyy");
            var month;
            ...
            var endDateItems = row.cells[13].getElementsByTagName("input")[0].value.split("-");
            ...
            if(monthdiff>=0)
            {
                row.cells[14].getElementsByTagName("input")[0].value = monthdiff;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div align="center" style="margin-top: 20px;">
        <fieldset style="width: 90%">
            <legend style="text-align: center;">PO Posting (Header) </legend>
            <table width="90%">
                <tr>
                    <td>
                        Start Date:
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="SELECT">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lblPurchaseID" runat="server" Visible="false" Text='<%# Eval("PURCHASE_ID") %>' />
                                <asp:Label ID="lblExistingPoValueINR" runat="server" Visible="false" Text='<%# Eval("EXISTING_PO_VALUE_INR") %>' />                                
                                ...
                                <asp:Label ID="lblIsOrderSubjectTo" runat="server" Visible="false" Text='<%# Eval("IS_ORDER_SUBJECT_TO") %>' />
                                <asp:Label ID="lblSalesPivotGroup" runat="server" Visible="false" Text='<%# Eval("SALES_PIVOT_GROUP") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="FRAIGHT/CUSTOM_LOADING(%)">
                            <ItemTemplate>
                                <asp:TextBox ID="txtFraightOrCustomLoading" runat="server" Width="100%" onKeyUp="checkDec1(this)"
                                    CssClass="aligntxtcenter" onpaste="return false" Text='<%# Eval("FRAIGHT_OR_CUSTOM_LOADING_IN_PERCENTAGE") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="TOTAL_PO_VALUE_INR">
                            <ItemTemplate>
                                <asp:TextBox ID="txtTotalPOValueINR" runat="server" Width="100%" CssClass="aligntxtcenter" onkeyDown="javascript:preventInput(event);"
                                    Text='<%# Eval("TOTAL_PO_VALUE_INR") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField HeaderText="EXISTING_PO_VALUE_INR" DataField="EXISTING_PO_VALUE_INR" />
                        ...
                        <asp:TemplateField HeaderText="MONTHS_TO_DELIVER">
                            <ItemTemplate>
                                <asp:TextBox ID="txtNoOfMonthsToDeliver" runat="server" Width="100%" onkeyup="checkDec(this);"
                                    CssClass="aligntxtcenter" onkeyDown="javascript:preventInput(event);"
                                    Text='<%# Eval("NO_OF_MONTHS_TO_DELIVER") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MONTHS_BASED_UPON">
                            <ItemTemplate>
                                <asp:TextBox ID="txtNoOfMonthsBasedUpon" runat="server" Width="100%" onkeyup="checkDec(this);"
                                    CssClass="aligntxtcenter"
                                    Text='<%# Eval("NO_OF_MONTHS_BASED_UPON") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="PAYMENT_TERM">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPaymentTerm" runat="server" Width="100%"
                                Text='<%# Eval("PAYMENT_TERM") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
