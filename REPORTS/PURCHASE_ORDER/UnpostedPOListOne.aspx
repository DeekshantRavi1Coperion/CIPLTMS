<%@ Page Title="" Language="C#" MasterPageFile="~/HOME.master" AutoEventWireup="true"
    CodeFile="UnpostedPOListOne.aspx.cs" Inherits="REPORTS_PROJECT_MGMT_UnpostedPOListOne" %>
        ...
        function checkDec1(el) {
            ...
            if (ex.test(el.value) == false) {
                ...
                if (el.value == '') {
                    ...
                    var lblPendingAmount = row.cells[10].innerText;
                    ...
                    row.cells[10].innerHTML=PendingAmount; 
                ...
                <fieldset style="width: 75%">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlJOBNo" runat="server" Width="200px" Height="25px" onblur="ValidateJOBNo();"
