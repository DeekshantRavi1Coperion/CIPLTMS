...
public partial class HR_StaffOTReportInDetail : System.Web.UI.Page
{
    ...
    protected void gvOTReport_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            {
                Label lblEmployeeCode = e.Row.FindControl("lblEmployeeCode") as Label;

                //if (strEmpCode != Convert.ToString(lblEmployeeCode.Text))
                //{
                //    strEmpCode = Convert.ToString(lblEmployeeCode.Text);
                //}
    ...
    private void GetOtReport()
    {
        try
        {
            ...
            dsOTReport = objHrdept.GetStaffOTDetails(startDate, endDate, deptID, empID, empCode);
